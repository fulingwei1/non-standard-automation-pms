...
| 服务类型 | 数量 | 服务列表 |
|---------|:----:|---------|
| 预警生成服务 | 8 | 缺料预警、里程碑预警、任务延期预警、生产计划预警、外协交期预警、收款提醒、逾期应收预警、负荷超限预警 |
| 定时检查服务 | 6 | 每日齐套检查、到货延迟检查、任务到期提醒、问题逾期预警、报工超时提醒、售前工单超时提醒 |
| 汇总计算服务 | 4 | 进度汇总计算、生产日报自动生成、缺料日报生成、岗位职责任务自动生成 |
| 升级推送服务 | 4 | 预警升级服务、消息推送服务（企微/邮件）、商机阶段超时提醒、问题超时升级 |

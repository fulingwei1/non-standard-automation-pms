...
def create_api_router() -> APIRouter:
    ...
    # ==================== 通知和告警 ====================
    try:
        from app.api.v1.endpoints import alerts, notifications
    ...
    api_router.include_router(
        technical_review.router, prefix="/technical-review", tags=["technical-review"]
    )
    ...
    api_router.include_router(
        account_unlock_router, prefix="/admin/account-lockout", tags=["admin", "security"]
    )
    api_router.include_router(
    ...
    try:
        ...
        api_router.include_router(
            data_import_export_router, prefix="/data", tags=["data-import-export"]
        )
        ...
        api_router.include_router(
            assembly_kit_router, prefix="/assembly-kit", tags=["assembly-kit"]
        )
        api_router.include_router(
    ...
    try:
        ...
        api_router.include_router(
            purchase_intelligence_router,
            prefix="/purchase-intelligence",
            tags=["purchase-intelligence"],
        )
        api_router.include_router(
            material_tracking_router, prefix="/material-tracking", tags=["material-tracking"]
        )
        api_router.include_router(
            shortage_alert_router, prefix="/shortage-alert", tags=["shortage-alert"]
        )
    except ImportError as e:
    ...
    try:
        ...
        api_router.include_router(
            project_review_router, prefix="/project-review", tags=["project-review"]
        )
    except ImportError as e:
    ...
    try:
        ...
        api_router.include_router(
            engineer_performance_router,
            prefix="/engineer-performance",
            tags=["engineer-performance"],
        )
    except ImportError as e:

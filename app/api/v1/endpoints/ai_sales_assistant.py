        ...
        "初次接触": [
            {
                "id": 1,
                "title": "初次拜访开场白",
                "content": "您好，我是金凯博自动化的[姓名]，专注于锂电行业自动化测试设备...",
                "match_score": 95,
            },
            {
                "id": 2,
                "title": "电话陌拜话术",
                "content": "您好，请问是[客户姓名]吗？我是金凯博自动化的小[姓]...",
                "match_score": 88,
            },
        ],
        "需求挖掘": [
            {
                "id": 3,
                "title": "需求了解话术",
                "content": "贵司目前在[产品]测试方面主要有哪些痛点？...",
                "match_score": 92,
            },
            {
                "id": 4,
                "title": "预算探询话术",
                "content": "这类项目的预算范围大概在什么区间？我可以为您推荐最合适的方案...",
                "match_score": 85,
            },
        ],
        "方案介绍": [
            {
                "id": 5,
                "title": "FCT方案介绍",
                "content": "我们的FCT设备采用模块化设计，支持ICT+FCT一体化测试...",
                "match_score": 90,
            },
        ],
        "价格谈判": [
            {
                "id": 6,
                "title": "价格异议处理",
                "content": "我理解您对价格的关注，让我从TCO（总拥有成本）角度分析一下...",
                "match_score": 93,
            },
        ],
    }
        ...
        return {
            ...
            "generated_content": {
                "sections": [
                    {
                        "title": "1. 项目概述",
                        "content": "本项目为锂电FCT功能测试设备，采用模块化设计...",
                    },
                    {
                        "title": "2. 技术方案",
                        "content": "设备配置：ICT测试模块、FCT测试模块、数据采集系统...",
                    },
                    {
                        "title": "3. 实施方案",
                        "content": "交付周期：60天（标准模式）/ 45天（密集模式）...",
                    },
        ...
        return {
            ...
            "generated_content": {
                "sections": [
                    ...
                    {
                        "title": "2. 报价方案",
                        "content": "设备总价：350万元（含税），包含：设备本体、安装调试、培训...",
                    },
                    {
                        "title": "3. 交付周期",
                        "content": "标准交付：60天；加急交付：45天（+10%费用）",
                    },
                    {
                        "title": "4. 付款方式",
                        "content": "3:6:1付款（合同签订30%，发货前60%，验收后10%）",
                    },
                ],
            },
        }

...
async def get_engineer_feedback(
    ...
    return ResponseModel(code=200, message="获取绩效反馈成功", data=feedback)
...
async def generate_feedback_message(
    ...
    return ResponseModel(code=200, message="生成反馈消息成功", data={"message": message})
...
async def get_dimension_trend(
    ...
    return ResponseModel(code=200, message="获取趋势数据成功", data=trends)

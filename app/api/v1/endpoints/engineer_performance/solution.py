...
async def get_solution_score_details(
    ...
    try:
        ...
        return ResponseModel(code=200, message="获取得分详情成功", data=details)
...
async def get_solution_bonus_details(
    ...
    try:
        ...
        return ResponseModel(code=200, message="获取奖金详情成功", data=bonus_details)
    except ValueError as e:
        raise HTTPException(status_code=400, detail=str(e))
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
async def calculate_solution_bonus(
    ...
    try:
        ...
        return ResponseModel(code=200, message="奖金计算完成", data=bonus_details)
    except ValueError as e:
        raise HTTPException(status_code=400, detail=str(e))
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))

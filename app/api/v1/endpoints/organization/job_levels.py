...
def list_job_levels(
    ...
    # 使用统一响应格式
    return list_response(items=level_responses, message="获取职级列表成功")
...
def create_job_level(
    *,
    ...
    """创建职级"""
    level = db.query(JobLevel).filter(JobLevel.level_code == level_in.level_code).first()
    if level:
    ...
    # 使用统一响应格式
    return success_response(data=level_response, message="职级创建成功")
...
def get_job_level(
    ...
    # 使用统一响应格式
    return success_response(data=level_response, message="获取职级信息成功")
...
def update_job_level(
    *,
    ...
    # 使用统一响应格式
    return success_response(data=level_response, message="职级更新成功")
...
def delete_job_level(
    ...
    # 使用统一响应格式
    return success_response(data={"id": id}, message="职级删除成功")

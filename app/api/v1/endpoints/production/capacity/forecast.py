...
async def forecast_capacity(
    ...
    if type == "equipment":
        ...
        forecast_result = _calculate_forecast(
            historical_data, forecast_days, value_field="daily_output"
        )
        ...
        trend = (
            ...
            else ("下降" if recent_avg < overall_avg * 0.95 else "平稳")
        )
        ...
        return {
            ...
            "data": {
                ...
                "historical_summary": {
                    ...
                    "avg_daily_output": sum(row.daily_output for row in historical_data)
                    / len(historical_data),
        ...
        efficiency_forecast = _calculate_forecast(
            historical_data, forecast_days, value_field="daily_efficiency"
        )
        ...
        return {
            ...
            "data": {
                ...
                "historical_summary": {
                    "avg_efficiency": sum(row.daily_efficiency for row in historical_data)
                    / len(historical_data),
                    "total_output": sum(row.daily_output for row in historical_data),
                },

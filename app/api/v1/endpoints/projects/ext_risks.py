...
@router.get("/projects/risks", response_model=Response[List[ProjectResponse]])
def get_project_risks(
    ...
    try:
        ...
        return Response.error(message=f"获取项目risks失败: {str(e)}")
...
def create_project_risks(
    ...
    try:
        # TODO: 实现risks创建逻辑
        return Response.success(message="项目risks创建成功")
    except Exception as e:
        return Response.error(message=f"创建项目risks失败: {str(e)}")

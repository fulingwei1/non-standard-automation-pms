...
@router.get("/quotes/approvals_simple", response_model=ResponseModel[List[QuoteResponse]])
def get_quote_approvals_simple(
    ...
    try:
        ...
        return ResponseModel(code=500, message=f"获取报价approvals_simple失败: {str(e)}")
...
def create_quote_approvals_simple(
    ...
    try:
        ...
        return ResponseModel(code=200, message="报价approvals_simple创建成功")
    except Exception as e:
        return ResponseModel(code=500, message=f"创建报价approvals_simple失败: {str(e)}")

...
@router.get("/quotes/cost_calculations", response_model=ResponseModel[List[QuoteResponse]])
def get_quote_cost_calculations(
    ...
    try:
        ...
        return ResponseModel(code=500, message=f"获取报价cost_calculations失败: {str(e)}")
...
def create_quote_cost_calculations(
    ...
    try:
        ...
        return ResponseModel(code=200, message="报价cost_calculations创建成功")
    except Exception as e:
        return ResponseModel(code=500, message=f"创建报价cost_calculations失败: {str(e)}")

...
@router.get("/quotes/delivery", response_model=ResponseModel[List[QuoteResponse]])
def get_quote_delivery(
    ...
    try:
        ...
        return ResponseModel(code=500, message=f"获取报价delivery失败: {str(e)}")
...
def create_quote_delivery(
    ...
    try:
        # TODO: 实现delivery创建逻辑
        return ResponseModel(code=200, message="报价delivery创建成功")
    except Exception as e:
        return ResponseModel(code=500, message=f"创建报价delivery失败: {str(e)}")

...
@router.get("/quotes/quotes_crud", response_model=ResponseModel[List[QuoteResponse]])
def get_quote_quotes_crud(
    ...
    try:
        ...
        return ResponseModel(code=500, message=f"获取报价quotes_crud失败: {str(e)}")
...
def create_quote_quotes_crud(
    ...
    try:
        ...
        return ResponseModel(code=200, message="报价quotes_crud创建成功")
    except Exception as e:
        return ResponseModel(code=500, message=f"创建报价quotes_crud失败: {str(e)}")

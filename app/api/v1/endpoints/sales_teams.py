...
@router.put("/{team_id:int}", response_model=ResponseModel)
...
@router.delete("/{team_id:int}", response_model=ResponseModel)
...
@router.post("/{team_id:int}/members", response_model=ResponseModel)
@require_permission("sales_team:update")
def add_member(
    team_id: int,
...
@router.delete("/{team_id:int}/members/{user_id:int}", response_model=ResponseModel)
@require_permission("sales_team:update")
def remove_member(
    team_id: int,
    user_id: int,
...
@router.put("/{team_id:int}/members/{user_id:int}/role", response_model=ResponseModel)
@require_permission("sales_team:update")

...
def get_schedule_plan(
    ...
    tasks = (
        ...
        .filter(ScheduleTask.schedule_plan_id == plan_id)
        .order_by(ScheduleTask.planned_start_date)
        .all()
    )
        ...
        "tasks": [
            {
                ...
                "phase": t.phase,
                "planned_start_date": (
                    t.planned_start_date.isoformat() if t.planned_start_date else None
                ),

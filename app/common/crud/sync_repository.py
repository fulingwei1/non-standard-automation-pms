...
class SyncBaseRepository(Generic[ModelType, CreateSchemaType, UpdateSchemaType]):
    ...
    def create_many(
        self, objs_in: List[CreateSchemaType], *, commit: bool = True
    ) -> List[ModelType]:
        """
        批量创建对象
    ...
    def update(
        self, id: int, obj_in: UpdateSchemaType, *, commit: bool = True
    ) -> Optional[ModelType]:
        """
        更新对象
    ...
    def update_by_field(
        self, field_name: str, field_value: Any, obj_in: UpdateSchemaType, *, commit: bool = True
    ) -> Optional[ModelType]:
        """
        根据字段值更新对象
    ...
    def delete(self, id: int, *, commit: bool = True, soft_delete: bool = False) -> bool:
        """
        删除对象
    ...
    def count(self, *, filters: Optional[Dict[str, Any]] = None) -> int:
        """统计数量"""
        query, count_query = SyncQueryBuilder.build_list_query(
            model=self.model, db=self.db, filters=filters
        )

...
class StatisticsAggregator:
    ...
    def register_service(self, name: str, service: BaseStatisticsService):
        """注册统计服务"""
        self._services[name] = service

    async def get_overview_stats(self, services: Optional[List[str]] = None) -> Dict[str, Any]:
        """
        获取概览统计
        ...
        for service_name in services_to_query:
            ...
            result[service_name] = {"total": total, "by_status": by_status}

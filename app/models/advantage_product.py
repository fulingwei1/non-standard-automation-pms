...
class Industry(Base, TimestampMixin):
    ...
    category_mappings = relationship(
        "IndustryCategoryMapping", back_populates="industry", cascade="all, delete-orphan"
    )
...
class IndustryCategoryMapping(Base, TimestampMixin):
    ...
    category_id = Column(
        Integer, ForeignKey("advantage_product_categories.id"), nullable=False, comment="产品类别ID"
    )
...
class AdvantageProductCategory(Base, TimestampMixin):
    ...
    industry_mappings = relationship(
        "IndustryCategoryMapping", back_populates="category", cascade="all, delete-orphan"
    )
...
class NewProductRequest(Base, TimestampMixin):
    ...
    category_id = Column(
        Integer, ForeignKey("advantage_product_categories.id"), comment="建议归属类别"
    )
    ...
    review_status = Column(
        String(20), default="PENDING", comment="审核状态：PENDING/APPROVED/REJECTED/CONVERTED"
    )
    ...
    # 转化为优势产品
    converted_product_id = Column(
        Integer, ForeignKey("advantage_products.id"), comment="转化后的优势产品ID"
    )
...
DEFAULT_INDUSTRIES = [
    ...
    },
    {
        ...
        "market_size": "LARGE",
        "growth_potential": "HIGH",
        "company_experience": "EXPERIENCED",
    },
    {
        "code": "HOME_APPLIANCE",
        "name": "家电",
    ...
    },
    {
        ...
        "market_size": "MEDIUM",
        "growth_potential": "HIGH",
        "company_experience": "LEARNING",
    },
    {
        "code": "INDUSTRIAL_CONTROL",
        "name": "工业控制",
        "sort_order": 6,
        "market_size": "MEDIUM",
        "growth_potential": "MEDIUM",
...
DEFAULT_SUB_INDUSTRIES = [
    # 3C电子子行业
    {
        "code": "MOBILE_PHONE",
        "name": "手机",
        "parent_code": "3C_ELECTRONICS",
        "typical_products": '["手机主板", "摄像头模组", "触摸屏", "电池"]',
    },
    {
        "code": "TABLET",
        "name": "平板电脑",
        "parent_code": "3C_ELECTRONICS",
        "typical_products": '["主板", "显示屏", "电池包"]',
    },
    {
        "code": "LAPTOP",
        "name": "笔记本电脑",
        "parent_code": "3C_ELECTRONICS",
        "typical_products": '["主板", "键盘", "电源适配器"]',
    },
    {
        "code": "WEARABLE",
        "name": "可穿戴设备",
        "parent_code": "3C_ELECTRONICS",
        "typical_products": '["智能手表", "TWS耳机", "手环"]',
    },
    {
        "code": "CHARGER",
        "name": "充电器/适配器",
        "parent_code": "3C_ELECTRONICS",
        "typical_products": '["充电器", "适配器", "充电宝"]',
    },
    # 汽车电子子行业
    {
        "code": "AUTO_ECU",
        ...
        "typical_products": '["域控制器", "BMS", "MCU", "VCU"]',
    },
    {
        "code": "AUTO_SENSOR",
        "name": "汽车传感器",
        "parent_code": "AUTOMOTIVE",
        "typical_products": '["毫米波雷达", "激光雷达", "摄像头"]',
    },
    {
        "code": "AUTO_MOTOR",
        "name": "汽车电机",
        "parent_code": "AUTOMOTIVE",
        "typical_products": '["驱动电机", "转向电机", "车窗电机"]',
    },
    {
        "code": "AUTO_LIGHTING",
        "name": "汽车车灯",
        "parent_code": "AUTOMOTIVE",
        "typical_products": '["LED大灯", "尾灯", "转向灯"]',
    },
    {
        "code": "AUTO_CHARGING",
        "name": "汽车充电",
        "parent_code": "AUTOMOTIVE",
        "typical_products": '["OBC", "DC-DC", "充电桩"]',
    },
    # 新能源子行业
    {
        "code": "BATTERY_PACK",
        "name": "动力电池",
        "parent_code": "NEW_ENERGY",
        "typical_products": '["电芯", "模组", "PACK"]',
    },
    {
        "code": "ENERGY_STORAGE",
        "name": "储能系统",
        "parent_code": "NEW_ENERGY",
        "typical_products": '["储能电池", "BMS", "PCS"]',
    },
    {
        "code": "PV_INVERTER",
        "name": "光伏逆变",
        "parent_code": "NEW_ENERGY",
        "typical_products": '["逆变器", "优化器", "汇流箱"]',
    },
    {
        "code": "CHARGING_PILE",
        "name": "充电桩",
        "parent_code": "NEW_ENERGY",
        "typical_products": '["直流桩", "交流桩", "充电模块"]',
    },
    # 家电子行业
    {
        "code": "WHITE_APPLIANCE",
        "name": "白色家电",
        "parent_code": "HOME_APPLIANCE",
        "typical_products": '["空调", "冰箱", "洗衣机"]',
    },
    {
        "code": "SMALL_APPLIANCE",
        "name": "小家电",
        "parent_code": "HOME_APPLIANCE",
        "typical_products": '["电饭煲", "吸尘器", "破壁机"]',
    },
    {
        "code": "KITCHEN_APPLIANCE",
        "name": "厨房电器",
        "parent_code": "HOME_APPLIANCE",
        "typical_products": '["油烟机", "燃气灶", "消毒柜"]',
    },
    # 医疗器械子行业
    {
        "code": "MEDICAL_MONITOR",
        "name": "监护设备",
        "parent_code": "MEDICAL_DEVICE",
        "typical_products": '["血压计", "血糖仪", "心电监护"]',
    },
    {
        "code": "MEDICAL_IMAGING",
        "name": "影像设备",
        "parent_code": "MEDICAL_DEVICE",
        "typical_products": '["CT", "MRI", "超声"]',
    },
    {
        "code": "IVD",
        "name": "体外诊断",
        "parent_code": "MEDICAL_DEVICE",
        "typical_products": '["生化分析仪", "免疫分析仪"]',
    },
    # 工业控制子行业
    {
        "code": "PLC_DCS",
        "name": "PLC/DCS",
        "parent_code": "INDUSTRIAL_CONTROL",
        "typical_products": '["PLC", "DCS", "PAC"]',
    },
    {
        "code": "SERVO_DRIVE",
        "name": "伺服驱动",
        "parent_code": "INDUSTRIAL_CONTROL",
        "typical_products": '["伺服驱动器", "伺服电机"]',
    },
    {
        "code": "FREQUENCY_CONVERTER",
        "name": "变频器",
        "parent_code": "INDUSTRIAL_CONTROL",
        "typical_products": '["通用变频器", "专用变频器"]',
    },
]
...
DEFAULT_INDUSTRY_CATEGORY_MAPPINGS = [
    ...
    {
        "industry_code": "3C_ELECTRONICS",
        "category_code": "HOME_APPLIANCE",
        "match_score": 100,
        "is_primary": True,
    },
    {
        "industry_code": "MOBILE_PHONE",
        "category_code": "HOME_APPLIANCE",
        "match_score": 100,
        "is_primary": True,
    },
    {
        "industry_code": "CHARGER",
        "category_code": "HOME_APPLIANCE",
        "match_score": 100,
        "is_primary": True,
    },
    ...
    {
        "industry_code": "AUTO_ECU",
        "category_code": "AUTOMOTIVE",
        "match_score": 100,
        "is_primary": True,
    },
    {
        "industry_code": "AUTO_SENSOR",
        "category_code": "AUTOMOTIVE",
        "match_score": 90,
        "is_primary": True,
    },
    {
        "industry_code": "AUTO_MOTOR",
        "category_code": "AUTOMOTIVE",
        "match_score": 80,
        "is_primary": False,
    },
    {
        "industry_code": "AUTO_CHARGING",
        "category_code": "NEW_ENERGY",
        "match_score": 90,
        "is_primary": True,
    },
    # 新能源
    {
        "industry_code": "NEW_ENERGY",
        "category_code": "NEW_ENERGY",
        "match_score": 100,
        "is_primary": True,
    },
    {
        "industry_code": "BATTERY_PACK",
        "category_code": "NEW_ENERGY",
        "match_score": 100,
        "is_primary": True,
    },
    {
        "industry_code": "ENERGY_STORAGE",
        "category_code": "NEW_ENERGY",
        "match_score": 95,
        "is_primary": True,
    },
    {
        "industry_code": "PV_INVERTER",
        "category_code": "NEW_ENERGY",
        "match_score": 85,
        "is_primary": True,
    },
    {
        "industry_code": "CHARGING_PILE",
        "category_code": "NEW_ENERGY",
        "match_score": 90,
        "is_primary": True,
    },
    # 家电
    {
        "industry_code": "HOME_APPLIANCE",
        "category_code": "HOME_APPLIANCE",
        "match_score": 100,
        "is_primary": True,
    },
    {
        "industry_code": "WHITE_APPLIANCE",
        "category_code": "HOME_APPLIANCE",
        "match_score": 100,
        "is_primary": True,
    },
    {
        "industry_code": "SMALL_APPLIANCE",
        "category_code": "HOME_APPLIANCE",
        "match_score": 95,
        "is_primary": True,
    },

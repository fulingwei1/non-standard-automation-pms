...
class CultureWallContent(Base, TimestampMixin):
    ...
    # 内容类型
    content_type = Column(
        String(30), nullable=False, comment="内容类型:STRATEGY/CULTURE/IMPORTANT/NOTICE/REWARD"
    )
    # STRATEGY: 战略规划
    # CULTURE: 企业文化
    # IMPORTANT: 重要事项
...
class PersonalGoal(Base, TimestampMixin):
    ...
    # 状态
    status = Column(
        String(20), default="IN_PROGRESS", comment="状态:IN_PROGRESS/COMPLETED/OVERDUE/CANCELLED"
    )

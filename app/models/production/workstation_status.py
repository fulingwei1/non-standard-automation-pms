...
class WorkstationStatus(Base, TimestampMixin):
    ...
    bottleneck_level = Column(
        Integer, default=0, comment="瓶颈等级：0-正常，1-轻度，2-中度，3-严重"
    )
    ...
    def __repr__(self):
        return (
            f"<WorkstationStatus workstation_id={self.workstation_id} state={self.current_state}>"
        )

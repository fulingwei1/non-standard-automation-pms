...
class DataImportTask(Base, TimestampMixin):
    ...
    # 导入人
    imported_by = Column(Integer, ForeignKey('users.id'), nullable=False, comment='导入人ID')
...
class DataExportTask(Base, TimestampMixin):
    ...
    # 导出人
    exported_by = Column(Integer, ForeignKey('users.id'), nullable=False, comment='导出人ID')

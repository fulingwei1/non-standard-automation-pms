...
from app.modules.presale.services.ammo_library_service import AmmoLibraryService
...
def run_presale_agent(
    ...
    try:
        ...
        if enable_deep_solution:
            t0 = time.time()
            from app.modules.presale.services.competitive_analyzer import analyze_competition
        ...
        if enable_deep_solution and is_line:
            ...
            t0 = time.time()
            try:
                from app.modules.presale.services.layout_html_generator import (
...
def _step_deep_risk_analysis(
    ...
    """
    from app.modules.presale.services.presale_tool_registry import ToolRegistry

...
class InitializeProjectStagesRequest(BaseModel):
    ...
    stage_overrides: Optional[Dict[str, StageAdjustment]] = Field(
        default=None, description="阶段调整配置"
    )
    node_overrides: Optional[Dict[str, NodeAdjustment]] = Field(
        default=None, description="节点调整配置"
    )

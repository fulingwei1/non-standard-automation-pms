...
class SolutionEngineerBonusService(BonusCalculatorBase):
    ...
    def calculate_solution_bonus(
        ...
        total_bonus = (
            completion_bonus
            + won_bonus
            + high_quality_compensation_total
            + success_rate_bonus_amount
        )
    ...
    def get_solution_score_details(self, engineer_id: int, period_id: int) -> Dict[str, Any]:
        """
        获取方案工程师得分详情
        ...
        return {
            ...
            "solution_statistics": {
                ...
                "approval_rate": (
                    round(approved_count / len(solutions) * 100, 2) if solutions else 0.0
                ),
            },
        }

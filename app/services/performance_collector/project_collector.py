    ...
    def collect_task_completion_data(
        ...
        try:
            ...
            on_time_tasks = sum(
                ...
                and t.due_date
                and t.actual_end_date <= t.due_date
            )
            ...
            for project in projects:
                ...
                if evaluation:
                    project_evaluations[project.id] = {
                        "difficulty_score": (
                            float(evaluation.difficulty_score)
                            if evaluation.difficulty_score
                            else None
                        ),
                        "workload_score": (
                            float(evaluation.workload_score) if evaluation.workload_score else None
                        ),
                    }

...
class PresaleAITemplateService:
    ...
    def create_template(self, data: Dict[str, Any], user_id: int) -> PresaleAISolutionTemplate:
        """创建方案模板"""
        template = PresaleAISolutionTemplate(
            **data, created_by=user_id, created_at=datetime.utcnow()
        )
    ...
    def update_template(self, template_id: int, data: Dict[str, Any]) -> PresaleAISolutionTemplate:
        """更新方案模板"""

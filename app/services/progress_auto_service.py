...
from app.models.progress import Task, TaskDependency, ProgressLog
from app.models.notification import Notification
from app.schemas.progress import TaskForecastItem, DependencyIssue
        ...
        try:
            ...
            if options["send_notifications"]:
                ...
                if high_issues or cycle_paths:
                    from app.api.v1.endpoints.progress.utils import _notify_dependency_alerts

...
class QualityRiskAnalyzer:
    ...
    def analyze_work_logs(
        self, work_logs: List[Dict[str, Any]], project_context: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
        """
        分析工作日志，识别质量风险
    ...
    def _analyze_with_keywords(self, work_logs: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        return {
            ...
            "ai_analysis": {"method": "KEYWORD_BASED", "logs_analyzed": len(work_logs)},
    ...
    def _build_analysis_prompt(
        self, work_logs: List[Dict[str, Any]], project_context: Optional[Dict[str, Any]]
    ) -> str:
        """构建GLM分析提示词"""
...
"""
    ...
    def _merge_analysis_results(
        self, keyword_result: Dict[str, Any], ai_result: Dict[str, Any]
    ) -> Dict[str, Any]:
        """合并关键词分析和AI分析结果"""
    ...
    def _predict_issues_from_keywords(
        self, keywords: Dict[str, List[str]], patterns: List[Dict[str, Any]]
    ) -> List[Dict[str, Any]]:
        """基于关键词预测问题"""

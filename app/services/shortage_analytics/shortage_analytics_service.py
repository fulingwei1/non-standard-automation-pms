...
class ShortageAnalyticsService:
    ...
    def _get_recent_reports(self, project_id: Optional[int] = None) -> List[Dict[str, Any]]:
        ...
        for report in recent_reports:
            ...
            recent_reports_list.append({
                ...
                "shortage_qty": self._to_float(report.shortage_qty),
                "urgent_level": report.urgent_level or "NORMAL",
    ...
    def get_daily_report(
        ...
        for report in daily_reports:
            ...
            by_material[material_key]["total_shortage_qty"] += self._to_float(report.shortage_qty)

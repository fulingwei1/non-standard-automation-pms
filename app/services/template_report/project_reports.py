...
class ProjectReportMixin:
            ...
            "sections": {
                "milestones": {
                    ...
                    "summary": {
                        ...
                        "completed": sum(
                            1 for m in milestones if getattr(m, "status", "") == "COMPLETED"
                        ),
                        "delayed": sum(
                            1 for m in milestones if getattr(m, "status", "") == "DELAYED"
                        ),
                    },
                },
                "timesheet": {
                ...
                "machines": {"title": "机台进度", "type": "list", "data": machine_data},
            },
            "metrics": {
                "total_hours": round(total_hours, 2),
                ...
                "milestone_completion_rate": (
                    round(
                        sum(1 for m in milestones if getattr(m, "status", "") == "COMPLETED")
    ...
    def _generate_project_monthly(
        ...
        data["sections"]["weekly_trend"] = {"title": "周度趋势", "type": "line", "data": weeks}

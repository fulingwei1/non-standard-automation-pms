...
class PmoCodes:
    ...
    def generate_risk_no(db: Session) -> str:
        ...
        return generate_sequential_no(
            db, PmoProjectRisk, "risk_no", "RISK", date_format="%y%m%d", separator="-", seq_length=3
        )
    ...
    def generate_meeting_no(db: Session) -> str:
        ...
        return generate_sequential_no(
            db, PmoMeeting, "meeting_no", "MTG", date_format="%y%m%d", separator="-", seq_length=3
        )
...
class TaskCenterCodes:
    ...
    def generate_task_code(db: Session) -> str:
        ...
        return generate_sequential_no(
            db, TaskUnified, "task_code", "TASK", date_format="%y%m%d", separator="-", seq_length=3
        )
...
class PurchaseCodes:
    ...
    def generate_order_no(db: Session) -> str:
        ...
        return generate_sequential_no(
            db, PurchaseOrder, "order_no", "PO", date_format="%Y%m%d", separator="-", seq_length=3
        )
    ...
    def generate_receipt_no(db: Session) -> str:
        ...
        return generate_sequential_no(
            db, GoodsReceipt, "receipt_no", "GR", date_format="%Y%m%d", separator="-", seq_length=3
        )
...
class BusinessSupportCodes:
    ...
    def generate_bidding_no(db: Session) -> str:
        ...
        return generate_sequential_no(
            db, Bidding, "bidding_no", "BID", date_format="%y%m%d", separator="-", seq_length=3
        )
...
class ServiceCodes:
    ...
    def generate_ticket_no(db: Session) -> str:
        ...
        return generate_sequential_no(
            db, ServiceTicket, "ticket_no", "SRV", date_format="%y%m%d", separator="-", seq_length=3
        )
    ...
    def generate_record_no(db: Session) -> str:
        ...
        return generate_sequential_no(
            db, ServiceRecord, "record_no", "REC", date_format="%y%m%d", separator="-", seq_length=3
        )
...
class RdProjectCodes:
    ...
    def generate_project_no(db: Session) -> str:
        ...
        return generate_sequential_no(
            db, RdProject, "project_no", "RDP", date_format="%y%m%d", separator="-", seq_length=3
        )
    ...
    def generate_cost_no(db: Session) -> str:
        ...
        return generate_sequential_no(
            db, RdCost, "cost_no", "RDC", date_format="%y%m%d", separator="-", seq_length=3
        )
...
class BudgetCodes:
    ...
    def generate_budget_no(db: Session) -> str:
        ...
        return generate_sequential_no(
            db, Budget, "budget_no", "BG", date_format="%y%m%d", separator="-", seq_length=3
        )
...
class InstallationDispatchCodes:
    ...
    def generate_order_no(db: Session) -> str:
        ...
        return generate_sequential_no(
            db, DispatchOrder, "order_no", "IDO", date_format="%y%m%d", separator="-", seq_length=3
        )
...
class KitCheckCodes:
    ...
    def generate_check_no(db: Session) -> str:
        ...
        return generate_sequential_no(
            db, KitCheck, "check_no", "KC", date_format="%y%m%d", separator="-", seq_length=3
        )

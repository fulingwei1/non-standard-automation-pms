...
OTHER_TASKS = [
    ...
    {
        "id": "push_ai_daily_reports",
        "name": "AI日报自动推送",
        "module": "app.utils.scheduled_tasks",
        "callable": "push_daily_reports",
        "cron": {"hour": 18, "minute": 30},
        "owner": "Sales",
        "category": "AI",
        "description": "每天18:30为当日有活动记录的员工AI生成个人日报并站内推送。",
        "enabled": True,
        "dependencies_tables": ["customer_communications", "notifications"],
        "risk_level": "LOW",
        "sla": {"max_execution_time_seconds": 600, "retry_on_failure": False},
    },
    {
        "id": "push_ai_weekly_reports",
        "name": "AI周报自动推送",
        "module": "app.utils.scheduled_tasks",
        "callable": "push_weekly_reports",
        "cron": {"day_of_week": "fri", "hour": 17, "minute": 30},
        "owner": "Sales",
        "category": "AI",
        "description": "每周五17:30为本周有活动记录的员工AI生成个人周报并站内推送。",
        "enabled": True,
        "dependencies_tables": ["customer_communications", "notifications"],
        "risk_level": "LOW",
        "sla": {"max_execution_time_seconds": 900, "retry_on_failure": False},
    },
    {

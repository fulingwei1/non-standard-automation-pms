...
**接口**: `GET /api/v1/project-evaluation/dimensions`
...
**接口**: `POST /api/v1/project-evaluation/dimensions`
...
**接口**: `PUT /api/v1/project-evaluation/dimensions/{dim_id}`
...
**接口**: `DELETE /api/v1/project-evaluation/dimensions/{dim_id}`

### 1.5 启用/停用维度配置

**接口**: `POST /api/v1/project-evaluation/dimensions/{dim_id}/toggle`
...
**接口**: `GET /api/v1/project-evaluation/dimensions/weights/summary`
...
```json
PUT /api/v1/project-evaluation/dimensions/1
{
...
```json
PUT /api/v1/project-evaluation/dimensions/3
{
  "scoring_rules": {
    "ranges": [
...
```javascript
// 获取维度配置列表
const dimensions = await api.get('/api/v1/project-evaluation/dimensions', {
  params: { is_active: true }
})

// 获取权重摘要
const weightsSummary = await api.get('/api/v1/project-evaluation/dimensions/weights/summary')
```
...
```javascript
// 更新维度权重
await api.put(`/api/v1/project-evaluation/dimensions/${dimId}`, {

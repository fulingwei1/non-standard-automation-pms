        ...
        {expandedLayers.vision && (
          <CardContent className="p-6 space-y-4">
            <div>
              ...
              <Textarea
                value={data.mission || ''}
                onChange={(e) => updateLayer('vision', 'mission', e.target.value)}
            ...
            <div>
              ...
              <Textarea
                value={data.vision || ''}
                onChange={(e) => updateLayer('vision', 'vision', e.target.value)}
            ...
            <div>
              <label className="block text-sm font-medium mb-2">存在的意义</label>
              <Textarea
                value={data.why_exist || ''}
                onChange={(e) => updateLayer('vision', 'why_exist', e.target.value)}
                placeholder="我们为什么存在？"
                disabled={readOnly}
                rows={2}
              />
            ...
            <div>
              <label className="block text-sm font-medium mb-2">三年后希望被怎么记住</label>
              <Textarea
                value={data.three_years_later || ''}
                onChange={(e) => updateLayer('vision', 'three_years_later', e.target.value)}
            ...
            <div>
              <label className="block text-sm font-medium mb-2">为谁创造长期价值</label>
              <Textarea
                value={data.long_term_value || ''}
                onChange={(e) => updateLayer('vision', 'long_term_value', e.target.value)}
          ...
          <CardContent className="p-6 space-y-4">
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => updateLayer('opportunity', 'market_trend', e.target.value)}
            ...
            <div>
              <label className="block text-sm font-medium mb-2">客户需求本质</label>
              <Textarea
                value={data.customer_demand || ''}
                onChange={(e) => updateLayer('opportunity', 'customer_demand', e.target.value)}
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => updateLayer('opportunity', 'competitive_gap', e.target.value)}
            ...
            <div>
              <label className="block text-sm font-medium mb-2">我们的优势</label>
              <Textarea
                value={data.our_advantage || ''}
                onChange={(e) => updateLayer('opportunity', 'our_advantage', e.target.value)}
                placeholder="我们凭什么能赢？"
                disabled={readOnly}
                rows={2}
              />
            ...
            <div className="border-t pt-4">
              <label className="block text-sm font-medium mb-3">四点合一分析</label>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs text-gray-600 mb-1">行业是否有增长</label>
                  <Textarea
                    value={data.four_in_one?.industry_growth || ''}
                    onChange={(e) => updateNestedField('opportunity', 'four_in_one.industry_growth', e.target.value)}
                    disabled={readOnly}
                    rows={2}
                  />
                </div>
                <div>
                  <label className="block text-xs text-gray-600 mb-1">竞争是否有空隙</label>
                  <Textarea
                    value={data.four_in_one?.competitive_gap || ''}
                    onChange={(e) => updateNestedField('opportunity', 'four_in_one.competitive_gap', e.target.value)}
                    disabled={readOnly}
                    rows={2}
                  />
                </div>
                <div>
                  <label className="block text-xs text-gray-600 mb-1">客户是否有需求</label>
                  <Textarea
                    value={data.four_in_one?.customer_demand || ''}
                    onChange={(e) => updateNestedField('opportunity', 'four_in_one.customer_demand', e.target.value)}
                    disabled={readOnly}
                    rows={2}
                  />
                </div>
                <div>
                  <label className="block text-xs text-gray-600 mb-1">我们是否有优势</label>
                  <Textarea
                    value={data.four_in_one?.our_advantage || ''}
                    onChange={(e) => updateNestedField('opportunity', 'four_in_one.our_advantage', e.target.value)}
                    disabled={readOnly}
                    rows={2}
                  />
                </div>
            ...
            <div>
              <label className="block text-sm font-medium mb-2">凭什么能赢的逻辑</label>
              <Textarea
                value={data.why_we_win || ''}
                onChange={(e) => updateLayer('opportunity', 'why_we_win', e.target.value)}
    ...
    return (
      <Card className="mb-4">
        ...
        {expandedLayers.positioning && (
          <CardContent className="p-6 space-y-4">
            <div>
              <label className="block text-sm font-medium mb-2">聚焦的赛道/细分市场</label>
              <Textarea
                value={data.market_segment || ''}
                onChange={(e) => updateLayer('positioning', 'market_segment', e.target.value)}
            ...
            <div>
              <label className="block text-sm font-medium mb-2">差异化方式</label>
              <Textarea
                value={data.differentiation || ''}
                onChange={(e) => updateLayer('positioning', 'differentiation', e.target.value)}
            ...
            <div>
              <label className="block text-sm font-medium mb-2">核心客户群体</label>
              <Textarea
                value={data.target_customers || ''}
                onChange={(e) => updateLayer('positioning', 'target_customers', e.target.value)}
            ...
            <div>
              <label className="block text-sm font-medium mb-2">独特价值主张</label>
              <Textarea
                value={data.value_proposition || ''}
                onChange={(e) => updateLayer('positioning', 'value_proposition', e.target.value)}
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => updateLayer('positioning', 'competitive_barrier', e.target.value)}
          ...
          <CardContent className="p-6 space-y-4">
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => updateLayer('goals', 'strategic_hypothesis', e.target.value)}
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => updateLayer('goals', 'annual_goals', e.target.value)}
                placeholder="年度目标"
                disabled={readOnly}
                rows={2}
              />
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => updateLayer('goals', 'quarterly_goals', e.target.value)}
                placeholder="季度目标"
                disabled={readOnly}
                rows={2}
              />
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => updateLayer('goals', 'monthly_goals', e.target.value)}
                placeholder="月度目标"
                disabled={readOnly}
                rows={2}
              />
              ...
              <div className="space-y-2">
                  ...
                  <div key={index} className="flex gap-2 items-start p-3 border rounded-lg">
                    <div className="flex-1 grid grid-cols-3 gap-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          const newMetrics = [...(data.key_metrics || [])]
                          newMetrics[index] = { ...newMetrics[index], target: e.target.value }
                          updateLayer('goals', 'key_metrics', newMetrics)
                        }}
                        placeholder="目标值"
                        disabled={readOnly}
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          const newMetrics = [...(data.key_metrics || [])]
                          newMetrics[index] = { ...newMetrics[index], purpose: e.target.value }
                          updateLayer('goals', 'key_metrics', newMetrics)
                        }}
                        placeholder="验证目的"
                        disabled={readOnly}
                    ...
                    {!readOnly && (
                      <Button
                        ...
                        size="sm"
                        onClick={() => {
                          const newMetrics = (data.key_metrics || []).filter((_, i) => i !== index)
                          updateLayer('goals', 'key_metrics', newMetrics)
                        }}
                      >
                ...
                {!readOnly && (
                  <Button
                    ...
                    size="sm"
                    onClick={() => {
                      const newMetrics = [...(data.key_metrics || []), { name: '', target: '', purpose: '' }]
                      updateLayer('goals', 'key_metrics', newMetrics)
                    }}
                  >
          ...
          <CardContent className="p-6 space-y-4">
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => updateLayer('path', 'customer_need_essence', e.target.value)}
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => updateLayer('path', 'product_solution', e.target.value)}
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => updateLayer('path', 'service_experience', e.target.value)}
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => updateLayer('path', 'repurchase_mechanism', e.target.value)}
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => updateLayer('path', 'execution_order', e.target.value)}
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => updateLayer('path', 'resources', e.target.value)}
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => updateLayer('path', 'campaigns', e.target.value)}

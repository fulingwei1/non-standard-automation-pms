...
export const revenueTypes = {
  PRODUCT_SALES: {
    ...
    color: "text-green-400",
    percentage: 60,
    description: "自动化设备销售收入"
  },
  SERVICE_FEES: {
    label: "服务收入",
    color: "text-blue-400",
    percentage: 25,
    description: "技术服务、维修、培训等收入"
  },
  CONSULTING: {
    label: "咨询收入",
    color: "text-purple-400",
    percentage: 10,
    description: "技术咨询和方案设计收入"
  },
  OTHER: {
    label: "其他收入",
    color: "text-gray-400",
...
export const costTypes = {
  MATERIAL_COST: {
    ...
    color: "text-red-400",
    percentage: 45,
    description: "原材料、零部件采购成本"
  },
  LABOR_COST: {
    label: "人工成本",
    color: "text-orange-400",
    percentage: 30,
    description: "生产人员、管理人员工资福利"
  },
  OVERHEAD: {
    label: "制造费用",
    color: "text-amber-400",
    percentage: 15,
    description: "厂房租金、设备折旧、水电等"
  },
  MARKETING: {
    label: "营销费用",
    color: "text-cyan-400",
...
export const cashFlowTypes = {
  OPERATING: {
    label: "经营活动现金流",
    color: "text-green-400",
    description: "主营业务产生的现金流量"
  },
  INVESTING: {
    label: "投资活动现金流",
    color: "text-blue-400",
    description: "投资和资产处置产生的现金流量"
  },
  FINANCING: {
    label: "筹资活动现金流",
    color: "text-purple-400",
    description: "融资和还款产生的现金流量"
  },
  NET: {
    label: "现金流量净额",
    color: "text-emerald-400",
...
export const chartTypes = {
  ...
  PIE: {
    label: "饼图",
    component: "PieChart",
    description: "展示部分与整体的关系"
  },
  AREA: {
    label: "面积图",
    component: "AreaChart",
    description: "展示总量和趋势，适合占比分析"
  },
  GAUGE: {
    label: "仪表图",
    component: "GaugeChart",
    description: "展示单个指标的完成度"
  },
  DUAL_AXES: {
    label: "双轴图",
...
export const alertRules = {
  lowCashFlow: {
    threshold: -100000,
    message: "现金流为负，需要关注资金状况",
    severity: "HIGH"
  },
  highDebtRatio: {
    threshold: 0.7,
    message: "负债率过高，存在财务风险",
    severity: "MEDIUM"
  },
  decliningRevenue: {
    threshold: -0.1,
    message: "收入连续下降，需要分析原因",
    severity: "MEDIUM"
  },
  highOperatingCost: {
    threshold: 0.8,

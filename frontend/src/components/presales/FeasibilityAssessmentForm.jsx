...
export default function FeasibilityAssessmentForm({
  opportunity,
  onSave,
  onCancel,
}) {
            ...
            <div>
              ...
              {opportunity?.expectedAmount && (
                <p className="text-sm text-emerald-400 mt-1">
                  预计金额：¥{(opportunity.expectedAmount / 10000).toFixed(0)}万
                </p>
              )}
            </div>
            <Badge
              className={cn(
                "text-xs",
                feasibilityStatus.bgColor,
                feasibilityStatus.color,
              )}
            >
      ...
      <div className="space-y-4">
        {assessmentDimensions.map((dimension) => {
          ...
          const dimensionPercentage =
            dimensionMaxScore > 0
              ? (dimensionScore / dimensionMaxScore) * 100
              : 0;
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-sm font-semibold text-white">
                      {dimensionPercentage.toFixed(0)}分
                    </p>
      ...
      <Card className="bg-gradient-to-br from-primary/10 to-indigo-500/10 border border-primary/20">
        <CardContent className="p-4">
          ...
          <div className="mt-3 flex items-center gap-2">
            ...
            <span
              className={cn("text-sm font-medium", feasibilityStatus.color)}
            >
              {feasibilityStatus.label}
            </span>
          </div>

...
export function UserCard({
  ...
  // 获取用户状态配置
  const statusConfig = getAccountStatusConfig(user.is_active ? "NORMAL" : "DISABLED");
  ...
  const renderCredits = () => {
    ...
    if (credits < 50) creditColor = "text-red-600";
    else if (credits < 100) creditColor = "text-yellow-600";

    ...
    hr_manager: [
      {
        label: '人力资源',
        items: [
          { name: '人事工作台', path: '/hr-dashboard', icon: 'LayoutDashboard' },
...
export function hasProductionAccess(role, isSuperuser = false) {
  ...
  const allowedRoles = [
    'admin', 'super_admin', 'chairman', 'gm',
    'manufacturing_director', 'production_manager',
    'pmc', 'pm', 'project_dept_manager',
    'assembler', 'assembler_mechanic', 'assembler_electrician',
    '制造总监', '生产部经理', '项目经理', '装配技工', '装配钳工', '装配电工',
  ];
...
export function isEngineerRole(role) {
  const engineerRoles = [
    'me_engineer', 'ee_engineer', 'sw_engineer', 'te_engineer', 'rd_engineer',
    'me_leader', 'ee_leader', 'te_leader',
    'procurement_engineer', 'customer_service_engineer',
    '机械工程师', '电气工程师', '软件工程师', '测试工程师', '研发工程师',
    '采购工程师', '客服工程师',
  ];
...
export function isManagerRole(role) {
  const managerRoles = [
    'chairman', 'gm', 'admin', 'super_admin',
    'sales_director', 'sales_manager',
    'project_dept_manager', 'tech_dev_manager',
    'me_dept_manager', 'ee_dept_manager', 'te_dept_manager',
    'procurement_manager', 'production_manager', 'manufacturing_director',
    'finance_manager', 'hr_manager', 'customer_service_manager',
    '董事长', '总经理', '管理员',
  ];

...
vi.mock('../../../../services/api', () => {
    return {
        acceptanceApi: { list: vi.fn(), get: vi.fn(), create: vi.fn(), update: vi.fn(), delete: vi.fn(), query: vi.fn(), aiMatch: vi.fn(), assign: vi.fn(), listExecutions: vi.fn(), startExecution: vi.fn(), submitResult: vi.fn() }
    };
});

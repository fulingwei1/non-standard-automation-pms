                ...
                <TableBody>
                  {filteredReceipts.map((receipt) => (
                    <TableRow key={receipt.id} className="border-slate-700">
                      ...
                      <TableCell className="text-slate-300">
                        {receipt.item_count || receipt.items?.length || 0} 项
                      </TableCell>
                      ...
                      <TableCell>
                        <Badge
                          className={
                            statusConfigs[receipt.status]?.color ||
                            "bg-slate-500"
                          }
                        >
                          {statusConfigs[receipt.status]?.label ||
                            receipt.status}
                        </Badge>
                      </TableCell>
                      <TableCell>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Badge
                        className={statusConfigs[selectedReceipt.status]?.color}
                      >
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(val) =>
                        setReceiveData({ ...receiveData, quality_status: val })
                      }
                    >
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setReceiveData({ ...receiveData, note: e.target.value })
                      }
                      placeholder="备注信息"
                      className="bg-slate-800 border-slate-700 text-slate-200"
                    />

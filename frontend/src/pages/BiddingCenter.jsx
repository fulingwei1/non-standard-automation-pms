...
export default function BiddingCenter() {
  ...
  const stats = {
    ...
    active: mockBiddings.filter((b) => !['won', 'lost'].includes(b.stage)).length,
    won: mockBiddings.filter((b) => b.stage === 'won').length,
    totalAmount: mockBiddings.filter((b) => b.stage === 'won').reduce((acc, b) => acc + b.amount, 0),
  }

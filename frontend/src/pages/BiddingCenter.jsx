...
const mockBiddings = [
  {
    ...
    salesPerson: '李销售',
    progress: 60,
    solution: 'SOL-2026-005',
    solutionName: '汽车零部件检测设备方案',
    techRequirements: '需提供完整的汽车零部件检测解决方案，包括尺寸测量、外观检测、功能测试等。',
    competitors: [
      { name: '竞争对手A', status: 'confirmed', price: '约110万' },
      { name: '竞争对手B', status: 'rumored', price: '未知' },
    ],
    documents: [
      { name: '技术标书', status: 'in_progress', progress: 70 },
      { name: '商务标书', status: 'pending', progress: 0 },
      { name: '资质文件', status: 'completed', progress: 100 },
      { name: '业绩证明', status: 'completed', progress: 100 },
    ],
    timeline: [
      { date: '2025-12-20', event: '获取招标信息', status: 'completed' },
      { date: '2025-12-25', event: '购买标书', status: 'completed' },
      { date: '2026-01-05', event: '技术方案确定', status: 'completed' },
      { date: '2026-01-10', event: '技术标书完成', status: 'in_progress' },
      { date: '2026-01-13', event: '商务标书完成', status: 'pending' },
      { date: '2026-01-15', event: '投标截止', status: 'pending' },
    ],
    notes: '客户更看重技术能力和售后服务，价格不是首要因素。',
    costSupport: {
      status: 'requested', // 'none', 'requested', 'in_progress', 'submitted', 'approved'
  ...
  },
  {
    ...
    solution: null,
    solutionName: null,
    techRequirements: '充电桩综合测试设备，要求覆盖绝缘、耐压、功率、通信等测试项目。',
    competitors: [
      { name: '竞争对手C', status: 'confirmed', price: '约75万' },
    ],
    documents: [
      { name: '技术标书', status: 'pending', progress: 0 },
      { name: '商务标书', status: 'pending', progress: 0 },
      { name: '资质文件', status: 'pending', progress: 0 },
    ],
    timeline: [
      { date: '2025-12-28', event: '获取招标信息', status: 'completed' },
      { date: '2026-01-08', event: '技术交流', status: 'pending' },
      { date: '2026-01-12', event: '方案确定', status: 'pending' },
      { date: '2026-01-18', event: '标书完成', status: 'pending' },
      { date: '2026-01-20', event: '投标截止', status: 'pending' },
    ],
    notes: '需要先完成技术交流和需求调研，再制定方案。',
    costSupport: {
      status: 'none',
      requestedAt: null,
      requestedBy: null,
  ...
  },
  {
    ...
    salesPerson: '王销售',
    progress: 100,
    solution: 'SOL-2026-004',
    solutionName: '视觉检测系统技术方案',
    techRequirements: '基于深度学习的视觉检测系统，要求支持多种缺陷检测。',
    competitors: [],
    documents: [
      { name: '技术标书', status: 'completed', progress: 100 },
      { name: '商务标书', status: 'completed', progress: 100 },
      { name: '资质文件', status: 'completed', progress: 100 },
      { name: '业绩证明', status: 'completed', progress: 100 },
    ],
    timeline: [
      { date: '2025-12-15', event: '获取招标信息', status: 'completed' },
      { date: '2025-12-20', event: '技术方案确定', status: 'completed' },
      { date: '2025-12-28', event: '标书完成', status: 'completed' },
      { date: '2026-01-05', event: '提交投标', status: 'completed' },
      { date: '2026-01-10', event: '开标评审', status: 'pending' },
    ],
    notes: '我司在视觉检测领域有明显优势，预计中标概率较高。',
    costSupport: {
      status: 'submitted',
  ...
  },
  {
    ...
    salesPerson: '张销售',
    progress: 100,
    solution: 'SOL-2025-010',
    solutionName: 'BMS测试设备方案',
    techRequirements: 'BMS综合测试设备，支持多规格产品测试。',
    competitors: [
      { name: '竞争对手A', status: 'lost', price: '138万' },
      { name: '竞争对手D', status: 'lost', price: '142万' },
    ],
    documents: [
      { name: '技术标书', status: 'completed', progress: 100 },
      { name: '商务标书', status: 'completed', progress: 100 },
    ...
    timeline: [
      { date: '2025-11-20', event: '获取招标信息', status: 'completed' },
      { date: '2025-12-01', event: '提交投标', status: 'completed' },
      { date: '2025-12-15', event: '开标评审', status: 'completed' },
      { date: '2025-12-18', event: '中标公示', status: 'completed' },
    ],
    notes: '技术方案优势明显，成功中标。',
  },
  {
    ...
    salesPerson: '李销售',
    progress: 100,
    solution: 'SOL-2025-008',
    solutionName: 'FCT测试设备方案',
    techRequirements: 'FCT功能测试设备。',
    competitors: [
      { name: '竞争对手B', status: 'won', price: '52万' },
    ],
    documents: [
      { name: '技术标书', status: 'completed', progress: 100 },
      { name: '商务标书', status: 'completed', progress: 100 },
    ...
    timeline: [
      { date: '2025-11-10', event: '获取招标信息', status: 'completed' },
      { date: '2025-11-25', event: '提交投标', status: 'completed' },
      { date: '2025-11-30', event: '开标评审', status: 'completed' },
      { date: '2025-12-05', event: '结果公布', status: 'completed' },
    ],
    notes: '价格竞争激烈，未能中标。后续关注技术升级和成本优化。',
  },
]
...
function BiddingCard({ bidding, onClick }) {
  ...
  const isOverdue = bidding.daysLeft === 0 && !['won', 'lost'].includes(bidding.stage)
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="bg-surface-50 p-3 rounded-lg">
              ...
              <p className="text-sm text-emerald-400 font-medium">¥{bidding.amount}万</p>
            </div>
            <div className="bg-surface-50 p-3 rounded-lg">
            ...
            <div className={cn(
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg font-bold text-white">{bidding.deadline}</p>
                </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-white bg-surface-50 p-3 rounded-lg">{bidding.techRequirements}</p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between p-3 bg-surface-50 rounded-lg">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-white">{bidding.solutionName}</span>
                </div>
          ...
          <div className="space-y-2">
            ...
            {bidding.costSupport?.status === 'requested' && (
              <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                ...
                <p className="text-xs text-slate-400">
                  申请时间：{bidding.costSupport.requestedAt} | 申请人员：{bidding.costSupport.requestedBy}
                </p>
            ...
            {bidding.costSupport?.status === 'in_progress' && (
              <div className="p-3 bg-amber-500/10 border border-amber-500/20 rounded-lg">
                ...
                <p className="text-xs text-slate-400">售前技术工程师正在核算成本...</p>
              </div>
            )}

            {bidding.costSupport?.status === 'submitted' && bidding.costSupport.estimatedCost && (
              <div className="space-y-3">
                <div className="p-3 bg-emerald-500/10 border border-emerald-500/20 rounded-lg">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-emerald-400" />
                      <span className="text-sm text-white">成本估算已完成</span>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className={cn(
                        ...
                        bidding.costSupport.estimatedCost.grossMargin >= 30 ? 'text-emerald-400' :
                        bidding.costSupport.estimatedCost.grossMargin >= 20 ? 'text-amber-400' : 'text-red-400'
                      )}>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white">{bidding.costSupport.submittedBy}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-3 bg-surface-50 rounded-lg">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <span className="text-white">¥{bidding.costSupport.estimatedCost.mechanical}万</span>
                    </div>
                    <div className="flex items-center justify-between text-xs">
                      <span className="text-slate-400">电气部分</span>
                      <span className="text-white">¥{bidding.costSupport.estimatedCost.electrical}万</span>
                    </div>
                    <div className="flex items-center justify-between text-xs">
                      <span className="text-slate-400">软件部分</span>
                      <span className="text-white">¥{bidding.costSupport.estimatedCost.software}万</span>
                    </div>
                    <div className="flex items-center justify-between text-xs">
                      <span className="text-slate-400">标准件/外购件</span>
                      <span className="text-white">¥{bidding.costSupport.estimatedCost.standard}万</span>
                    </div>
                    <div className="flex items-center justify-between text-xs">
                      <span className="text-slate-400">人工成本</span>
                      <span className="text-white">¥{bidding.costSupport.estimatedCost.labor}万</span>
                    </div>
                    <div className="flex items-center justify-between text-xs">
                      <span className="text-slate-400">其他费用</span>
                      <span className="text-white">¥{bidding.costSupport.estimatedCost.other}万</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-2">
              {bidding.documents.map((doc, index) => (
                <div key={index} className="flex items-center justify-between p-3 bg-surface-50 rounded-lg">
                  ...
                  {doc.status === 'in_progress' && <Clock className="w-4 h-4 text-blue-500" />}
                  {doc.status === 'pending' && <AlertTriangle className="w-4 h-4 text-slate-500" />}
                </div>
              ))}
            </div>
          </div>
                  ...
                  <div key={index} className="flex items-center justify-between p-3 bg-surface-50 rounded-lg">
                    <div className="flex items-center gap-2">
                      ...
                      <Badge variant="outline" className="text-xs">
                        {competitor.status === 'confirmed' ? '已确认' : competitor.status === 'rumored' ? '传闻' : competitor.status === 'won' ? '中标' : '未中标'}
                      </Badge>
                    </div>
                ...
                <div key={index} className="flex gap-3">
                  <div className="flex flex-col items-center">
                    <div className={cn(
                      ...
                      item.status === 'in_progress' ? 'bg-blue-500' : 'bg-slate-600'
                    )}>
          ...
          {bidding.notes && (
            <div className="space-y-2">
              ...
              <p className="text-sm text-white bg-surface-50 p-3 rounded-lg">{bidding.notes}</p>
            </div>
          )}
        </div>
...
export default function BiddingCenter() {
  ...
  const loadTenders = useCallback(async () => {
    try {
      ...
      const transformedTenders = tendersData.map(tender => {
        ...
        const now = new Date()
        const daysLeft = deadline ? Math.ceil((deadline - now) / (1000 * 60 * 60 * 24)) : 0
        ...
        return {
          ...
          techRequirements: tender.tech_requirements || tender.description || '',
          competitors: [],
          documents: [],
          timeline: [],
          notes: tender.notes || '',
  ...
  const stats = {
    ...
    totalAmount: biddings.filter((b) => b.stage === 'won').reduce((acc, b) => acc + b.amount, 0),
  }
  ...
  return (
    ...
    >
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-violet-400">¥{stats.totalAmount}万</p>
              </div>
            </div>
          </CardContent>
        </Card>
                ...
                <CardContent className="p-3 space-y-3 min-h-[300px] max-h-[calc(100vh-400px)] overflow-y-auto custom-scrollbar">
                  {column.biddings.length > 0 ? (
                    column.biddings.map((bidding) => (
                      <BiddingCard key={bidding.id} bidding={bidding} onClick={setSelectedBidding} />
                    ))
                  ) : (
      ...
      {/* 投标详情面板 */}
      {selectedBidding && (
        <BiddingDetailPanel bidding={selectedBidding} onClose={() => setSelectedBidding(null)} />
      )}
    </motion.div>
  )
}

...
import { useBiddingCenter } from '../useBiddingCenter';
import { biddingApi } from '../../../../services/api';

// Mock API
vi.mock('../../../../services/api', () => {
    return {
        biddingApi: { list: vi.fn(), get: vi.fn(), create: vi.fn(), update: vi.fn(), delete: vi.fn(), query: vi.fn(), aiMatch: vi.fn(), assign: vi.fn(), submit: vi.fn() }
    };
});
...
describe('useBiddingCenter Hook', () => {
  ...
  it('should load data', async () => {
    const { result } = renderHook(() => useBiddingCenter());

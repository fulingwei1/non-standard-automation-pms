...
import { useBiddingDetail } from '../useBiddingDetail';
import { biddingApi } from '../../../../services/api';

// Mock API
vi.mock('../../../../services/api', () => {
    return {
        biddingApi: { list: vi.fn(), get: vi.fn(), create: vi.fn(), update: vi.fn(), delete: vi.fn(), query: vi.fn(), aiMatch: vi.fn(), assign: vi.fn(), submitBid: vi.fn() }
    };
});

describe('useBiddingDetail Hook', () => {

...
describe('useContractApproval Hook', () => {
  ...
  beforeEach(() => {
    ...
    const apiObjects = [contractApprovalApi];
  ...
  it('should load data', async () => {
    const { result } = renderHook(() => useContractApproval());

...
const mockContracts = [
  {
    ...
    salesPerson: '张销售',
    paymentTerms: [
      { type: 'deposit', percent: 30, amount: 255000, dueDate: '2026-01-10', status: 'paid', paidDate: '2026-01-05' },
      { type: 'progress', percent: 40, amount: 340000, dueDate: '2026-02-01', status: 'pending' },
      { type: 'acceptance', percent: 25, amount: 212500, dueDate: '2026-03-15', status: 'pending' },
      { type: 'warranty', percent: 5, amount: 42500, dueDate: '2027-02-28', status: 'pending' },
    ],
  ...
  },
  {
    ...
    warrantyMonths: 12,
    warrantyEndDate: '2027-01-25',
    salesPerson: '张销售',
    paymentTerms: [
      { type: 'deposit', percent: 30, amount: 360000, dueDate: '2025-12-30', status: 'paid', paidDate: '2025-12-29' },
      { type: 'progress', percent: 30, amount: 360000, dueDate: '2026-01-15', status: 'paid', paidDate: '2026-01-10' },
      { type: 'delivery', percent: 20, amount: 240000, dueDate: '2026-01-25', status: 'pending' },
      { type: 'acceptance', percent: 15, amount: 180000, dueDate: '2026-02-10', status: 'pending' },
      { type: 'warranty', percent: 5, amount: 60000, dueDate: '2027-01-25', status: 'pending' },
    ],
    attachments: ['合同正本.pdf', '技术规格书.pdf', '补充协议.pdf'],
    notes: '',
  ...
  },
  {
    ...
    salesPerson: '张销售',
    paymentTerms: [
      { type: 'deposit', percent: 30, amount: 135000, dueDate: '2025-10-25', status: 'paid', paidDate: '2025-10-22' },
      { type: 'progress', percent: 40, amount: 180000, dueDate: '2026-01-20', status: 'pending' },
      { type: 'acceptance', percent: 25, amount: 112500, dueDate: '2026-03-01', status: 'pending' },
      { type: 'warranty', percent: 5, amount: 22500, dueDate: '2027-02-20', status: 'pending' },
    ],
  ...
  },
  {
    ...
    salesPerson: '张销售',
    paymentTerms: [
      { type: 'deposit', percent: 30, amount: 204000, status: 'paid', paidDate: '2024-08-28' },
      { type: 'progress', percent: 40, amount: 272000, status: 'paid', paidDate: '2024-10-15' },
      { type: 'acceptance', percent: 25, amount: 170000, status: 'paid', paidDate: '2024-12-10' },
      { type: 'warranty', percent: 5, amount: 34000, dueDate: '2025-11-30', status: 'overdue' },
    ],
    attachments: ['合同正本.pdf', '验收报告.pdf'],
    notes: '质保金已逾期',

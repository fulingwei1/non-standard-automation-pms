...
describe('useCustomerCommunication Hook', () => {
  ...
  beforeEach(() => {
    ...
    const apiObjects = [communicationApi, customerApi];
  ...
  it('should load data', async () => {
    const { result } = renderHook(() => useCustomerCommunication());

...
// Mock data - 统计数据
const mockStats = {
  pendingIssues: 12,           // 待处理问题
  inProgressServices: 8,        // 进行中服务
  resolvedThisMonth: 45,        // 本月解决问题
  customerSatisfaction: 4.6,    // 客户满意度（5分制）
  activeProjects: 15,           // 活跃项目（S8/S9）
  urgentIssues: 3,             // 紧急问题
  todayTasks: 6,                // 今日任务
  warrantyProjects: 22,         // 质保期项目
}
...
const mockIssues = [
  ...
  },
  {
    ...
    status: 'resolved',
    reporter: '张工',
    reportDate: '2026-01-05 10:15',
    resolvedDate: '2026-01-06 09:00',
    assignee: '当前用户',
    followUpCount: 1,
  },
]

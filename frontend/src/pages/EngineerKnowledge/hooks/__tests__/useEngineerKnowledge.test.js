...
describe('useEngineerKnowledge Hook', () => {
  ...
  beforeEach(() => {
    ...
    const apiObjects = [engineerKnowledgeApi];
  ...
  it('should load data', async () => {
    const { result } = renderHook(() => useEngineerKnowledge());

                      ...
                      return (
                        <div key={index} className="p-4 bg-slate-800/40 rounded-lg">
                          <div className="flex items-center justify-between mb-3">
                            ...
                            <div className="flex items-center gap-4">
                              <div className="text-right">
                                <div className="text-xs text-slate-500">流入</div>
                                <div className="text-sm font-medium text-emerald-400">
                                  {formatCurrency(item.inflow)}
                                </div>
                              </div>
                              <div className="text-right">
                                <div className="text-xs text-slate-500">流出</div>
                                <div className="text-sm font-medium text-red-400">
                                  {formatCurrency(item.outflow)}
                                </div>
                              </div>
                              <div className="text-right">
                                <div className="text-xs text-slate-500">净流量</div>
                                <div className={cn(
                                  'text-lg font-bold',
                          ...
                          <Progress
                            ...
                            className={cn(
                              'h-2',
                              item.net > 0 ? 'bg-emerald-500/20' : 'bg-red-500/20'
                            )}
                          />
                        </div>
                      )
                        ...
                        <div key={index} className="space-y-2">
                          ...
                          <div className="flex items-center gap-2">
                            <Progress
                              ...
                              className={cn(
                                'flex-1 h-2',
                                used > 100 ? 'bg-red-500/20' : used > 90 ? 'bg-amber-500/20' : 'bg-slate-700/50'
                              )}
                            />
                        ...
                        >
                          ...
                          <div className="space-y-2">
                            <div className="flex items-center justify-between text-xs">
                              ...
                              <span className="text-red-400">{formatCurrency(project.cost)}</span>
                            </div>
                            <div className="flex items-center justify-between text-xs">
                              <span className="text-slate-400">利润率</span>
                              <span className={cn(
                                'font-medium',
                                project.margin >= 30 ? 'text-emerald-400' :
                                project.margin >= 20 ? 'text-amber-400' : 'text-red-400'
                              )}>
                            ...
                            <Progress
                              ...
                              className={cn(
                                'h-2',
                                project.margin >= 30 ? 'bg-emerald-500/20' :
                                project.margin >= 20 ? 'bg-amber-500/20' : 'bg-red-500/20'
                              )}
                            />
                          </div>
                        </div>

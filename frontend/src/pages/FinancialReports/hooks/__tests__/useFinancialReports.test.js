...
vi.mock('../../../../services/api', () => {
    return {
        reportApi: { list: vi.fn(), get: vi.fn(), create: vi.fn(), update: vi.fn(), delete: vi.fn(), query: vi.fn(), aiMatch: vi.fn(), assign: vi.fn(), exportFinancial: vi.fn(), generateFinancial: vi.fn(), listFinancial: vi.fn() }
    };
});

...
export default function IssueStatisticsSnapshot() {
  ...
  const comparison = useMemo(() => {
    ...
    return {
      ...
      resolved: {
        current: latest.resolved_issues,
        previous: earliest.resolved_issues,
      },
      blocking: {
        current: latest.blocking_issues,
        previous: earliest.blocking_issues,
      },
    };
  }, [snapshots]);
              ...
              <CardContent className="p-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="text-2xl font-bold text-white">
                    {comparison.total.current}
                  </div>
                  {comparison.total.previous && (
                    <div
                      className={cn(
                        "text-sm flex items-center gap-1",
                        comparison.total.current > comparison.total.previous
                          ? "text-red-400"
                          : "text-green-400",
                      )}
                    >
              ...
              <CardContent className="p-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="text-2xl font-bold text-blue-400">
                    {comparison.open.current}
                  </div>
                  {comparison.open.previous && (
                    <div
                      className={cn(
                        "text-sm flex items-center gap-1",
                        comparison.open.current > comparison.open.previous
                          ? "text-red-400"
                          : "text-green-400",
                      )}
                    >
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                  <div className="text-sm text-slate-400 mb-1">总问题数</div>
                  <div className="text-2xl font-bold text-white">
                    {selectedSnapshot.total_issues || 0}
                  </div>
                </div>
                <div>
                  <div className="text-sm text-slate-400 mb-1">阻塞问题</div>
                  <div className="text-2xl font-bold text-red-400">
                    {selectedSnapshot.blocking_issues || 0}
                  </div>
                </div>
                <div>
                  <div className="text-sm text-slate-400 mb-1">逾期问题</div>
                  <div className="text-2xl font-bold text-orange-400">
                    {selectedSnapshot.overdue_issues || 0}
                  </div>
                </div>
              </div>

...
vi.mock('../../../../services/api', () => {
    return {
        knowledgeBaseApi: { list: vi.fn(), get: vi.fn(), create: vi.fn(), update: vi.fn(), delete: vi.fn(), query: vi.fn(), aiMatch: vi.fn(), assign: vi.fn(), getCategories: vi.fn(), listArticles: vi.fn() }
    };
});

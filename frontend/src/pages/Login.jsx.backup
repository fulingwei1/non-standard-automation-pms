...
const demoAccountGroups = [
  ...
  },
  {
    ...
    accounts: [
      ...
      {
        roleCode: "business_support",
        icon: FileText,
        color: "from-violet-500 to-purple-500",
      },
      {
        roleCode: "presales_manager",
        icon: Lightbulb,
        color: "from-amber-500 to-orange-600",
      },
      {
  ...
  },
  {
    ...
    accounts: [
      {
        roleCode: "project_dept_manager",
        icon: Briefcase,
        color: "from-blue-500 to-indigo-600",
      },
      {
        roleCode: "demo_pm_liu",
        icon: ClipboardList,
        color: "from-amber-500 to-orange-500",
      },
      {
  ...
  },
  {
    ...
    accounts: [
      {
        roleCode: "tech_dev_manager",
        icon: Settings,
        color: "from-indigo-500 to-purple-600",
      },
      {
        roleCode: "rd_engineer",
        icon: GitBranch,
        color: "from-cyan-500 to-blue-600",
      },
      {
        roleCode: "me_dept_manager",
        icon: Cog,
        color: "from-blue-500 to-indigo-500",
      },
      {
        roleCode: "te_dept_manager",
        icon: TestTube,
        color: "from-purple-500 to-violet-600",
      },
      {
        roleCode: "ee_dept_manager",
        icon: CircuitBoard,
        color: "from-amber-500 to-yellow-600",
      },
      {
        roleCode: "me_engineer",
        icon: Cog,
        color: "from-blue-500 to-indigo-500",
      },
      {
        roleCode: "te_engineer",
        icon: TestTube,
        color: "from-purple-500 to-violet-500",
      },
      {
        roleCode: "ee_engineer",
        icon: Zap,
  ...
  },
  {
    ...
    accounts: [
      {
        roleCode: "manufacturing_director",
        icon: Factory,
        color: "from-indigo-500 to-purple-600",
      },
      {
      ...
      {
        roleCode: "assembler_mechanic",
        icon: Wrench,
        color: "from-slate-500 to-gray-600",
      },
      {
        roleCode: "assembler_electrician",
        icon: Hammer,
      ...
      {
        roleCode: "customer_service_engineer",
        icon: Headphones,
...
export default function Login({ onLoginSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const isDemoAccount =
      demoUser && (password === "admin123" || password === "demo123");

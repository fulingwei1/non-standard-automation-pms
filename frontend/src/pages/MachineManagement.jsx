...
export default function MachineManagement() {
  ...
  const handleDownloadDocument = async (doc) => {
    try {
      const response = await machineApi.downloadDocument(
        selectedMachine.id,
        doc.id,
      );
      ...
      const errorMessage =
        error.response?.data?.detail || error.message || "下载失败";
      // 如果是权限错误，提供更友好的提示
      if (error.response?.status === 403) {
        alert(
    ...
    <div className="space-y-6 p-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>共 {filteredMachines.length} 个机台</CardDescription>
        </CardHeader>
        <CardContent>
          {loading ? (
                ...
                {filteredMachines.map((machine) => (
                  <TableRow key={machine.id}>
                    ...
                    <TableCell>
                      <Badge
                        className={
                          statusConfigs[machine.status]?.color || "bg-slate-500"
                        }
                      >
                    ...
                    <TableCell>
                      <Badge
                        className={
                          healthConfigs[machine.health]?.color || "bg-slate-500"
                        }
                      >
                    ...
                    <TableCell className="text-right">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            navigate(`/bom?machine_id=${machine.id}`)
                          }
                        >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    setNewMachine({ ...newMachine, status: val, stage: val })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    setNewMachine({ ...newMachine, health: val })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
      ...
      >
        <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              机台详情 - {selectedMachine?.machine_code}
            </DialogTitle>
          </DialogHeader>
          <DialogBody>
            {selectedMachine && (
              ...
              >
                ...
                <TabsContent value="info" className="space-y-4 mt-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Badge
                        className={statusConfigs[selectedMachine.status]?.color}
                      >
                    ...
                    <div>
                      ...
                      <Badge
                        className={healthConfigs[selectedMachine.health]?.color}
                      >
                    ...
                    <div>
                      ...
                      <div className="space-y-1">
                        <div className="text-lg font-bold">
                          {selectedMachine.progress || 0}%
                        </div>
                        <Progress
                          value={selectedMachine.progress || 0}
                          className="h-2"
                        />
                      </div>
                    </div>
                ...
                <TabsContent value="documents" className="space-y-4 mt-4">
                  ...
                  {loadingDocuments ? (
                    ...
                    Object.keys(machineDocuments.documents_by_type).length >
                      0 ? (
                      ...
                      {machineDocuments.filtered_count > 0 && (
                        <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-3 text-sm text-amber-800 dark:text-amber-200">
                          <p className="flex items-center gap-2">
                            ...
                            提示：有 {machineDocuments.filtered_count}{" "}
                            个文档因权限限制未显示。如需查看，请联系管理员分配相应角色权限。
                          </p>
                        </div>
                      )}
                      {Object.entries(machineDocuments.documents_by_type).map(
                        ([docType, docs]) => {
                          const config =
                            docTypeConfigs[docType] || docTypeConfigs.OTHER;
                                      ...
                                      <div className="flex items-center gap-2">
                                        ...
                                        <Button
                                          ...
                                          onClick={async () => {
                                            try {
                                              const versions =
                                                await machineApi.getDocumentVersions(
                                                  selectedMachine.id,
                                                  doc.id,
                                                );
                                              const versionList =
                ...
                <TabsContent value="bom" className="space-y-4 mt-4">
                  <div className="text-center py-8">
                    <Button
                      onClick={() =>
                        navigate(`/bom?machine_id=${selectedMachine.id}`)
                      }
                    >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    setUploadForm({ ...uploadForm, doc_type: val })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setUploadForm({ ...uploadForm, doc_name: e.target.value })
                  }
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setUploadForm({ ...uploadForm, doc_no: e.target.value })
                  }
                  placeholder="用于版本管理"
                />
              </div>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    setUploadForm({ ...uploadForm, machine_stage: val })
                  }
                >
                  <SelectTrigger>

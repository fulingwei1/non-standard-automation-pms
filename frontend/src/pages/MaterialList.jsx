            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(val) => setNewMaterial({ ...newMaterial, category_id: val && val !== 'none' ? parseInt(val) : null })}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="选择分类" />
                  </SelectTrigger>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(val) => setNewMaterial({ ...newMaterial, supplier_id: val && val !== 'none' ? parseInt(val) : null })}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="选择供应商" />
                  </SelectTrigger>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="font-mono">{selectedMaterial.material_code}</div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div>{selectedMaterial.unit_price ? formatCurrency(selectedMaterial.unit_price) : '-'}</div>
                  </div>
                  <div>

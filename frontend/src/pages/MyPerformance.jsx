...
const mockMonthlyHistory = [
  {
    ...
    deptScore: 88,
    projectScores: [
      { projectId: 1, projectName: "项目A", score: 92, weight: 60 },
      { projectId: 3, projectName: "项目C", score: 85, weight: 40 },
    ],
    status: "COMPLETED",
    evaluatedBy: "李经理",
    evaluatedAt: "2024-12-31",
    workSummary: "本月完成了项目A的关键模块开发，质量达标。项目C进度正常。",
  },
  {
    id: 2,
    period: "2024-11",
    ...
    deptScore: 86,
    projectScores: [
      { projectId: 1, projectName: "项目A", score: 88, weight: 60 },
      { projectId: 3, projectName: "项目C", score: 84, weight: 40 },
    ],
    status: "COMPLETED",
    evaluatedBy: "李经理",
    evaluatedAt: "2024-11-30",
    workSummary: "项目A按计划推进，但测试阶段发现几个问题需要修复。项目C进度略有延迟。",
  },
  {
    id: 3,
    period: "2024-10",
    ...
    deptScore: 85,
    projectScores: [
      { projectId: 1, projectName: "项目A", score: 86, weight: 60 },
      { projectId: 3, projectName: "项目C", score: 82, weight: 40 },
    ],
    status: "COMPLETED",
    evaluatedBy: "李经理",
    evaluatedAt: "2024-10-31",
    workSummary: "完成了项目A的需求分析和设计文档。项目C进入开发阶段。",
  },
  {
    id: 4,
    period: "2024-09",
    ...
    deptScore: 87,
    projectScores: [
      { projectId: 1, projectName: "项目A", score: 90, weight: 60 },
      { projectId: 2, projectName: "项目B", score: 84, weight: 40 },
    ],
    status: "COMPLETED",
    evaluatedBy: "李经理",
    evaluatedAt: "2024-09-30",
    workSummary: "项目B顺利交付，客户反馈良好。项目A开发工作稳步推进。",
  },
  {
    id: 5,
    period: "2024-08",
    ...
    deptScore: 83,
    projectScores: [
      { projectId: 2, projectName: "项目B", score: 85, weight: 70 },
      { projectId: 1, projectName: "项目A", score: 77, weight: 30 },
    ],
    status: "COMPLETED",
    evaluatedBy: "李经理",
    evaluatedAt: "2024-08-31",
    workSummary: "项目B接近完成，正在进行最后的调试。项目A需求变更导致进度略受影响。",
  },
];

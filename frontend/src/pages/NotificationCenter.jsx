...
export default function NotificationCenter() {
  ...
  const getNotificationType = (notification) => {
    ...
    return typeMap[notification.notification_type] || notification.notification_type?.toLowerCase() || 'system'
  }
  ...
  const formatNotification = (notification) => {
    ...
    return {
      ...
      timestamp: notification.created_at ? new Date(notification.created_at).toLocaleString('zh-CN') : '',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      >
        {[
          ...
          {
            label: '待审批',
            value: notifications.filter((n) => n.type === 'approval' && !n.read)
              .length,
            icon: Users,
            ...
            <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
              ...
              <div className="flex items-center gap-3 w-full lg:w-auto">
                ...
                <Button
                  ...
                  className={cn(showUnreadOnly && 'bg-accent/10 border-accent')}
                >

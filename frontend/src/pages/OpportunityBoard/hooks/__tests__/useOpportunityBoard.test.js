...
vi.mock('../../../../services/api', () => {
    return {
        salesApi: { list: vi.fn(), get: vi.fn(), create: vi.fn(), update: vi.fn(), delete: vi.fn(), query: vi.fn(), aiMatch: vi.fn(), assign: vi.fn(), listOpportunities: vi.fn(), updateOpportunity: vi.fn() }
    };
});

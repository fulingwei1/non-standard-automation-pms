...
const mockPendingPayments = [
  {
    ...
    daysPending: 0,
    dueDate: '2025-01-08',
    description: '铝合金型材、导轨等标准件采购',
    attachments: ['采购订单.pdf', '报价单.pdf'],
  },
  {
    id: 2,
    type: 'outsourcing',
  ...
  },
  {
    ...
    daysPending: 1,
    dueDate: '2025-01-10',
    description: '2025年1月生产部工资',
    attachments: ['工资表.xlsx'],
  },
  {
    id: 5,
    type: 'purchase',
    ...
    daysPending: 2,
    dueDate: '2025-01-12',
    description: 'PLC、传感器等电气件采购',
    attachments: ['采购订单.pdf'],
  },
]

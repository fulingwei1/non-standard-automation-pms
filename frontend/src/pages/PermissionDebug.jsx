      ...
      <Card>
        ...
        <CardContent className="space-y-2">
          <div>
            ...
            <span className="text-white">{userInfo.user.username || userInfo.user.name}</span>
          </div>
          <div>
            <span className="text-slate-400">角色代码: </span>
            <span className="text-white font-mono">{userInfo.role || '未设置'}</span>
          </div>
          <div>
            <span className="text-slate-400">是否超级管理员: </span>
            <span className={userInfo.isSuperuser ? 'text-green-400' : 'text-red-400'}>
      ...
      <Card>
        ...
        <CardContent className="space-y-2">
          <div>
            ...
            <span className={userInfo.hasFinance ? 'text-green-400' : 'text-red-400'}>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-sm text-slate-400 space-y-1">
            <div>hasFinanceAccess('{userInfo.role}', {String(userInfo.isSuperuser)})</div>

...
const mockTasks = [
  {
    ...
    progress: 45,
    description: '客户需要一条完整的电池Pack自动化测试线，包括ICT、FCT、老化、EOL等工站。',
    opportunity: '电池Pack测试线项目',
    amount: 220,
    estimatedHours: 40,
    actualHours: 18,
    assignee: '李工',
    deliverables: ['技术方案文档', '设备配置清单', '报价明细'],
  },
  {
    id: 2,
    ...
    progress: 0,
    description: '客户希望进行技术交流，了解我司EOL测试设备的技术能力和成功案例。',
    opportunity: 'EOL功能测试设备',
    amount: 65,
    estimatedHours: 8,
    actualHours: 0,
    assignee: '李工',
    deliverables: ['技术交流PPT', '案例介绍'],
  },
  {
    id: 3,
    ...
    createdAt: '2026-01-03',
    progress: 0,
    description: '客户有新的储能产品线需要ICT测试设备，需现场调研需求。',
    opportunity: 'ICT测试设备项目',
    amount: 45,
    estimatedHours: 16,
    actualHours: 0,
    assignee: '李工',
    deliverables: ['需求调研报告', '现场照片'],
  },
  {
    id: 8,
    ...
    progress: 0,
    description: '针对已评审通过的电池Pack自动化测试线方案进行详细成本核算，包括硬件采购、加工件、软件授权及人工调试成本。',
    opportunity: '电池Pack测试线项目',
    amount: 220,
    estimatedHours: 12,
    actualHours: 0,
    assignee: '李工',
    deliverables: ['成本明细表', '利润分析'],
  },
  {
    id: 4,
    ...
    progress: 60,
    description: '广州汽车零部件检测设备采购项目投标，需编写技术标书。',
    opportunity: '广州汽车零部件检测设备',
    amount: 120,
    estimatedHours: 32,
    actualHours: 19,
    assignee: '李工',
    deliverables: ['技术标书', '偏离表', '资质文件'],
  },
  {
    id: 5,
    title: 'BMS老化设备方案内部评审',
    ...
    createdAt: '2026-01-02',
    progress: 85,
    description: 'BMS老化测试设备方案V1.2版本内部评审。',
    opportunity: 'BMS老化测试设备',
    amount: 85,
    estimatedHours: 8,
    actualHours: 6,
    assignee: '李工',
    deliverables: ['评审意见', '修改清单'],
  },
  {
    id: 6,
    title: '佛山智能 - 视觉检测系统方案',
    ...
    progress: 100,
    description: '视觉检测系统技术方案，已完成并提交客户。',
    opportunity: '视觉检测系统项目',
    amount: 95,
    estimatedHours: 24,
    actualHours: 22,
    assignee: '李工',
    deliverables: ['技术方案', '设备清单', '报价'],
  },
  {
    id: 7,
    title: '中山电子 - 充电桩测试设备调研',
    type: 'survey',
    typeName: '需求调研',
    typeColor: 'bg-emerald-500',
    status: 'completed',

...
vi.mock('../../../../services/api', () => {
    return {
        presaleApi: { list: vi.fn(), get: vi.fn(), create: vi.fn(), update: vi.fn(), delete: vi.fn(), query: vi.fn(), aiMatch: vi.fn(), assign: vi.fn(), completeTask: vi.fn(), getMyTasks: vi.fn(), updateTaskStatus: vi.fn() }
    };
});

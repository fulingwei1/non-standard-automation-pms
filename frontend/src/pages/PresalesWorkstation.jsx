...
export default function PresalesWorkstation() {
  ...
  const [_recentTenders, setRecentTenders] = useState([]);
  const [_relatedOpportunities, setRelatedOpportunities] = useState([]);
  ...
  const loadData = useCallback(async () => {
    try {
      ...
      const _inProgressTickets = tickets.filter(

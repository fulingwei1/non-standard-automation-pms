...
describe('useProcurementWorkstation Hook', () => {
  ...
  beforeEach(() => {
    ...
    const apiObjects = [purchaseApi, supplierApi];
  ...
  it('should load data', async () => {
    const { result } = renderHook(() => useProcurementWorkstation());

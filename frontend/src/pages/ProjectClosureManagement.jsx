...
export default function ProjectClosureManagement() {
  ...
  const [reviewDialog, setReviewDialog] = useState({ open: false, closureId: null })
  const [lessonsDialog, setLessonsDialog] = useState({ open: false, closureId: null })
  const [detailDialog, setDetailDialog] = useState({ open: false, closure: null })
  ...
  return (
    ...
    >
      <PageHeader
        title="项目结项管理"
        description={project ? `${project.project_name} - 项目结项` : '项目结项'}
        action={
      ...
      {loading ? (
        ...
        <div className="space-y-6">
            ...
            <Card>
              <CardContent className="p-5">
                <div className="flex items-center justify-between mb-3">
                  ...
                  {closure.cost_variance !== null && closure.cost_variance !== undefined && (
                    <div
                      className={cn(
          ...
          <Card>
            <CardContent className="p-5">
              <h3 className="text-lg font-semibold text-white mb-4">验收信息</h3>
          ...
          {closure.project_summary && (
            <Card>
              <CardContent className="p-5">
                <h3 className="text-lg font-semibold text-white mb-4">项目总结</h3>
          ...
          {closure.achievement && (
            <Card>
              <CardContent className="p-5">
                <h3 className="text-lg font-semibold text-white mb-4">项目成果</h3>
                <p className="text-white whitespace-pre-wrap">
                  {closure.achievement}
                </p>
              </CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card>
              <CardContent className="p-5">
                <h3 className="text-lg font-semibold text-white mb-4">客户满意度</h3>
          ...
          {closure.status === 'REVIEWED' && (
            <Card>
              <CardContent className="p-5">
                <h3 className="text-lg font-semibold text-white mb-4">评审信息</h3>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, acceptance_date: e.target.value })
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, acceptance_result: e.target.value })
                    }
              ...
              <div className="mt-4">
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, acceptance_notes: e.target.value })
                  }
                  placeholder="请输入验收说明"

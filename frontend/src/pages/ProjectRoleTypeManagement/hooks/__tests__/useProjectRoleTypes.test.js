...
import { useProjectRoleTypes } from '../useProjectRoleTypes';
import { roleTypeApi } from '../../../../services/api';

// Mock API
vi.mock('../../../../services/api', () => {
    return {
        roleTypeApi: { list: vi.fn(), get: vi.fn(), create: vi.fn(), update: vi.fn(), delete: vi.fn(), query: vi.fn(), aiMatch: vi.fn(), assign: vi.fn() }
    };
});

describe('useProjectRoleTypes Hook', () => {
  ...
  it('should load data', async () => {
    const { result } = renderHook(() => useProjectRoleTypes());

...
describe('useProjectSettlement Hook', () => {
  ...
  beforeEach(() => {
    ...
    const apiObjects = [projectSettlementApi];
  ...
  it('should load data', async () => {
    const { result } = renderHook(() => useProjectSettlement());

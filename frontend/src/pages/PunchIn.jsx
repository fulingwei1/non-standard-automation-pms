...
const PunchIn = () => {
    ...
    const activities = [
        { id: 1, type: '签退', time: '18:02:15', date: '2026-01-03', location: '南京总部 A 座' },
        { id: 2, type: '签到', time: '08:55:30', date: '2026-01-03', location: '南京总部 A 座' },
        { id: 3, type: '签退', time: '17:45:10', date: '2026-01-02', location: '无锡研发中心' },
    ]
                    ...
                    <div className="relative h-full bg-surface-100 border border-white/10 rounded-3xl p-8 backdrop-blur-xl flex flex-col items-center justify-center min-h-[400px]">
                            ...
                            <AnimatePresence mode="wait">
                                {status === 'punching' ? (
                                    ...
                                    >
                                        ...
                                        <span className="text-xl font-bold">{isPunchedIn ? '下班打卡' : '上班打卡'}</span>
                        ...
                        <div className="mt-8 grid grid-cols-2 gap-12 border-t border-white/5 pt-8 w-full">
                            <div className="text-center">
                                <p className="text-slate-500 text-xs uppercase tracking-wider mb-1">今日时长</p>
                                <p className="text-xl font-mono font-semibold text-white">
                                    {isPunchedIn ? formatDuration(workingTime) : '00:00:00'}
                                </p>
                            </div>
                            <div className="text-center border-l border-white/5">
                                <p className="text-slate-500 text-xs uppercase tracking-wider mb-1">当前状态</p>
                                <div className="flex items-center justify-center gap-2">
                                    <div className={cn("w-2 h-2 rounded-full", isPunchedIn ? "bg-success animate-pulse" : "bg-slate-600")} />
                ...
                <div className="space-y-6">
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-end">
                                ...
                                <span className="text-xs text-success bg-success/10 px-2 py-0.5 rounded-full font-medium">+12%</span>
                            </div>
                    ...
                    >
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="text-sm font-semibold text-white mb-1">地理围栏已启用</h3>
                    ...
                    >
                        <div className="flex gap-4">
                            ...
                            <div>
                                <h3 className="text-sm font-semibold text-warning mb-1">异常提醒</h3>
                        ...
                        <tbody className="divide-y divide-white/5">
                            {activities.map((activity) => (
                                <tr key={activity.id} className="group hover:bg-white/[0.02] transition-colors">
                                    <td className="px-8 py-4 text-sm text-slate-300">{activity.date}</td>
                                    <td className="px-8 py-4 text-sm font-mono text-slate-200">{activity.time}</td>
                                    <td className="px-8 py-4">
                                        <span className={cn(
                                            "px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider",
                                            activity.type === '签到' ? "bg-primary/10 text-primary-light" : "bg-slate-700/50 text-slate-400"
                                        )}>
                                            {activity.type}
                                        </span>
                                    </td>
                                    ...
                                    <td className="px-8 py-4 text-right">
                                        <div className="inline-flex items-center gap-1.5 bg-success/10 px-2 py-1 rounded-lg">
                                            ...
                                            <span className="text-[10px] font-bold text-success uppercase">Normal</span>
                                        </div>
                                    </td>
                                </tr>
                            ))}

...
vi.mock('../../../../services/api', () => {
    return {
        materialApi: { list: vi.fn(), get: vi.fn(), create: vi.fn(), update: vi.fn(), delete: vi.fn(), query: vi.fn(), aiMatch: vi.fn(), assign: vi.fn(), listWithCost: vi.fn(), updatePrice: vi.fn() },
        purchaseApi: { list: vi.fn(), get: vi.fn(), create: vi.fn(), update: vi.fn(), delete: vi.fn(), query: vi.fn(), aiMatch: vi.fn(), assign: vi.fn(), listSuppliers: vi.fn() }
    };
});

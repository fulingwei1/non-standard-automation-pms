  ...
  const handleViewOrder = async (order) => {
    ...
    if (order._original) {
      try {
        ...
        // Load items
        const itemsResponse = await purchaseApi.orders.getItems(
          order._original.id,
        );
  ...
  useEffect(() => {
    ...
    if (action === "create") {
      ...
      const order = (orders || []).find(
        (o) => o.id === parseInt(orderId) || o.id === orderId,
      );
      if (order) {
              ...
              <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(val) =>
                        setNewOrder({
                          ...newOrder,
                          supplier_id: val ? parseInt(val) : null,
                        })
                      }
                    >
                      <SelectTrigger>
                ...
                <div>
                  ...
                  <div className="space-y-2 max-h-64 overflow-y-auto">
                    {newOrder.items.map((item, index) => (
                      <div
                        key={index}
                        className="grid grid-cols-12 gap-2 p-2 border border-border rounded"
                      >
                        ...
                        <div className="col-span-3">
                          <Input
                            ...
                            className={
                              item.material_id ? "bg-slate-800/50" : ""
                            }
                          />
                        </div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setNewOrder({ ...newOrder, remark: e.target.value })
                    }
                    placeholder="备注信息（可选）"
                    rows={3}
                  />
                ...
                onSelect={(material) => {
                  if (currentItemIndex !== null) {
                    ...
                    newItems[currentItemIndex] = {
                      ...
                      unit_price:
                        material.last_price || material.standard_price || 0,
                    };
                    setNewOrder({ ...newOrder, items: newItems });
                  }
              ...
              {approvingOrder && (
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-200">
                      ¥{approvingOrder.totalAmount?.toLocaleString() || 0}
                    </p>
                  </div>
                  <div>

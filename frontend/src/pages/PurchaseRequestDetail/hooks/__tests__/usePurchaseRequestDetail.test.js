...
import { usePurchaseRequestDetail } from '../usePurchaseRequestDetail';
...
describe('usePurchaseRequestDetail Hook', () => {
  ...
  beforeEach(() => {
    ...
    const apiObjects = [purchaseRequestApi];
  ...
  it('should load data', async () => {
    const { result } = renderHook(() => usePurchaseRequestDetail(1));

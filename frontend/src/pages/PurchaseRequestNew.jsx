                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(val) => setFormData({ ...formData, project_id: val ? parseInt(val) : null, machine_id: null })}
                    >
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(val) => setFormData({ ...formData, machine_id: val ? parseInt(val) : null })}
                      disabled={!formData.project_id}
                    >
                      <SelectTrigger className="bg-slate-900/50 border-slate-700" disabled={!formData.project_id}>
                ...
                {formData.items.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {formData.items.map((item, index) => (
                      <div key={index} className="p-4 border border-slate-700 rounded-lg bg-slate-900/30">
                        <div className="flex items-start justify-between mb-3">
                          <Badge className="bg-blue-500/20 text-blue-400">物料 {index + 1}</Badge>
                          <Button
                            size="sm"
                            variant="ghost"
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                          <div className="md:col-span-2">
                            ...
                            <div className="flex gap-2">
                              <Input
                                ...
                                onChange={(e) => handleUpdateItem(index, 'material_code', e.target.value)}
                          ...
                          <div>
                            ...
                            <Input
                              ...
                              onChange={(e) => handleUpdateItem(index, 'required_date', e.target.value)}
                              className="bg-slate-800 border-slate-700 text-slate-200"
                            />
                          </div>
                        </div>
            ...
            <Card className="bg-slate-800/50 border-slate-700/50 sticky top-6">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-2xl font-bold text-slate-200">{formData.items.length}</p>
                </div>
                <div>
                  ...
                  {filteredMaterials.length === 0 ? (
                    ...
                    filteredMaterials.map(material => (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="text-slate-200 font-medium">{material.material_code}</p>
                            <p className="text-slate-400 text-sm">{material.material_name}</p>
                          </div>
                          <div className="text-right">
                            <p className="text-slate-300">¥{material.standard_price || material.last_price || 0}</p>

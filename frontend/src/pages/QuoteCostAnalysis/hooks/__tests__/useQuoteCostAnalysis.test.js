...
describe('useQuoteCostAnalysis Hook', () => {
  ...
  it('should load data', async () => {
    const { result } = renderHook(() => useQuoteCostAnalysis('quote-1'));

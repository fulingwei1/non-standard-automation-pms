                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <Badge className="bg-blue-500">
                            {freezeTypeConfig[freeze.freeze_type] || freeze.freeze_type}
                          </Badge>
                          <Badge variant="outline">版本: {freeze.version_number}</Badge>
                          {freeze.requires_ecr && (
                            <Badge className="bg-orange-500">需ECR/ECN</Badge>
                          )}
                        </div>
                        {freeze.description && (
                          <div className="text-sm mb-2">{freeze.description}</div>
                        )}
                        <div className="flex items-center gap-4 text-xs text-gray-400">
                          <span>冻结时间: {new Date(freeze.freeze_time).toLocaleString()}</span>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Select
                ...
                onValueChange={(value) => setFormData({...formData, freeze_type: value})}
              >
                <SelectTrigger>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                onChange={(e) => setFormData({...formData, requires_ecr: e.target.checked})}
              />

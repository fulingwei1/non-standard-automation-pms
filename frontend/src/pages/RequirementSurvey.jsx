...
const mockSurveys = [
  {
    ...
    location: '深圳市宝安区XX工业园',
    engineer: '李工',
    salesPerson: '张销售',
    opportunity: 'BMS老化测试设备',
    opportunityId: 'OP001',
    summary: '客户有BMS老化测试需求，年产量约50万件，要求64通道测试，支持高低温环境测试。',
    productInfo: {
      name: 'BMS电池管理系统',
      model: 'BMS-A100/A200',
      size: '150×100×30mm',
    ...
    testRequirements: ['充放电循环测试', '高温老化测试', '低温老化测试', '绝缘电阻测试'],
    ...
    pendingQuestions: [],
    attachments: [
      { name: '现场照片1.jpg', type: 'image', size: '2.3MB' },
      { name: '现场照片2.jpg', type: 'image', size: '1.8MB' },
      { name: '产品图纸.pdf', type: 'pdf', size: '5.2MB' },
    ],
    comments: 3,
  },
  {
    ...
    completedDate: null,
    location: '惠州市惠城区XX科技园',
    engineer: '李工',
    salesPerson: '张销售',
    opportunity: 'ICT测试设备项目',
    opportunityId: 'OP005',
    summary: '客户有新的储能产品线需要ICT测试设备，需现场调研需求。',
    productInfo: null,
    testRequirements: [],
    ...
    timeline: '待确认',
    competitors: [],
    pendingQuestions: ['产品具体规格', '测试项目清单', '场地条件'],
    attachments: [],
    comments: 1,
  },
  {
    ...
    opportunityId: 'OP003',
    summary: '客户需要EOL下线功能测试设备，产品为消费电子类，要求兼容多规格产品。',
    productInfo: {
      name: '智能穿戴设备',
      model: 'SW-100/200/300',
      size: '多规格',
      material: '塑胶+金属',
    },
    testRequirements: ['功能测试', '外观检测', '称重', '条码扫描'],
    capacityRequirements: {
      annual: 1000000,
      daily: 4000,
      uph: 200,
    ...
    pendingQuestions: [],
    attachments: [
      { name: '产品规格书.pdf', type: 'pdf', size: '3.1MB' },
    ],
    comments: 5,
  },
  {
    ...
    opportunity: '充电桩测试设备',
    opportunityId: 'OP007',
    summary: '初步电话沟通，了解客户充电桩测试设备需求，后续需现场调研。',
    productInfo: {
      name: '直流充电桩',
      model: 'DC-120KW',
      size: '大型设备',
    ...
    testRequirements: ['绝缘测试', '耐压测试', '功率测试', '通信测试'],
    capacityRequirements: {
      annual: 10000,
      daily: 50,
      uph: 3,
    ...
    timeline: '2026年Q2',
    competitors: [],
    pendingQuestions: ['需现场勘察场地', '详细测试项目'],
    attachments: [],
    comments: 2,
  },
]
...
export default function RequirementSurvey() {
  ...
  const stats = {
    ...
    pendingQuestions: mockSurveys.reduce((acc, s) => acc + s.pendingQuestions.length, 0),
  }

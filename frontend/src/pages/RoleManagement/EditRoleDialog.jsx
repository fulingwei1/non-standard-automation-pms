...
export default function EditRoleDialog({
    ...
    allPermissions, selectedPermissionIds, inheritedPermissionIds,
    permissionSearch, onPermissionSearchChange,
    permissionModuleFilter, onPermissionModuleFilterChange,
    onTogglePermission, onToggleAllPermissions,
    getFilteredPermissions, getAllModules,
}) {
    return (
                    ...
                    <Tabs value={activeTab || "unknown"} onValueChange={onTabChange} className="w-full h-full flex flex-col">
                        ...
                        <TabsContent value="basic" className="mt-6 space-y-4">
                            <div>
                                ...
                                <Input value={form.role_code} disabled className="bg-slate-800 border-slate-700" />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        ...
                                        {roles
                                            .filter(r => r.is_active && r.id !== form.id)
                                            .map((role) => (

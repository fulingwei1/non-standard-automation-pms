...
import { TrendingUp, TrendingDown, Target, Users, DollarSign, Filter, Calendar, Search, ChevronRight } from 'lucide-react'
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <Select value={ownerId || 'all'} onValueChange={(v) => setOwnerId(v === 'all' ? null : parseInt(v))}>
                    <SelectTrigger>
                ...
                <div>
                  ...
                  <Select value={customerId || 'all'} onValueChange={(v) => setCustomerId(v === 'all' ? null : parseInt(v))}>
                    <SelectTrigger>
                      <SelectValue placeholder="全部" />
                    </SelectTrigger>
                    <SelectContent>
            ...
            <CardContent>
              <div className="space-y-4">
                {funnelData.map((data, index) => {
                  ...
                  const dropRate = prevData && prevData.count > 0
                    ? (((prevData.count - data.count) / prevData.count) * 100).toFixed(1)
                    : 0

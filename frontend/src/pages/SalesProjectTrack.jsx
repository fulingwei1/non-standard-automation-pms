...
const mockProjects = [
  {
    ...
    pm: '李工',
    milestones: [
      { name: '签约', date: '2026-01-05', status: 'completed', actual: '2026-01-05' },
      { name: '方案评审', date: '2026-01-10', status: 'completed', actual: '2026-01-10' },
      { name: '设计评审', date: '2026-01-20', status: 'in_progress' },
      { name: '物料齐套', date: '2026-02-01', status: 'pending' },
      { name: '出厂验收', date: '2026-02-28', status: 'pending' },
      { name: '现场验收', date: '2026-03-15', status: 'pending' },
    ],
    issues: [],
    lastUpdate: '今天 10:30',
  },
  {
    ...
    pm: '王工',
    milestones: [
      { name: '签约', date: '2025-12-28', status: 'completed', actual: '2025-12-28' },
      { name: '方案评审', date: '2025-12-30', status: 'completed', actual: '2025-12-30' },
      { name: '设计评审', date: '2026-01-05', status: 'completed', actual: '2026-01-06' },
      { name: '物料齐套', date: '2026-01-10', status: 'completed', actual: '2026-01-12' },
      { name: '出厂验收', date: '2026-01-20', status: 'in_progress' },
      { name: '现场验收', date: '2026-02-10', status: 'pending' },
    ],
    issues: [
      { type: 'delay', content: '部分物料到货延迟2天', severity: 'medium' }
    ],
    lastUpdate: '昨天 16:45',
  },
  {
    ...
    pm: '赵工',
    milestones: [
      { name: '签约', date: '2025-10-18', status: 'completed', actual: '2025-10-18' },
      { name: '方案评审', date: '2026-01-15', status: 'in_progress' },
      { name: '设计评审', date: '2026-01-25', status: 'pending' },
      { name: '物料齐套', date: '2026-02-05', status: 'pending' },
      { name: '出厂验收', date: '2026-02-20', status: 'pending' },
      { name: '现场验收', date: '2026-03-01', status: 'pending' },
    ],
    issues: [],
    lastUpdate: '3天前',
  },

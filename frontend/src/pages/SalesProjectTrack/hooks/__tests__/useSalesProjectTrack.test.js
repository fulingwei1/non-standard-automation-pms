...
vi.mock('../../../../services/api', () => {
    return {
        salesProjectApi: { list: vi.fn(), get: vi.fn(), create: vi.fn(), update: vi.fn(), delete: vi.fn(), query: vi.fn(), aiMatch: vi.fn(), assign: vi.fn(), addFollowUp: vi.fn(), updateStage: vi.fn() }
    };
});

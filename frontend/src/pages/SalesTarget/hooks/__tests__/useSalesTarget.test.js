...
describe('useSalesTarget Hook', () => {
  ...
  beforeEach(() => {
    ...
    const apiObjects = [salesTargetApi];
  ...
  it('should load data', async () => {
    const { result } = renderHook(() => useSalesTarget());

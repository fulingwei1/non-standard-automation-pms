...
vi.mock('../../../../services/api', () => {
    return {
        salesTemplateApi: { list: vi.fn(), get: vi.fn(), create: vi.fn(), update: vi.fn(), delete: vi.fn(), query: vi.fn(), aiMatch: vi.fn(), assign: vi.fn(), duplicate: vi.fn(), getCategories: vi.fn() }
    };
});

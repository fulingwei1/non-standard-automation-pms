...
function ScheduleCalendarView({ projects: _projects, onProjectClick }) {
...
function ScheduleGanttView({ projects: _projects, onProjectClick }) {
  ...
  const handleZoomIn = () => {
    if (zoom === "month") setZoom("week");else
    if (zoom === "week") setZoom("day");
  };

  const handleZoomOut = () => {
    if (zoom === "day") setZoom("week");else

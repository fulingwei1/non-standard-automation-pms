            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleChange('report_location', e.target.value)}
                />
              </div>
            </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                />
                {errors.required_qty && (
                  <div className="text-sm text-red-400 mt-1">{errors.required_qty}</div>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.shortage_qty && (
                  <div className="text-sm text-red-400 mt-1">{errors.shortage_qty}</div>
                )}
              </div>
            </div>

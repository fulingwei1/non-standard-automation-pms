...
import { CheckCircle2, XCircle, AlertTriangle, Search, RefreshCw } from 'lucide-react'
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <Badge variant="outline">{getMatchTypeLabel(record.match_type)}</Badge>
                        ...
                        <div className="text-sm text-gray-600 space-y-1">
                          ...
                          {record.differences && Object.keys(record.differences).length > 0 && (
                            <div className="mt-2 p-2 bg-red-50 rounded border border-red-200">
                              <p className="font-medium text-red-800 mb-1">差异详情:</p>

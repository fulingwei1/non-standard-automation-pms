...
describe('useSupplierManagementPage Hook', () => {
  ...
  it('should load data', async () => {
    const { result } = renderHook(() => useSupplierManagementPage());

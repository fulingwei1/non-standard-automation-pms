...
export default function TaskCenter() {
  ...
  // Use different task data based on role
  const [tasks, setTasks] = useState(role === 'assembler' ? mockAssemblyTasks : mockTasks)
  ...
  const handleStepToggle = (taskId, stepNumber) => {
    setTasks((prev) =>
      prev.map((task) => {
        ...
        const progress = (stepsCompleted / newInstructions.length) * 100
        return { ...task, instructions: newInstructions, progress }
      })
    )
  }

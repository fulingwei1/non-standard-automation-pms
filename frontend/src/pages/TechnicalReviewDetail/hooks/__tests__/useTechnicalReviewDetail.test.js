...
vi.mock('../../../../services/api', () => {
    return {
        technicalReviewApi: { list: vi.fn(), get: vi.fn(), create: vi.fn(), update: vi.fn(), delete: vi.fn(), query: vi.fn(), aiMatch: vi.fn(), assign: vi.fn(), getComments: vi.fn(), submitDecision: vi.fn() }
    };
});

...
describe('useTimesheetBatchOperations Hook', () => {
  ...
  it('should load data', async () => {
    const { result } = renderHook(() => useTimesheetBatchOperations());

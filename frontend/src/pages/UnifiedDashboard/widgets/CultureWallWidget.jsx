...
export default function CultureWallWidget() {
  const [cultureData, setCultureData] = useState(emptyCultureData);
  ...
  // 员工风采轮播
  useEffect(() => {
    if (!cultureData.employeeHighlights?.length) return;
  ...
  const isEmpty = !cultureData.coreValues?.length && !cultureData.announcements?.length && !cultureData.honors?.length && !cultureData.employeeHighlights?.length;
      ...
      <CardContent className="p-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="space-y-3">
            ...
            {cultureData.coreValues?.length > 0 ? (
              ...
              <div className="text-xs text-slate-500 text-center py-4">暂无数据</div>
            )}
          </div>
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              {cultureData.announcements?.length > 0 ? (
                ...
                <div className="text-xs text-slate-500 text-center py-2">暂无公告</div>
              )}
            </div>
            ...
            <div>
              ...
              {cultureData.honors?.length > 0 ? (
                ...
                <div className="text-xs text-slate-500 text-center py-2">暂无荣誉</div>
              )}
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            {cultureData.employeeHighlights?.length > 0 ? (
              <>
              ...
              <div className="text-xs text-slate-500 text-center py-4">暂无员工风采</div>
            )}
          </div>
        </div>
      </CardContent>

        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div>
              ...
              <div className="font-mono font-medium">{workOrder.work_order_no}</div>
            </div>
            <div>
            ...
            <div>
              ...
              <Badge className={statusConfigs[workOrder.status]?.color || 'bg-slate-500'}>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-2xl font-bold">{workOrder.progress || 0}%</span>
              </div>
          ...
          <CardContent>
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-slate-500">/ {workOrder.plan_qty || 0}</span>
              </div>
              <Progress 
                value={workOrder.plan_qty ? (workOrder.completed_qty / workOrder.plan_qty * 100) : 0} 
                className="h-3" 
              />
            </div>
          </CardContent>
              ...
              <div className="flex items-center justify-between">
                ...
                {workOrder.completed_qty > 0 && (
                  <span className="text-slate-500">
                    合格率: {((workOrder.qualified_qty / workOrder.completed_qty) * 100).toFixed(1)}%
                  </span>
                )}
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-sm">
                  {workOrder.plan_start_date ? formatDate(workOrder.plan_start_date) : '-'}
                </div>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-sm">
                  {workOrder.plan_end_date ? formatDate(workOrder.plan_end_date) : '-'}
                </div>
              </div>
              <Calendar className="w-5 h-5 text-slate-400" />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-sm font-medium">
                  {workOrder.standard_hours ? `${workOrder.standard_hours}h` : '-'}
                </div>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-sm font-medium">
                  {workOrder.actual_hours ? `${workOrder.actual_hours.toFixed(1)}h` : '-'}
                </div>
              </div>
              <Clock className="w-5 h-5 text-slate-400" />
            </div>
            ...
            <TabsContent value="details" className="mt-4">
              <div className="space-y-4">
                <div>
                  ...
                  <div className="text-slate-600">{workOrder.work_content || '-'}</div>
                </div>

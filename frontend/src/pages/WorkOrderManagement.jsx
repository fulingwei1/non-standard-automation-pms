                ...
                {filteredOrders.map((order) => (
                  <TableRow key={order.id}>
                    ...
                    <TableCell>
                      {order.material_name || '-'}
                      {order.specification && (
                        <div className="text-xs text-slate-500">{order.specification}</div>
                      )}
                    </TableCell>
                    ...
                    <TableCell>
                      <Badge className={priorityConfigs[order.priority]?.color || 'bg-slate-500'}>
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setNewOrder({ ...newOrder, task_name: e.target.value })}
                  placeholder="请输入任务名称"
                />
              </div>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(val) => setNewOrder({ ...newOrder, task_type: val })}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setNewOrder({ ...newOrder, specification: e.target.value })}
                    placeholder="规格"
                  />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-sm font-medium mb-2 block">计划数量</label>
                  <Input
                    type="number"
                    value={newOrder.plan_qty}
                    onChange={(e) => setNewOrder({ ...newOrder, plan_qty: parseFloat(e.target.value) || 0 })}
                    placeholder="0"
                  />
                </div>
                <div>
                  <label className="text-sm font-medium mb-2 block">标准工时（小时）</label>
                  <Input
                    type="number"
                    value={newOrder.standard_hours}
                    onChange={(e) => setNewOrder({ ...newOrder, standard_hours: parseFloat(e.target.value) || 0 })}
                    placeholder="0"
                  />
                </div>
              </div>
              ...
              <div>
                <label className="text-sm font-medium mb-2 block">工作内容</label>
                <textarea
                  ...
                  onChange={(e) => setNewOrder({ ...newOrder, work_content: e.target.value })}
                  placeholder="工作内容描述..."
                />
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Badge className={priorityConfigs[selectedOrder.priority]?.color}>
                  ...
                  <div>
                    ...
                    <div className="font-medium">{selectedOrder.completed_qty || 0}</div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div>{selectedOrder.plan_start_date ? formatDate(selectedOrder.plan_start_date) : '-'}</div>
                  </div>
                  <div>
                    <div className="text-sm text-slate-500 mb-1">计划结束</div>
                    <div>{selectedOrder.plan_end_date ? formatDate(selectedOrder.plan_end_date) : '-'}</div>
                  </div>
                </div>
          ...
          <DialogBody>
            {selectedOrder && (
              <div className="space-y-4">
                ...
                <div>
                  <label className="text-sm font-medium mb-2 block">分配人员</label>
                  <Input
                    type="number"
                    value={assignData.assigned_to || ''}
                    onChange={(e) => setAssignData({ ...assignData, assigned_to: e.target.value ? parseInt(e.target.value) : null })}
                    placeholder="人员ID"
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setAssignData({ ...assignData, workstation_id: e.target.value ? parseInt(e.target.value) : null })}
                    placeholder="工位ID"
                  />
                </div>
              </div>

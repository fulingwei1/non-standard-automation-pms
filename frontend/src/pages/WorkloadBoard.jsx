              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-2xl font-bold">
                    {dashboardData.summary?.total_users || teamWorkload.length}
                  </div>
                </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-2xl font-bold">
                    {dashboardData.summary?.avg_allocation_rate?.toFixed(1) ||
                      0}
                    %
                  </div>
                </div>
                ...
                {(teamWorkload || []).map((user) => {
                  ...
                  return (
                    <TableRow key={user.user_id}>
                      ...
                      <TableCell>
                        {user.assigned_hours?.toFixed(1) || 0}h
                      </TableCell>
                      <TableCell>
                        {user.standard_hours?.toFixed(1) || 0}h
                      </TableCell>
                      <TableCell>
                        <div className="space-y-1">
                          <div className="flex items-center justify-between text-xs">
                            <span className={status.textColor}>
                              {user.allocation_rate?.toFixed(1) || 0}%
                            </span>
                          ...
                          <Progress
                            ...
                            className={cn(
                              ...
                              user.allocation_rate >= 100 &&
                                user.allocation_rate < 120 &&
                                "bg-orange-500",
                              user.allocation_rate >= 80 &&
                                user.allocation_rate < 100 &&
                                "bg-emerald-500",

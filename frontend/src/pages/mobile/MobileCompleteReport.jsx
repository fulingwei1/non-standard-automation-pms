...
export default function MobileCompleteReport() {
  ...
  const handleSubmit = async () => {
    ...
    const defectQty = formData.defect_qty || (formData.completed_qty - formData.qualified_qty)
    ...
    try {
      ...
      setError('完工报工失败: ' + (error.response?.data?.detail || error.message))
    } finally {
      setLoading(false)
    }
  }
      ...
      <div className="p-4 space-y-4">
        ...
        {success && (
          <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4 flex items-center gap-3">
            ...
            <div className="flex-1">
              <div className="text-sm font-medium text-emerald-800">完工报工成功！</div>
            </div>
          </div>
        )}
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    onClick={() => handleQuickQuantity('completed', workOrder.plan_qty)}
                    className="flex-1"
                  >
                    全部完成
                  </Button>
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    onClick={() => handleQuickQuantity('completed', Math.floor((workOrder.plan_qty || 0) / 2))}
                    className="flex-1"
                  >
                    一半
                  </Button>
              ...
              {formData.completed_qty > 0 && (
                <div className="bg-slate-50 rounded-lg p-3">
                  ...
                  <div className="text-lg font-medium text-red-600">
                    {formData.completed_qty - formData.qualified_qty}（自动计算）
                  </div>
                </div>
              )}
              ...
              {/* 说明 */}
              <div>
                <label className="text-sm font-medium mb-2 block">完工说明（可选）</label>
                <textarea

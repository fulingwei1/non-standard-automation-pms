  ...
  const fetchWorkOrder = async (id) => {
    try {
      ...
      if (order.status !== 'ASSIGNED') {
        setError(`工单状态为"${statusConfigs[order.status]?.label || order.status}"，无法开工`)
        return
      }
      ...
      <div className="p-4 space-y-4">
        ...
        {success && (
          <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4 flex items-center gap-3">
            ...
            <div className="flex-1">
              <div className="text-sm font-medium text-emerald-800">开工成功！</div>
            </div>
          </div>
        )}
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <div className="text-base">
                      {workOrder.workshop_name || '-'} / {workOrder.workstation_name || '-'}
                    </div>
                  </div>

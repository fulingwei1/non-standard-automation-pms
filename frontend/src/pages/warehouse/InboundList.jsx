      ...
      <main className="container mx-auto px-4 py-6 space-y-4">
        <div className="flex gap-3 items-center">
          <div className="relative flex-1 max-w-sm">
            ...
            <Input placeholder="搜索单号/来源/供应商..." value={keyword || "unknown"} onChange={(e) => setKeyword(e.target.value)}
          ...
          <Select value={statusFilter || "unknown"} onValueChange={(v) => { setStatusFilter(v); setPage(1); }}>
            ...
            <SelectContent>
              ...
              {Object.entries(STATUS_MAP).map(([k, v]) => <SelectItem key={k} value={k || "unknown"}>{v.label}</SelectItem>)}
            </SelectContent>
          </Select>

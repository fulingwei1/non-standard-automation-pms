...
-- 验证 exception_events 表索引
SELECT
    'exception_events' as table_name,
    name as index_name,
    sql as index_definition
FROM sqlite_master
WHERE type = 'index'
  AND tbl_name = 'exception_events'
  AND name IN (

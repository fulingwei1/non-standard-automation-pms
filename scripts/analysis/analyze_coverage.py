...
categories = {"models": [], "schemas": [], "api": [], "services": [], "core": [], "utils": []}
...
for filepath, info in files.items():
    ...
    if category:
        categories[category].append(
            {"file": filepath, "percent": percent, "statements": summary["num_statements"]}
        )
...
for module in sorted(business_modules):
    if module == "__pycache__" or module == "__init__":
        continue

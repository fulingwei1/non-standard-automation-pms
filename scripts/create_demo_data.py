...
def create_demo_users(db: Session):
    ...
    demo_users_data = [
        # 机械部
        {
            "username": "demo_mech_zhang",
            "real_name": "张工",
            "department": "机械部",
            "employee_code": "EMP001",
        },
        {
            "username": "demo_mech_li",
            "real_name": "李工",
            "department": "机械部",
        ...
        # 电气部
        {
            "username": "demo_elec_wang",
            "real_name": "王工",
            "department": "电气部",
            "employee_code": "EMP003",
        },
        {
            "username": "demo_elec_zhao",
            "real_name": "赵工",
            "department": "电气部",
        ...
        # 软件部
        {
            "username": "demo_soft_sun",
            "real_name": "孙工",
            "department": "软件部",
            "employee_code": "EMP005",
        },
        {
            "username": "demo_soft_zhou",
            "real_name": "周工",
            "department": "软件部",
    ...
    for user_data in demo_users_data:
        ...
        employee = (
            db.query(Employee).filter(Employee.employee_code == user_data["employee_code"]).first()
        )
        if not employee:
            print(
                f"⚠️  警告: 找不到员工 {user_data['employee_code']}，跳过创建用户 {user_data['username']}"
            )
            continue

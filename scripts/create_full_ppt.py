...
def create_full_presentation():
    ...
    # 第7页 - 痛点详解1
    add_content_slide(prs, "痛点① 需求变更频繁,版本管理混乱", [
    ...
    # 第8页 - 痛点详解2
    add_content_slide(prs, "痛点② 多团队协同效率低下", [
        {"text": "现状描述", "size": 20, "bold": True, "color": TECH_BLUE},
    ...
    # 第10页 - 痛点详解4
    add_content_slide(prs, "痛点④ FAT/SAT 问题追溯困难", [
        {"text": "现状描述", "size": 20, "bold": True, "color": TECH_BLUE},
        "• 验收测试发现问题,无法快速定位责任环节",
        "• 历史问题记录分散,无法形成知识沉淀",
        "• 相同问题在不同项目重复出现",
    ...
    add_table_slide(prs, "告别 Excel + 微信的时代",
        ["维度", "传统方式", "本系统"],
        [
            ["项目规划", "Excel手工排期", "AI智能拆解,模板复用"],
            ["进度跟踪", "周会汇报,信息滞后", "实时看板,自动预警"],
            ["团队协同", "微信群+邮件,分散", "统一平台,@通知到人"],
            ["变更管理", "口头通知,易遗漏", "流程审批,自动通知"],
    ...
    # 第25页 - 客户360
    add_two_column_slide(prs, "客户360°视图",
        [
            "客户基本信息",
            "• 企业信息、联系人",
            "• 组织架构",
    ...
    add_content_slide(prs, "项目管理模块", [
        ...
        "",
        {"text": "业务价值", "size": 22, "bold": True, "color": GREEN},
        "项目交付周期缩短 25% | 延期项目减少 40% | 项目可见度 100%",
    ], page_num=29)
    ...
    add_content_slide(prs, "出厂验收（FAT）管理", [
        ...
        "",
        {"text": "FAT报告自动生成", "size": 20, "color": GREEN},
        "汇总验收数据 | 问题清单 | 客户签字页 | 一键导出PDF",
    ], page_num=41)
    ...
    add_content_slide(prs, "采购管理模块", [
        ...
        "",
        {"text": "业务价值", "size": 22, "bold": True, "color": GREEN},
        "采购周期缩短 30% | 采购成本降低 5-10% | 供应商绩效可视化",
    ], page_num=48)
    ...
    add_content_slide(prs, "成本节约分析", [
        ...
        "",
        {"text": "1. 返���成本减少", "size": 20, "bold": True},
        "   信息同步减少版本错误 | 变更管理减少遗漏",
        "",

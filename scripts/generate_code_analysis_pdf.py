...
def create_pdf(output_path):
    ...
    story.append(Paragraph("非标自动化项目管理系统", ParagraphStyle(
        'Subtitle', parent=body_style, fontSize=14, alignment=1, textColor=colors.gray
    )))
    story.append(Paragraph(f"生成时间: {datetime.now().strftime('%Y-%m-%d %H:%M')}", ParagraphStyle(
        'Date', parent=body_style, fontSize=10, alignment=1, textColor=colors.gray
    )))
    ...
    critical_table.setStyle(TableStyle([
        ...
        ('GRID', (0, 0), (-1, -1), 0.5, colors.grey),
        ('ROWBACKGROUNDS', (0, 1), (-1, -1), [colors.HexColor('#ffeaea'), colors.white]),
    ]))
    ...
    warning_table.setStyle(TableStyle([
        ...
        ('TOPPADDING', (0, 0), (-1, 0), 8),
        ('GRID', (0, 0), (-1, -1), 0.5, colors.grey),
        ('ROWBACKGROUNDS', (0, 1), (-1, -1), [colors.HexColor('#fff5e6'), colors.white]),
    ]))
    ...
    refactor_table.setStyle(TableStyle([
        ...
        ('TOPPADDING', (0, 0), (-1, 0), 8),
        ('GRID', (0, 0), (-1, -1), 0.5, colors.grey),
        ('ROWBACKGROUNDS', (0, 1), (-1, -1), [colors.HexColor('#e8f8f0'), colors.white]),
    ]))

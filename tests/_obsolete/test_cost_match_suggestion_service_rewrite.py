...
class TestCalculateSummary(unittest.TestCase):
    ...
    def test_calculate_with_zero_current_cost(self):
        """测试当前总成本为0"""
        items = [self._create_mock_item(item_id=1, qty=10)]
        suggestions = [self._create_mock_suggestion(item_id=1, current_cost=0, suggested_cost=120)]

        summary = calculate_summary(
            current_total_cost=0.0, current_total_price=2000.0, items=items, suggestions=suggestions
        )
    ...
    def test_calculate_with_zero_price(self):
        ...
        summary = calculate_summary(
            current_total_cost=1000.0, current_total_price=0.0, items=items, suggestions=suggestions
        )
    ...
    def test_calculate_with_missing_qty(self):
        ...
        summary = calculate_summary(
            current_total_cost=0.0, current_total_price=1000.0, items=items, suggestions=suggestions
        )

...
class TestShortageDashboardAdapter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # 创建适配器实例
        self.adapter = ShortageDashboardAdapter(db=self.mock_db, current_user=self.mock_user)
        ...
        def report_filter_side_effect(*args, **kwargs):
            ...
            if filter_expr is not None:
                ...
                if "REPORTED" in filter_str:
                    ...
                    "urgent_level" in filter_str
                    or "URGENT" in filter_str
                    or "CRITICAL" in filter_str
                ):
                    return mock_urgent

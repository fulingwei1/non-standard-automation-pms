...
class TestAnalyzeTrend(unittest.TestCase):
    ...
    def test_analyze_trend_daily_basic(self):
        ...
        result = self.service.analyze_trend(
            period_type="DAILY", start_date=start_date, end_date=end_date
        )
    ...
    def test_analyze_trend_weekly(self):
        ...
        result = self.service.analyze_trend(
            period_type="WEEKLY", start_date=date(2024, 1, 1), end_date=date(2024, 1, 14)
        )
    ...
    def test_analyze_trend_monthly(self):
        ...
        result = self.service.analyze_trend(
            period_type="MONTHLY", start_date=date(2024, 1, 1), end_date=date(2024, 2, 29)
        )
    ...
    def test_analyze_trend_yearly(self):
        ...
        result = self.service.analyze_trend(
            period_type="YEARLY", start_date=date(2024, 1, 1), end_date=date(2024, 12, 31)
        )

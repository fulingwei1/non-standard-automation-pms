...
class TestPurchaseRequestsAPI:
    ...
    def test_list_purchase_requests(self, client: TestClient, admin_token: str):
        ...
        response = client.get(f"{settings.API_V1_PREFIX}/purchase/requests/", headers=headers)
    ...
    def test_create_purchase_request(self, client: TestClient, admin_token: str):
        ...
        response = client.post(
            f"{settings.API_V1_PREFIX}/purchase/requests/", headers=headers, json=request_data
        )
    ...
    def test_get_request_detail(self, client: TestClient, admin_token: str):
        ...
        response = client.get(f"{settings.API_V1_PREFIX}/purchase/requests/1", headers=headers)
    ...
    def test_update_purchase_request(self, client: TestClient, admin_token: str):
        ...
        update_data = {"urgency_level": "urgent", "remarks": "加急处理"}

        response = client.put(
            f"{settings.API_V1_PREFIX}/purchase/requests/1", headers=headers, json=update_data
        )
    ...
    def test_delete_purchase_request(self, client: TestClient, admin_token: str):
        ...
        response = client.delete(f"{settings.API_V1_PREFIX}/purchase/requests/999", headers=headers)
    ...
    def test_request_items_management(self, client: TestClient, admin_token: str):
        ...
        response = client.post(
            f"{settings.API_V1_PREFIX}/purchase/requests/1/items", headers=headers, json=item_data
        )
    ...
    def test_submit_request_for_approval(self, client: TestClient, admin_token: str):
        ...
        response = client.post(
            f"{settings.API_V1_PREFIX}/purchase/requests/1/submit", headers=headers
        )
    ...
    def test_approve_purchase_request(self, client: TestClient, admin_token: str):
        ...
        approval_data = {"action": "approve", "comments": "同意采购"}
    ...
    def test_reject_purchase_request(self, client: TestClient, admin_token: str):
        ...
        rejection_data = {"action": "reject", "comments": "暂缓采购"}
    ...
    def test_filter_requests_by_status(self, client: TestClient, admin_token: str):
        ...
        response = client.get(
            f"{settings.API_V1_PREFIX}/purchase/requests/?status=approved", headers=headers
        )
    ...
    def test_filter_requests_by_project(self, client: TestClient, admin_token: str):
        ...
        response = client.get(
            f"{settings.API_V1_PREFIX}/purchase/requests/?project_id=1", headers=headers
        )
    ...
    def test_filter_requests_by_urgency(self, client: TestClient, admin_token: str):
        ...
        response = client.get(
            f"{settings.API_V1_PREFIX}/purchase/requests/?urgency=urgent", headers=headers
        )
    ...
    def test_request_statistics(self, client: TestClient, admin_token: str):
        ...
        response = client.get(
            f"{settings.API_V1_PREFIX}/purchase/requests/statistics", headers=headers
        )
    ...
    def test_request_export(self, client: TestClient, admin_token: str):
        ...
        response = client.get(f"{settings.API_V1_PREFIX}/purchase/requests/export", headers=headers)
    ...
    def test_request_unauthorized(self, client: TestClient):
        """测试未授权访问采购申请"""
        response = client.get(f"{settings.API_V1_PREFIX}/purchase/requests/")

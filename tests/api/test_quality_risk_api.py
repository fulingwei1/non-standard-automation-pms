...
class TestQualityRiskDetectionAPI:
    ...
    def test_analyze_work_logs_success(self, client, admin_auth_headers, db: Session):
        """测试成功分析工作日志"""
        # 先创建测试数据（工作日志）
        # TODO: 创建测试项目和工作日志
    ...
    def test_analyze_work_logs_missing_project(self, client, admin_auth_headers):
        """测试缺少项目ID"""
        payload = {
            "start_date": str(date.today() - timedelta(days=7)),
            "end_date": str(date.today()),
    ...
    def test_list_detections_with_filters(self, client, admin_auth_headers):
        """测试带过滤条件查询"""
    ...
    def test_get_detection_not_found(self, client, admin_auth_headers):
        """测试获取不存在的检测记录"""
...
class TestQualityTestRecommendationAPI:
    ...
    def test_generate_recommendation(self, client, admin_auth_headers):
        """测试生成测试推荐"""
        response = client.post(
    ...
    def test_generate_recommendation_missing_detection(self, client, admin_auth_headers):
        """测试基于不存在的检测生成推荐"""
        response = client.post(
            "/api/v1/quality-risk/recommendations/generate",
    ...
    def test_list_recommendations_with_filters(self, client, admin_auth_headers):
        """测试带过滤条件查询推荐"""
    ...
    def test_update_recommendation(self, client, admin_auth_headers):
        """测试更新推荐"""
...
class TestQualityReportAPI:
    ...
    def test_generate_quality_report(self, client, admin_auth_headers):
        """测试生成质量报告"""
        payload = {
            "project_id": 1,
    ...
    def test_generate_report_missing_dates(self, client, admin_auth_headers):
        """测试缺少日期参数"""
    ...
    def test_get_statistics_with_filters(self, client, admin_auth_headers):
        """测试带过滤条件的统计"""

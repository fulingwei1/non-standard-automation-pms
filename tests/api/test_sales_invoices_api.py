...
class TestSalesInvoicesAPI:
    ...
    def test_list_invoices(self, client: TestClient, admin_token: str):
        ...
        response = client.get(f"{settings.API_V1_PREFIX}/sales/invoices/", headers=headers)
    ...
    def test_create_invoice(self, client: TestClient, admin_token: str):
        ...
        response = client.post(
            f"{settings.API_V1_PREFIX}/sales/invoices/", headers=headers, json=invoice_data
        )
    ...
    def test_get_invoice_detail(self, client: TestClient, admin_token: str):
        ...
        response = client.get(f"{settings.API_V1_PREFIX}/sales/invoices/1", headers=headers)
    ...
    def test_delete_invoice(self, client: TestClient, admin_token: str):
        ...
        response = client.delete(f"{settings.API_V1_PREFIX}/sales/invoices/999", headers=headers)
    ...
    def test_invoice_approval(self, client: TestClient, admin_token: str):
        ...
        approval_data = {"action": "approve", "comments": "审核通过"}
    ...
    def test_invoice_issue(self, client: TestClient, admin_token: str):
        ...
        issue_data = {"issue_date": datetime.now().strftime("%Y-%m-%d"), "issued_by": 1}

        response = client.post(
            f"{settings.API_V1_PREFIX}/sales/invoices/1/issue", headers=headers, json=issue_data
        )
    ...
    def test_invoice_cancel(self, client: TestClient, admin_token: str):
        ...
        cancel_data = {"reason": "客户要求作废"}

        response = client.post(
            f"{settings.API_V1_PREFIX}/sales/invoices/1/cancel", headers=headers, json=cancel_data
        )
    ...
    def test_filter_invoices_by_status(self, client: TestClient, admin_token: str):
        ...
        response = client.get(
            f"{settings.API_V1_PREFIX}/sales/invoices/?status=issued", headers=headers
        )
    ...
    def test_filter_invoices_by_customer(self, client: TestClient, admin_token: str):
        ...
        response = client.get(
            f"{settings.API_V1_PREFIX}/sales/invoices/?customer_id=1", headers=headers
        )
    ...
    def test_invoice_statistics(self, client: TestClient, admin_token: str):
        ...
        response = client.get(
            f"{settings.API_V1_PREFIX}/sales/invoices/statistics", headers=headers
        )
    ...
    def test_invoice_export(self, client: TestClient, admin_token: str):
        ...
        response = client.get(f"{settings.API_V1_PREFIX}/sales/invoices/export", headers=headers)
    ...
    def test_invoice_tax_calculation(self, client: TestClient, admin_token: str):
        ...
        calc_data = {"amount": 100000.0, "tax_rate": 13.0}
    ...
    def test_invoice_validation(self, client: TestClient, admin_token: str):
        ...
        invalid_data = {"amount": -1000.0}  # 负数金额

        response = client.post(
            f"{settings.API_V1_PREFIX}/sales/invoices/", headers=headers, json=invalid_data
        )
    ...
    def test_invoice_unauthorized(self, client: TestClient):
        """测试未授权访问发票"""
        response = client.get(f"{settings.API_V1_PREFIX}/sales/invoices/")

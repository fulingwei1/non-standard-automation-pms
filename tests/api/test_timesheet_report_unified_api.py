...
class TestTimesheetReportUnifiedAPI:
    ...
    def test_list_available_timesheet_reports(self, auth_headers):
        """测试获取可用工时报表列表"""
    ...
    def test_get_hr_report_schema(self, auth_headers):
        """测试获取HR报表Schema"""
        response = client.get(
    ...
    def test_get_hr_report_unified_json(self, auth_headers):
        """测试获取HR报表（JSON格式）"""
        today = date.today()
        response = client.get(
    ...
    def test_get_finance_report_unified_json(self, auth_headers):
        """测试获取财务报表（JSON格式）"""
        today = date.today()
        response = client.get(
    ...
    def test_get_project_report_unified_json(self, auth_headers, sample_project):
        """测试获取项目报表（JSON格式）"""
    ...
    def test_get_rd_report_unified_json(self, auth_headers):
        """测试获取研发报表（JSON格式）"""
        today = date.today()
        response = client.get(
    ...
    def test_generate_hr_report_with_unified_endpoint(self, auth_headers):
        """测试使用统一报表框架端点生成HR报表"""
        today = date.today()

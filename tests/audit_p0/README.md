...
| test_p0_06_receipt_no_stock | 6 收货/领料/调拨/在途库存断链 | 源码接线 + API 契约：修复前 receipts 不调 InboundService、领料不调 OutboundService、调拨不调 TransferService；修复后合格收货入库，采购收货契约覆盖 PO/POI 状态、金额与在途读侧流转，生产领料契约覆盖发料扣库与 ISSUE 流水，调拨契约覆盖源库扣减、目标库增加与 TRANSFER_IN 流水 |

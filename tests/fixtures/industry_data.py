...
SAMPLE_TIMESHEETS = [
    ...
    },
    {
        ...
        "hours": 8.0,
        "type": "SOFTWARE",
        "description": "ICT测试程序开发，完成基础通信框架",
        "status": "APPROVED",
    },
    {
        "id": 3,
...
def make_mock_db_with_projects(projects: list = None) -> MagicMock:
    ...
    db.query.return_value.filter.return_value.first.return_value = (
        project_list[0] if project_list else None
    )

...
def assert_success_response(
    response_data: Dict[str, Any], expected_code: int = 200
) -> Dict[str, Any]:
    """
    断言成功响应格式
    ...
    if "success" in response_data:
        ...
        ), f"响应应该成功，但 success={response_data.get('success')}"
        assert (
            response_data["code"] == expected_code
        ), f"期望状态码 {expected_code}，实际 {response_data.get('code')}"

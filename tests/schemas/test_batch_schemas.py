...
class TestManagementRhythm:
    def test_rhythm_config_create(self):
        ...
        r = RhythmConfigCreate(
            rhythm_level="STRATEGIC", cycle_type="QUARTERLY", config_name="季度战略会"
        )
    ...
    def test_rhythm_dashboard_response(self):
        ...
        d = RhythmDashboardResponse(
            ...
            cycle_type="QUARTERLY",
            current_cycle=None,
            key_metrics_snapshot=None,
            health_status="GREEN",
            last_meeting_date=None,
            next_meeting_date=None,
            meetings_count=5,
            completed_meetings_count=3,
    ...
    def test_meeting_statistics_response(self):
        ...
        s = MeetingStatisticsResponse(
            ...
            by_level={"STRATEGIC": 5},
            by_cycle={"QUARTERLY": 3},
        )
...
class TestStaffMatching:
    ...
    def test_staffing_need_create(self):
        from app.schemas.staff_matching import SkillRequirement, StaffingNeedCreate
    ...
    def test_staffing_dashboard(self):
        from app.schemas.staff_matching import MatchingStatistics, StaffingDashboard

        d = StaffingDashboard(
            open_needs=10,
            matching_needs=5,
            filled_needs=3,
            total_headcount_needed=20,
            total_headcount_filled=8,
            needs_by_priority={"HIGH": 5},
            matching_stats=MatchingStatistics(
                total_requests=20,
                total_candidates_matched=50,
                accepted_count=15,
                rejected_count=5,
                pending_count=0,
            ),
...
class TestRdProject:
    def test_category_create(self):
        ...
        c = RdProjectCategoryCreate(
            category_code="RD001", category_name="新产品研发", category_type="PRODUCT"
        )
...
class TestSession:
    def test_session_response(self):
        ...
        s = SessionResponse(
            id=1,
            user_id=1,
            access_token_jti="abc",
            refresh_token_jti="def",
            is_active=True,
            login_at=now,
...
class TestWorkload:
    ...
    def test_project_workload_item(self):
        ...
        p = ProjectWorkloadItem(
            project_id=1,
            assigned_hours=Decimal("80"),
            actual_hours=Decimal("60"),
            task_count=3,
        )

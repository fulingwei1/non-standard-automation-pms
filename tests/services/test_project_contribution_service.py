...
class TestGetUserProjectContributions:
    ...
    def test_get_user_contributions_with_period_range(self):
        ...
        svc = ProjectContributionService(db)
        result = svc.get_user_project_contributions(1, start_period="2024-01", end_period="2024-12")
...
class TestRateMemberContribution:
    ...
    def test_rate_existing_contribution(self):
        ...
        contribution = _make_contribution(contribution_score=Decimal("10"), pm_rating=None)
...
class TestGenerateContributionReport:
    ...
    def test_report_top_contributors_limited_to_10(self):
        ...
        for i in range(15):
            ...
            contrib = _make_contribution(user_id=i + 1, contribution_score=Decimal(str(15 - i)))
            contrib.user = user
        ...
        assert len(report["top_contributors"]) == 10
        assert (
            report["top_contributors"][0]["contribution_score"]
    ...
    def test_report_calculates_totals_correctly(self):
        ...
        contributions = [
            _make_contribution(
                user_id=1, task_count=5, actual_hours=40.0, bonus_amount=Decimal("2000")
            ),
            _make_contribution(
                user_id=1, task_count=7, actual_hours=50.0, bonus_amount=Decimal("3000")
            ),
        ]

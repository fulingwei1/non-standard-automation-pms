...
class TestForecastProjectHours:
    ...
    def test_linear_regression_method_called(self):
        ...
        result = svc.forecast_project_hours(
            project_id=1, project_type="ICT", forecast_method="LINEAR_REGRESSION"
        )
        assert result is mock_result
    ...
    def test_trend_forecast_method_called(self):
        ...
        result = svc.forecast_project_hours(
            project_id=1, project_type="ICT", forecast_method="TREND_FORECAST"
        )
        assert result is mock_result
...
class TestInitTimesheetForecastService:
    ...
    def test_forecast_method_routing_invalid(self):
        ...
        try:
            result = svc.forecast_project_hours(project_id=1, forecast_method="UNKNOWN_METHOD")
            # 如果返回 None 也可接受
        except Exception:
            pass  # 异常也可接受

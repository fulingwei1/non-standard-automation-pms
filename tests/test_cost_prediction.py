...
class TestCostPredictionModel:
    ...
    def test_create_prediction(
        self, db: Session, test_project: Project, test_evm_data: EarnedValueData
    ):
        """测试创建预测记录"""
...
class TestCostPredictionService:
    ...
    def test_traditional_eac_prediction(
        self, db: Session, test_project: Project, test_evm_data: EarnedValueData
    ):
        """测试传统EAC预测方法"""
    ...
    def test_traditional_risk_analysis(
        self,
        db: Session,
        test_project: Project,
        test_evm_data: EarnedValueData,
        test_evm_history: list,
    ):
        """测试传统风险分析"""
        service = CostPredictionService(db)
    ...
    def test_create_prediction_with_ai(
        ...
        prediction = service.create_prediction(
            project_id=test_project.id, prediction_version="V1.0", use_ai=True, created_by=1
        )
    ...
    def test_create_prediction_without_ai(
        self,
        db: Session,
        test_project: Project,
        test_evm_data: EarnedValueData,
        ...
        prediction = service.create_prediction(
            project_id=test_project.id, prediction_version="V1.0", use_ai=False, created_by=1
        )
    ...
    def test_get_latest_prediction(
        ...
        pred1 = service.create_prediction(
            project_id=test_project.id, prediction_version="V1.0", use_ai=False
        )

        pred2 = service.create_prediction(
            project_id=test_project.id, prediction_version="V2.0", use_ai=False
        )
...
class TestCostPredictionAPI:
    ...
    def test_create_prediction_api(
        self,
        client: TestClient,
        test_project: Project,
        test_evm_data: EarnedValueData,
    ...
    def test_get_prediction_detail_api(
        self,
        client: TestClient,
        db: Session,
        test_project: Project,
    ...
    def test_get_latest_prediction_api(
        self,
        client: TestClient,
        db: Session,
        test_project: Project,
    ...
    def test_approve_prediction_api(
        self,
        client: TestClient,
        db: Session,
        test_project: Project,
    ...
    def test_get_project_cost_health_api(
        self,
        client: TestClient,
        db: Session,
        test_project: Project,
    ...
    def test_prediction_without_evm_data(self, db: Session):
        ...
        with pytest.raises(ValueError, match="项目无EVM数据"):
            service.create_prediction(
                project_id=project.id, prediction_version="V1.0", use_ai=False
            )

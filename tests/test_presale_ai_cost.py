...
class TestCostOptimization:
    ...
    @pytest.mark.asyncio
    async def test_generate_optimization_suggestions_hardware(
        self, service, sample_estimation_input
    ):
        """测试11: 生成优化建议 - 硬件优化"""
        cost_breakdown = {
        ...
        suggestions = await service._generate_optimization_suggestions(
            sample_estimation_input, cost_breakdown
        )
    ...
    @pytest.mark.asyncio
    async def test_generate_optimization_suggestions_software(
        self, service, sample_estimation_input
    ):
        """测试12: 生成优化建议 - 软件优化"""
        cost_breakdown = {
    ...
    async def test_generate_optimization_suggestions_installation(self, service):
        ...
        suggestions = await service._generate_optimization_suggestions(input_data, cost_breakdown)
...
class TestHistoricalLearning:
    ...
    async def test_update_actual_cost_basic(self, service):
        ...
        input_data = UpdateActualCostInput(
            estimation_id=1, project_id=2001, project_name="测试项目", actual_cost=Decimal("110000")
        )
    ...
    async def test_update_actual_cost_with_breakdown(self, service):
        ...
        input_data = UpdateActualCostInput(
            estimation_id=1, actual_cost=Decimal("110000"), actual_breakdown=breakdown
        )
    ...
    async def test_update_actual_cost_negative_variance(self, service):
        ...
        input_data = UpdateActualCostInput(estimation_id=1, actual_cost=Decimal("90000"))

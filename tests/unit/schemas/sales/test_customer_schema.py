...
class TestCustomerSchema:
    ...
    def test_customer_create_valid(self):
        """测试有效的客户创建"""
        data = {"customer_name": "测试客户", "customer_code": "CUST001", "customer_type": "企业"}
    ...
    def test_customer_code_format(self):
        """测试客户编码格式"""
        data = {"customer_name": "客户A", "customer_code": "CUST001"}
        schema = CustomerCreate(**data)
    ...
    def test_customer_type_enum(self):
        ...
        for ct in valid_types:
            data = {"customer_name": "类型测试", "customer_code": "CUST_TYPE", "customer_type": ct}
            try:
                schema = CustomerCreate(**data)
    ...
    def test_customer_extra_forbidden(self):
        """测试禁止额外字段"""
        data = {"customer_name": "测试", "customer_code": "CUST006", "invalid_field": "not_allowed"}
        try:
            CustomerCreate(**data)

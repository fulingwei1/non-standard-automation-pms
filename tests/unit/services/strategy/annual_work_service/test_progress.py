...
class TestUpdateProgress:
    ...
    def test_update_progress_success(self):
        ...
        data = AnnualKeyWorkProgressUpdate(
            progress_percent=Decimal("50"), progress_description="已完成50%"
        )

        mock_work = AnnualKeyWork(
            id=1, progress_percent=Decimal("0"), status="NOT_STARTED", is_active=True
        )
    ...
    def test_update_progress_to_completed(self):
        """测试更新进度至完成"""
        db = Mock(spec=Session)
        data = AnnualKeyWorkProgressUpdate(progress_percent=Decimal("100"))

        mock_work = AnnualKeyWork(
            id=1, progress_percent=Decimal("80"), status="IN_PROGRESS", is_active=True
        )
    ...
    def test_update_progress_to_in_progress(self):
        """测试更新进度至进行中"""
        db = Mock(spec=Session)
        data = AnnualKeyWorkProgressUpdate(progress_percent=Decimal("30"))
    ...
    def test_update_progress_without_description(self):
        ...
        mock_work = AnnualKeyWork(
            id=1, progress_percent=Decimal("0"), progress_description="旧描述", is_active=True
        )
...
class TestCalculateProgressFromProjects:
    ...
    def test_calculate_with_single_project(self):
        ...
        link = AnnualKeyWorkProjectLink(
            annual_work_id=1, project_id=100, contribution_weight=Decimal("1"), is_active=True
        )
    ...
    def test_calculate_with_multiple_projects_equal_weight(self):
        ...
        links = [
            ...
            AnnualKeyWorkProjectLink(
                annual_work_id=1, project_id=101, contribution_weight=Decimal("1"), is_active=True
            ),
        ]
    ...
    def test_calculate_with_different_weights(self):
        ...
        links = [
            AnnualKeyWorkProjectLink(
                annual_work_id=1, project_id=100, contribution_weight=Decimal("2"), is_active=True
            ),
            AnnualKeyWorkProjectLink(
                annual_work_id=1, project_id=101, contribution_weight=Decimal("1"), is_active=True
            ),
...
class TestEdgeCases:
    ...
    def test_calculate_very_small_weights(self):
        ...
        link = AnnualKeyWorkProjectLink(
            annual_work_id=1, project_id=100, contribution_weight=Decimal("0.001"), is_active=True
        )

...
class TestAddCC(unittest.TestCase):
    ...
    def test_add_cc_success(self):
        """测试成功加抄送"""
        # 准备mock数据
        instance = ApprovalInstance(id=1, current_node_id=10, status="PENDING")
        operator = User(id=1, username="admin", real_name="管理员", password_hash="test_hash_123")
        cc_records = [
        ...
        # 执行
        result = self.engine.add_cc(instance_id=1, operator_id=1, cc_user_ids=[2, 3])
...
class TestWithdraw(unittest.TestCase):
    ...
    def test_withdraw_success(self):
        ...
        initiator = User(id=10, username="user1", real_name="用户1", password_hash="test_hash_123")
        ...
        self.engine.db.query.side_effect = [
            ...
            MagicMock(
                filter=MagicMock(return_value=MagicMock(first=MagicMock(return_value=initiator)))
            ),
            task_query_mock,  # ApprovalTask查询
        ]

        result = self.engine.withdraw(instance_id=1, initiator_id=10, comment="撤回测试")
    ...
    def test_withdraw_invalid_status(self):
        """测试无效状态撤回"""
        instance = ApprovalInstance(id=1, initiator_id=10, status="APPROVED")  # 已通过不能撤回
    ...
    def test_withdraw_from_draft(self):
        """测试从草稿状态撤回"""
        instance = ApprovalInstance(id=1, initiator_id=10, status="DRAFT", completed_at=None)
        initiator = User(id=10, username="user1", real_name="用户1", password_hash="test_hash_123")
...
class TestTerminate(unittest.TestCase):
    ...
    def test_terminate_success(self):
        ...
        result = self.engine.terminate(instance_id=1, operator_id=1, comment="违规终止")
...
class TestRemind(unittest.TestCase):
    ...
    def test_remind_success(self):
        """测试成功催办"""
        task = ApprovalTask(
            id=1, instance_id=10, status="PENDING", remind_count=0, reminded_at=None
        )
        reminder = User(id=5, username="user5", real_name="催办人", password_hash="test_hash_123")
    ...
    def test_remind_reminder_not_found(self):
        """测试催办人不存在（应仍能成功）"""
        task = ApprovalTask(id=1, instance_id=10, status="PENDING", remind_count=0)
...
class TestAddComment(unittest.TestCase):
    ...
    def test_add_comment_simple(self):
        """测试简单评论"""
        user = User(id=1, username="user1", real_name="用户1", password_hash="test_hash_123")
        ...
        result = self.engine.add_comment(instance_id=10, user_id=1, content="这是一条评论")
    ...
    def test_add_comment_with_reply(self):
        """测试回复评论"""
        user = User(id=2, username="user2", real_name="用户2", password_hash="test_hash_123")
        instance = ApprovalInstance(id=10, status="PENDING")
        ...
        result = self.engine.add_comment(
            instance_id=10, user_id=2, content="回复内容", parent_id=5, reply_to_user_id=1
        )
    ...
    def test_add_comment_with_mentions(self):
        ...
        result = self.engine.add_comment(
            instance_id=10, user_id=1, content="@用户2 @用户3 请查看", mentioned_user_ids=[2, 3]
        )
    ...
    def test_add_comment_with_attachments(self):
        ...
        result = self.engine.add_comment(
            instance_id=10, user_id=1, content="带附件的评论", attachments=attachments
        )
    ...
    def test_add_comment_user_not_found(self):
        ...
        result = self.engine.add_comment(instance_id=10, user_id=999, content="匿名评论")
    ...
    def test_add_comment_no_mentions(self):
        ...
        result = self.engine.add_comment(instance_id=10, user_id=1, content="普通评论")
    ...
    def test_add_comment_instance_not_found_no_notify(self):
        ...
        result = self.engine.add_comment(
            instance_id=999, user_id=1, content="评论", mentioned_user_ids=[2, 3]
        )
...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_add_cc_empty_list(self):
        """测试空抄送列表"""
        instance = ApprovalInstance(id=1, current_node_id=10)
        operator = User(id=1, username="admin", password_hash="test_hash_123")
    ...
    def test_withdraw_without_comment(self):
        """测试无说明撤回"""
        instance = ApprovalInstance(id=1, initiator_id=10, status="PENDING", completed_at=None)
        initiator = User(id=10, username="user1", password_hash="test_hash_123")
    ...
    def test_remind_count_none_to_one(self):
        ...
        reminder = User(id=5, username="user5", password_hash="test_hash_123")

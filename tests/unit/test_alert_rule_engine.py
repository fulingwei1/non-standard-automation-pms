...
class TestLevelDeterminer:
    ...
    def test_determine_alert_level_with_context(self):
        ...
        level = LevelDeterminer.determine_alert_level(rule, {"value": 100}, {"extra": "data"})
...
class TestAlertCreator:
    ...
    def test_should_create_alert_no_existing(self, db_session: Session):
        ...
        result = creator.should_create_alert(rule, target_data, AlertLevelEnum.WARNING.value)
        assert result is None
    ...
    def test_should_create_alert_existing_alert(self, db_session: Session):
        ...
        result = creator.should_create_alert(rule, {"target_id": 123}, AlertLevelEnum.WARNING.value)
        assert result is None
...
class TestAlertRuleEngine:
    ...
    def test_level_priority_comparison(self, db_session: Session):
        ...
        assert base.level_priority(AlertLevelEnum.WARNING.value) < base.level_priority(
            AlertLevelEnum.CRITICAL.value
        )
        assert base.level_priority(AlertLevelEnum.CRITICAL.value) < base.level_priority(

...
class TestAddCC:
    ...
    def test_add_cc_success(self, actions_service, db_mock, sample_instance, sample_operator):
        ...
        # 执行
        result = actions_service.add_cc(instance_id=1, operator_id=200, cc_user_ids=[301, 302])
    ...
    def test_add_cc_instance_not_found(self, actions_service, db_mock):
        ...
        with pytest.raises(ValueError) as exc_info:
            actions_service.add_cc(instance_id=999, operator_id=200, cc_user_ids=[301])
    ...
    def test_add_cc_empty_cc_list(self, actions_service, db_mock, sample_instance, sample_operator):
        ...
        result = actions_service.add_cc(instance_id=1, operator_id=200, cc_user_ids=[])
    ...
    def test_add_cc_operator_not_found(self, actions_service, db_mock, sample_instance):
        ...
        result = actions_service.add_cc(instance_id=1, operator_id=999, cc_user_ids=[301])

        # 应该继续执行
        assert len(result) == 1
        db_mock.commit.assert_called_once()

    def test_add_cc_multiple_users(
        self, actions_service, db_mock, sample_instance, sample_operator
    ):
        """测试批量添加多个抄送人"""
        instance_query = MagicMock()
        instance_query.filter.return_value.first.return_value = sample_instance
        ...
        result = actions_service.add_cc(
            instance_id=1, operator_id=200, cc_user_ids=[301, 302, 303, 304, 305]
        )
    ...
    def test_add_cc_with_operator_real_name(self, actions_service, db_mock, sample_instance):
        ...
        actions_service.add_cc(instance_id=1, operator_id=200, cc_user_ids=[])
...
class TestWithdraw:
    ...
    def test_withdraw_success_pending(self, actions_service, db_mock, sample_instance, sample_user):
        ...
        # 执行
        result = actions_service.withdraw(instance_id=1, initiator_id=100, comment="测试撤回")
    ...
    def test_withdraw_success_draft(self, actions_service, db_mock, sample_instance, sample_user):
        ...
        result = actions_service.withdraw(instance_id=1, initiator_id=100)
    ...
    def test_withdraw_instance_not_found(self, actions_service, db_mock):
        ...
        with pytest.raises(ValueError) as exc_info:
            actions_service.withdraw(instance_id=999, initiator_id=100)
    ...
    def test_withdraw_not_initiator(self, actions_service, db_mock, sample_instance):
        ...
        with pytest.raises(ValueError) as exc_info:
            actions_service.withdraw(instance_id=1, initiator_id=999)  # 不是发起人
    ...
    def test_withdraw_invalid_status(self, actions_service, db_mock, sample_instance):
        ...
        with pytest.raises(ValueError) as exc_info:
            actions_service.withdraw(instance_id=1, initiator_id=100)
    ...
    def test_withdraw_affected_users_notification(
        self, actions_service, db_mock, sample_instance, sample_user
    ):
        """测试撤回时获取受影响用户并通知"""
        sample_instance.status = "PENDING"
        sample_instance.initiator_id = 100
...
class TestTerminate:
    ...
    def test_terminate_success(self, actions_service, db_mock, sample_instance, sample_operator):
        ...
        # 执行
        result = actions_service.terminate(instance_id=1, operator_id=200, comment="紧急终止")
    ...
    def test_terminate_instance_not_found(self, actions_service, db_mock):
        ...
        with pytest.raises(ValueError) as exc_info:
            actions_service.terminate(instance_id=999, operator_id=200, comment="终止")
    ...
    def test_terminate_invalid_status(self, actions_service, db_mock, sample_instance):
        ...
        with pytest.raises(ValueError) as exc_info:
            actions_service.terminate(instance_id=1, operator_id=200, comment="终止")
    ...
    def test_terminate_operator_not_found(self, actions_service, db_mock, sample_instance):
        ...
        result = actions_service.terminate(instance_id=1, operator_id=999, comment="终止")

        # 应该继续执行
        assert result.status == "TERMINATED"
        db_mock.commit.assert_called_once()

    def test_terminate_updates_all_pending_tasks(
        self, actions_service, db_mock, sample_instance, sample_operator
    ):
        """测试终止时更新所有待处理任务"""
        sample_instance.status = "PENDING"
...
class TestRemind:
    ...
    def test_remind_success(self, actions_service, db_mock, sample_task, sample_operator):
        ...
        # 执行
        result = actions_service.remind(task_id=50, reminder_id=200)
        ...
        actions_service.notify.notify_remind.assert_called_once_with(
            sample_task, reminder_id=200, reminder_name="李四"
        )
    ...
    def test_remind_multiple_times(self, actions_service, db_mock, sample_task, sample_operator):
        ...
        actions_service.remind(task_id=50, reminder_id=200)
    ...
    def test_remind_task_not_found(self, actions_service, db_mock):
        ...
        with pytest.raises(ValueError) as exc_info:
            actions_service.remind(task_id=999, reminder_id=200)
...
class TestAddComment:
    ...
    def test_add_comment_simple(self, actions_service, db_mock, sample_user):
        ...
        # 执行
        result = actions_service.add_comment(instance_id=1, user_id=100, content="测试评论")
    ...
    def test_add_comment_with_reply(self, actions_service, db_mock, sample_user):
        ...
        result = actions_service.add_comment(
            instance_id=1, user_id=100, content="回复内容", parent_id=10, reply_to_user_id=200
        )
    ...
    def test_add_comment_with_mentions(
        self, actions_service, db_mock, sample_user, sample_instance
    ):
        """测试@提及用户"""
        user_query = MagicMock()
        user_query.filter.return_value.first.return_value = sample_user
        ...
        result = actions_service.add_comment(
            instance_id=1, user_id=100, content="@所有人 请关注", mentioned_user_ids=mentioned_users
        )
    ...
    def test_add_comment_with_attachments(self, actions_service, db_mock, sample_user):
        ...
        result = actions_service.add_comment(
            instance_id=1, user_id=100, content="请查看附件", attachments=attachments
        )
    ...
    def test_add_comment_user_without_real_name(self, actions_service, db_mock):
        ...
        actions_service.add_comment(instance_id=1, user_id=100, content="评论")
    ...
    def test_add_comment_user_not_found(self, actions_service, db_mock):
        ...
        actions_service.add_comment(instance_id=1, user_id=999, content="评论")

        added_comment = db_mock.add.call_args[0][0]
        assert added_comment.user_name is None
        db_mock.commit.assert_called_once()

    def test_add_comment_instance_not_found_no_notification(
        self, actions_service, db_mock, sample_user
    ):
        """测试实例不存在时不发送通知"""
        user_query = MagicMock()
        user_query.filter.return_value.first.return_value = sample_user
        ...
        actions_service.add_comment(
            instance_id=999, user_id=100, content="评论", mentioned_user_ids=[201]
        )
    ...
    def test_add_comment_no_mentions_no_notification(
        self, actions_service, db_mock, sample_user, sample_instance
    ):
        """测试没有@提及时不发送通知"""
        user_query = MagicMock()
    ...
    def test_add_comment_empty_mentions_no_notification(
        self, actions_service, db_mock, sample_user, sample_instance
    ):
        """测试空的@提及列表不发送通知"""
        user_query = MagicMock()
        ...
        actions_service.add_comment(
            instance_id=1, user_id=100, content="评论", mentioned_user_ids=[]  # 空列表
        )

        # 不应发送通知
        actions_service.notify.notify_comment.assert_not_called()

    def test_add_comment_complete_flow(
        self, actions_service, db_mock, sample_user, sample_instance
    ):
        """测试完整的评论流程（所有参数）"""
        user_query = MagicMock()

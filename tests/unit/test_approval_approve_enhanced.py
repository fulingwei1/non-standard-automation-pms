...
class TestApprovalProcessMixin(unittest.TestCase):
    ...
    def test_reject_to_start(self):
        ...
        result = self.mixin.reject(
            task_id=1, approver_id=5, comment="不符合要求", reject_to="START"
        )
    ...
    def test_reject_to_previous(self):
        ...
        result = self.mixin.reject(task_id=1, approver_id=5, comment="请修改", reject_to="PREV")
    ...
    def test_reject_to_previous_no_prev_node(self):
        ...
        result = self.mixin.reject(task_id=1, approver_id=5, comment="退回", reject_to="PREV")
    ...
    def test_reject_to_specific_node(self):
        ...
        result = self.mixin.reject(task_id=1, approver_id=5, comment="退回", reject_to="20")
    ...
    def test_reject_to_invalid_node_id(self):
        ...
        result = self.mixin.reject(task_id=1, approver_id=5, comment="退回", reject_to="invalid")
    ...
    def test_return_to_success(self):
        ...
        with patch.object(self.db, "query") as mock_query:
            ...
            result = self.mixin.return_to(
                task_id=1, approver_id=5, target_node_id=8, comment="请重新填写"
            )
    ...
    def test_return_to_node_not_found(self):
        ...
        result = self.mixin.return_to(task_id=1, approver_id=5, target_node_id=999, comment="退回")
    ...
    def test_transfer_success(self):
        ...
        with patch("app.services.approval_engine.engine.approve.ApprovalTask") as mock_task_class:
            ...
            result = self.mixin.transfer(
                task_id=1, from_user_id=5, to_user_id=6, comment="请帮忙审批"
            )
    ...
    def test_add_approver_before(self):
        ...
        with patch("app.services.approval_engine.engine.approve.ApprovalTask") as mock_task_class:
            ...
            result = self.mixin.add_approver(
                task_id=1, operator_id=5, approver_ids=[6, 7], position="BEFORE"
            )
    ...
    def test_add_approver_after(self):
        ...
        with patch("app.services.approval_engine.engine.approve.ApprovalTask") as mock_task_class:
            ...
            result = self.mixin.add_approver(
                task_id=1, operator_id=5, approver_ids=[6], position="AFTER"
            )
    ...
    def test_add_approver_user_not_found(self):
        ...
        with patch("app.services.approval_engine.engine.approve.ApprovalTask"):
            result = self.mixin.add_approver(task_id=1, operator_id=5, approver_ids=[999])

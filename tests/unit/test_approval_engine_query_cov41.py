...
def test_get_pending_tasks_returns_dict(query_mixin):
    query_mixin.db.query.return_value.filter.return_value.order_by.return_value.count.return_value = (
        0
    )
    ...
    with (
        patch("app.services.approval_engine.engine.query.get_pagination_params") as mock_pag,
        ...
        mock_apply.return_value = (
            query_mixin.db.query.return_value.filter.return_value.order_by.return_value
        )

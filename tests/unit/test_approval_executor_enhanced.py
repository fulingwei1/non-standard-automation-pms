...
class TestApprovalNodeExecutor(unittest.TestCase):
    ...
    def test_create_tasks_empty_approvers(self):
        ...
        tasks = self.executor.create_tasks_for_node(self.mock_instance, self.mock_node, [])
    ...
    def test_create_tasks_single_mode(self):
        """测试单人审批模式"""
        self.mock_node.approval_mode = "SINGLE"
        tasks = self.executor.create_tasks_for_node(self.mock_instance, self.mock_node, [101])
    ...
    def test_process_approval_invalid_status(self):
        ...
        can_proceed, error = self.executor.process_approval(mock_task, "APPROVE")
    ...
    def test_process_approval_single_mode_approve(self):
        ...
        with patch("app.services.approval_engine.executor.datetime") as mock_datetime:
            ...
            can_proceed, error = self.executor.process_approval(mock_task, "APPROVE", "同意")
    ...
    def test_process_approval_or_sign_reject_with_pending(self):
        ...
        with patch.object(self.executor, "_count_pending_tasks", return_value=2):
            can_proceed, error = self.executor.process_approval(mock_task, "REJECT")
    ...
    def test_process_approval_sequential_approve(self):
        ...
        with patch.object(
            self.executor, "_activate_next_sequential_task", return_value=mock_next_task
        ):
            can_proceed, error = self.executor.process_approval(mock_task, "APPROVE")
    ...
    def test_process_approval_with_eval_data(self):
        """测试带评估数据的审批（ECN场景）"""
        mock_task = self._create_mock_task("SINGLE")
        eval_data = {"cost_estimate": 5000, "schedule_estimate": 10, "risk_assessment": "中"}
    ...
    def test_process_countersign_no_result_record(self):
        ...
        can_proceed, error = self.executor._process_countersign(mock_task, "APPROVE")
    ...
    def test_process_countersign_one_rejected(self):
        ...
        with patch.object(self.executor, "_summarize_eval_data"):
            can_proceed, error = self.executor._process_countersign(mock_task, "REJECT")
    ...
    def test_create_cc_records_new_users(self):
        ...
        records = self.executor.create_cc_records(self.mock_instance, 10, [201, 202], "FLOW", 100)
    ...
    def test_create_cc_records_duplicate_skip(self):
        ...
        records = self.executor.create_cc_records(self.mock_instance, 10, [201], "FLOW")
    ...
    def test_create_cc_records_mixed(self):
        ...
        records = self.executor.create_cc_records(self.mock_instance, 10, [201, 202], "MANUAL", 100)

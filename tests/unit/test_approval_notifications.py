...
class TestApprovalNotifications:
    ...
    @patch("app.services.ecn.notification.approval_notifications.NotificationDispatcher")
    @patch("app.services.ecn.notification.approval_notifications.find_users_by_role")
    def test_notify_approval_assigned_no_approver(self, mock_find, mock_dispatcher):
        from app.services.ecn.notification.approval_notifications import notify_approval_assigned

...
class TestReject(unittest.TestCase):
    ...
    def test_reject_to_start_success(self):
        ...
        # 验证调用适配器回调
        self.engine._call_adapter_callback.assert_called_once_with(task.instance, "on_rejected")
    ...
    def test_reject_to_specific_node_by_id(self):
        ...
        self.mock_db.query.side_effect = [
            ...
            MagicMock(
                filter=MagicMock(return_value=MagicMock(first=MagicMock(return_value=target_node)))
            ),
        ]

...
class TestBomAttributesService(unittest.TestCase):
    ...
    def test_get_bom_assembly_attrs_basic(self):
        ...
        # 配置数据库mock
        with patch(
            "app.services.bom_attributes.bom_attributes_service.get_or_404"
        ) as mock_get_or_404:
        ...
        with patch(
            ...
            with patch(
                ...
                result = self.service.smart_recommend_assembly_attrs(
                    bom_id=1, overwrite=False, user_id=1
                )
    ...
    def test_smart_recommend_assembly_attrs_skip_existing(self):
        ...
        with patch(
            ...
            with patch(
                ...
                result = self.service.smart_recommend_assembly_attrs(bom_id=1, overwrite=False)
    ...
    def test_smart_recommend_assembly_attrs_update_with_overwrite(self):
        ...
        with patch(
            ...
            with patch(
                ...
                result = self.service.smart_recommend_assembly_attrs(bom_id=1, overwrite=True)
    ...
    def test_apply_assembly_template_success(self):
        ...
        with patch(
            ...
            result = self.service.apply_assembly_template(bom_id=1, template_id=1, overwrite=False)
    ...
    def test_apply_assembly_template_not_found(self):
        ...
        with patch(
            ...
            with self.assertRaises(HTTPException) as context:
                self.service.apply_assembly_template(bom_id=1, template_id=999, overwrite=False)
    ...
    def test_apply_assembly_template_empty_config(self):
        ...
        with patch(
            ...
            with self.assertRaises(HTTPException) as context:
                self.service.apply_assembly_template(bom_id=1, template_id=1, overwrite=False)
    ...
    def test_apply_assembly_template_with_overwrite(self):
        ...
        with patch(
            ...
            result = self.service.apply_assembly_template(bom_id=1, template_id=1, overwrite=True)

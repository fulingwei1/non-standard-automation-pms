...
class TestBomAttributesService(unittest.TestCase):
    ...
    def test_get_bom_assembly_attrs_success(self):
        ...
        with patch(
            "app.services.bom_attributes.bom_attributes_service.get_or_404", return_value=mock_bom
        ):
            # 设置查询链
    ...
    def test_update_assembly_attr_success(self):
        ...
        with patch(
            "app.services.bom_attributes.bom_attributes_service.get_or_404", return_value=mock_attr
        ):
    ...
    def test_apply_assembly_template_success(self):
        ...
        with patch(
            ...
            mock_query.first.side_effect = [
                ...
                mock_category,
                None,
            ]  # template, material, category, no existing

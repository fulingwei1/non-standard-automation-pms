...
class TestBuildOrderItems:
    ...
    def test_build_order_items_success(self):
        ...
        order_items, total_amount, total_tax, total_with_tax = build_order_items([item1, item3])
    ...
    def test_build_order_items_skip_fully_purchased(self):
        ...
        order_items, total_amount, total_tax, total_with_tax = build_order_items([item1, item2])
...
class TestGroupItemsBySupplier:
    ...
    def test_group_items_with_default_supplier(self, db_session: Session):
        ...
        grouped = group_items_by_supplier(db_session, [item1, item2, item3], default_supplier_id)

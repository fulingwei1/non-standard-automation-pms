...
class TestListBudgets:
    ...
    def test_list_budgets_by_project(self, db_session: Session, test_project):
        ...
        BudgetFactory.create(project=test_project, status="APPROVED", total_amount=100000)
        db_session.commit()
    ...
    def test_list_budgets_with_filter_by_status(self, db_session: Session, test_project):
        """按状态过滤预算"""

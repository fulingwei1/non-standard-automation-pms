...
class TestCalendarEvents:
    ...
    def test_create_calendar_event(self):
        ...
        with patch(
            "app.services.strategy.review.calendar_events.StrategyCalendarEvent"
        ) as MockEvent:
    ...
    def test_delete_calendar_event_not_found(self):
        ...
        db = _make_db()
        with patch(
            "app.services.strategy.review.calendar_events.get_calendar_event", return_value=None
        ):
    ...
    def test_delete_calendar_event_soft_delete(self):
        ...
        db = _make_db()
        with patch(
            "app.services.strategy.review.calendar_events.get_calendar_event", return_value=event
        ):
    ...
    def test_list_calendar_events_returns_tuple(self):
        ...
        with (
            patch("app.services.strategy.review.calendar_events.StrategyCalendarEvent") as MockSCE,

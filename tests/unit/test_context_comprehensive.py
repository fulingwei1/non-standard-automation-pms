...
class TestAuditContext:
    ...
    def test_detail_dict(self):
        """测试详情字典"""
        detail = {"action": "update_project", "project_id": 123, "changes": {"status": "COMPLETED"}}
...
class TestEdgeCases:
    ...
    def test_nested_detail_dict(self):
        """测试嵌套详情字典"""
        detail = {"level1": {"level2": {"level3": "value"}}}
        set_audit_context(detail=detail)
        assert get_audit_context()["detail"] == detail
...
class TestRealWorldScenarios:
    ...
    def test_user_login_scenario(self):
        ...
        set_audit_context(
            ...
            detail={"action": "login", "username": "testuser", "success": True},
            tenant_id=1,
        )
    ...
    def test_api_request_tracking(self):
        ...
        set_audit_context(
            ...
            detail={"endpoint": "/api/v1/projects", "method": "POST", "request_id": "abc-123-def"},
        )

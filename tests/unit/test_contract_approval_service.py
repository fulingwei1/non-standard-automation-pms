...
class TestContractApprovalService(unittest.TestCase):
    ...
    def test_submit_contracts_for_approval_success(self):
        ...
        results, errors = self.service.submit_contracts_for_approval(
            contract_ids=[1], initiator_id=1, urgency="URGENT", comment="紧急审批"
        )
    ...
    def test_submit_contracts_contract_not_found(self):
        ...
        # 执行
        results, errors = self.service.submit_contracts_for_approval(
            contract_ids=[999], initiator_id=1
        )
    ...
    def test_submit_contracts_batch_mixed_results(self):
        ...
        # 执行
        results, errors = self.service.submit_contracts_for_approval(
            contract_ids=[1, 2, 3], initiator_id=1
        )
    ...
    def test_get_pending_tasks_with_filters(self):
        ...
        items, total = self.service.get_pending_tasks(user_id=2, customer_id=1, min_amount=10000.0)
    ...
    def test_get_pending_tasks_pagination(self):
        ...
        # 执行 - 第2页，每页1条
        items, total = self.service.get_pending_tasks(user_id=2, page=2, page_size=1)
    ...
    def test_approve_task(self):
        ...
        result = self.service.approve_task(task_id=1, approver_id=2, comment="同意")
    ...
    def test_reject_task(self):
        ...
        result = self.service.reject_task(task_id=1, approver_id=2, comment="不同意")

        self.assertEqual(result, mock_result)
        self.service.engine.reject.assert_called_once_with(
            task_id=1, approver_id=2, comment="不同意"
        )
    ...
    def test_batch_approve_success(self):
        ...
        results, errors = self.service.batch_approve_or_reject(
            task_ids=[1, 2, 3], approver_id=2, action="approve", comment="批量同意"
        )
    ...
    def test_batch_reject_success(self):
        ...
        results, errors = self.service.batch_approve_or_reject(
            task_ids=[1, 2], approver_id=2, action="reject", comment="批量驳回"
        )
    ...
    def test_batch_approve_invalid_action(self):
        """测试批量操作使用无效的action"""
        results, errors = self.service.batch_approve_or_reject(
            task_ids=[1], approver_id=2, action="invalid_action"
        )
    ...
    def test_batch_approve_partial_failure(self):
        ...
        results, errors = self.service.batch_approve_or_reject(
            task_ids=[1, 2, 3], approver_id=2, action="approve"
        )
    ...
    def test_withdraw_approval_success(self):
        ...
        result = self.service.withdraw_approval(contract_id=1, user_id=1, reason="需要修改")
    ...
    def test_get_approval_history_with_status_filter(self):
        ...
        # 执行
        items, total = self.service.get_approval_history(user_id=2, status_filter="APPROVED")
    ...
    def test_get_approval_history_pagination(self):
        ...
        # 执行 - 第2页，每页2条
        items, total = self.service.get_approval_history(user_id=2, page=2, page_size=2)

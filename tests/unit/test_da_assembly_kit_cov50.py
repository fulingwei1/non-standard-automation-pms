...
def test_get_stats_empty_db():
    ...
    with patch(
        "app.services.dashboard_adapters.assembly_kit.DashboardStatCard",
...
def test_get_widgets_returns_two_widgets():
    ...
    with patch(
        "app.services.dashboard_adapters.assembly_kit.DashboardWidget", side_effect=_mock_widget
    ):
        adapter = _make_adapter(db=db)
...
def test_get_detailed_data_structure():
    ...
    with (
        ...
        patch(
            "app.services.dashboard_adapters.assembly_kit.DetailedDashboardResponse",

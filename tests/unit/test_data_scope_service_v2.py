...
class TestDataScopeService:
    ...
    def test_get_user_org_units_no_assignments(self, db_session: Session):
        ...
        employee = Employee(employee_code="EMP-TEST", name="测试员工", department="测试部门")
    ...
    def test_apply_data_scope_superuser(self, mock_permission_service, db_session: Session):
        """测试应用数据权限 - 超级管理员"""
        from app.core.security import get_password_hash
        from app.models.organization import Employee
        ...
        result = DataScopeService.apply_data_scope(mock_query, db_session, user, "project")

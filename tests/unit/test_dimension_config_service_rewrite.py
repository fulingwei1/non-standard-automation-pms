...
class TestDimensionConfigServiceCore(unittest.TestCase):
    ...
    def test_get_config_department_priority(self):
        ...
        result = self.service.get_config(
            job_type="mechanical", department_id=100, effective_date=self.today
        )
    ...
    def test_get_config_with_job_level(self):
        ...
        result = self.service.get_config(
            job_type="mechanical", job_level="P6", effective_date=self.today
        )
    ...
    def test_get_department_config_with_job_level(self):
        ...
        result = self.service._get_department_config(
            job_type="mechanical", job_level="P7", effective_date=self.today, department_id=100
        )
    ...
    def test_get_department_config_fallback_to_common(self):
        ...
        result = self.service._get_department_config(
            job_type="mechanical", job_level="P6", effective_date=self.today, department_id=100
        )
    ...
    def test_get_global_config_with_job_level(self):
        ...
        result = self.service._get_global_config(
            job_type="test", job_level="P8", effective_date=self.today
        )
    ...
    def test_get_global_config_fallback_to_common(self):
        ...
        result = self.service._get_global_config(
            job_type="electrical", job_level="P5", effective_date=self.today
        )
    ...
    def test_create_config_valid_weights(self, mock_save):
        ...
        result = self.service.create_config(data=data, operator_id=1, require_approval=False)
    ...
    def test_create_department_config_requires_approval(self, mock_save):
        ...
        result = self.service.create_config(
            data=data, operator_id=1, department_id=100, require_approval=True
        )
    ...
    def test_list_configs_all(self):
        """测试列出所有配置"""
        configs = [Mock(spec=EngineerDimensionConfig), Mock(spec=EngineerDimensionConfig)]
    ...
    def test_build_config_list(self):
        """测试构建配置列表"""
        distribution = {"mechanical": {"count": 5, "levels": {"P6": 3, "P7": 2}}}
        ...
        result = self.service._build_config_list(distribution, dept_configs, global_configs)
    ...
    def test_build_config_list_no_configs(self):
        """测试没有配置的情况"""
        distribution = {"electrical": {"count": 2, "levels": {"P5": 2}}}
    ...
    def test_approve_config_success(self):
        ...
        result = self.service.approve_config(
            config_id=1, approver_id=2, approved=True, approval_reason="测试通过"
        )
    ...
    def test_approve_config_reject(self):
        ...
        result = self.service.approve_config(
            config_id=1, approver_id=2, approved=False, approval_reason="不符合要求"
        )
    ...
    def test_get_pending_approvals(self):
        """测试获取待审批配置"""
        pending_configs = [Mock(spec=EngineerDimensionConfig), Mock(spec=EngineerDimensionConfig)]

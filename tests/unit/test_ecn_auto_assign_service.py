...
class TestFindUsersByDepartment:
    ...
    def test_find_users_by_department_success(self):
        ...
        mock_users = [
            MockUser(1, "研发部", "工程师", password_hash="test_hash_123"),
            MockUser(2, "研发部", "高级工程师", password_hash="test_hash_123"),
        ]
...
class TestFindUsersByRole:
    ...
    def test_find_users_by_role_success(self):
        ...
        mock_users = [
            MockUser(1, password_hash="test_hash_123"),
            MockUser(2, password_hash="test_hash_123"),
        ]
...
class TestAutoAssignEvaluation:
    ...
    def test_auto_assign_evaluation_select_leader(self):
        ...
        mock_users = [
            MockUser(1, "研发部", "工程师", password_hash="test_hash_123"),
            MockUser(2, "研发部", "部门负责人", password_hash="test_hash_123"),
            MockUser(3, "研发部", "经理", password_hash="test_hash_123"),
        ]
        db.query.return_value.filter.return_value.all.return_value = mock_users
    ...
    def test_auto_assign_evaluation_select_manager(self):
        ...
        mock_users = [
            MockUser(1, "研发部", "工程师", password_hash="test_hash_123"),
            MockUser(2, "研发部", "经理", password_hash="test_hash_123"),
        ]
        db.query.return_value.filter.return_value.all.return_value = mock_users
    ...
    def test_auto_assign_evaluation_select_supervisor(self):
        ...
        mock_users = [
            MockUser(1, "研发部", "工程师", password_hash="test_hash_123"),
            MockUser(2, "研发部", "主管", password_hash="test_hash_123"),
        ]
        db.query.return_value.filter.return_value.all.return_value = mock_users
...
class TestAutoAssignApproval:
    ...
    def test_auto_assign_approval_select_leader(self):
        ...
        mock_user_roles = [MockUserRole(1, 1), MockUserRole(2, 1)]
        mock_users = [
            MockUser(1, position="普通审批员", password_hash="test_hash_123"),
            MockUser(2, position="审批负责人", password_hash="test_hash_123"),
        ]
...
class TestAutoAssignTask:
    ...
    def test_auto_assign_task_select_leader(self):
        ...
        mock_users = [
            MockUser(1, "生产部", "操作员", password_hash="test_hash_123"),
            MockUser(2, "生产部", "生产负责人", password_hash="test_hash_123"),
        ]
        db.query.return_value.filter.return_value.all.return_value = mock_users
...
class TestEcnAutoAssignIntegration:
    ...
    def test_position_priority_leader(self):
        ...
        mock_users = [
            MockUser(1, "测试部", "测试工程师", password_hash="test_hash_123"),
            MockUser(2, "测试部", "测试主管", password_hash="test_hash_123"),
            MockUser(3, "测试部", "测试经理", password_hash="test_hash_123"),
            MockUser(4, "测试部", "测试负责人", password_hash="test_hash_123"),
        ]
        db.query.return_value.filter.return_value.all.return_value = mock_users

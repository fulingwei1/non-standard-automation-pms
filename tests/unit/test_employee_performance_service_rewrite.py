...
class TestEmployeePerformanceServiceCreateSummary(unittest.TestCase):
    ...
    def test_create_monthly_work_summary_success(self, mock_create_tasks):
        ...
        self.assertEqual(
            result.work_content, "完成项目A开发，包括需求分析、系统设计、代码编写、测试和部署等工作"
        )
...
class TestEmployeePerformanceServiceSaveDraft(unittest.TestCase):
    ...
    def test_save_draft_update_existing(self):
        ...
        summary_update = MonthlyWorkSummaryUpdate(work_content="更新后的内容", highlights="新亮点")
...
class TestEmployeePerformanceServiceGetMyPerformance(unittest.TestCase):
    ...
    def test_get_my_performance_with_current_summary(
        self, mock_date, mock_history, mock_level, mock_calc
    ):
        """获取我的绩效（有当前总结）"""
        # Mock当前日期
        ...
        # Mock绩效计算
        mock_calc.return_value = {"final_score": 87.5, "dept_score": 90.0, "project_score": 85.0}

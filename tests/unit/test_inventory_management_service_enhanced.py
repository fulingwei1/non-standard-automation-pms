...
class TestInventoryManagementServiceEnhanced(unittest.TestCase):
    ...
    def test_get_stock_with_batch_filter(self):
        ...
        result = self.service.get_stock(material_id=100, batch_number="BATCH001")
    ...
    def test_get_stock_with_all_filters(self):
        ...
        result = self.service.get_stock(material_id=100, location="仓库A", batch_number="BATCH001")
    ...
    def test_get_available_quantity_with_location(self):
        ...
        result = self.service.get_available_quantity(material_id=100, location="仓库A")
    ...
    def test_get_all_stocks_with_filters(self):
        ...
        result = self.service.get_all_stocks(location="仓库A", status="NORMAL", limit=50)
    ...
    def test_update_stock_issue_insufficient(self):
        ...
        with self.assertRaises(InsufficientStockError):
            self.service.update_stock(
                material_id=100, quantity=Decimal("50"), transaction_type="ISSUE", location="仓库A"
            )
    ...
    def test_update_stock_adjust_positive(self):
        ...
        result = self.service.update_stock(
            material_id=100, quantity=Decimal("20"), transaction_type="ADJUST", location="仓库A"
        )
    ...
    def test_update_stock_adjust_negative(self):
        ...
        result = self.service.update_stock(
            material_id=100, quantity=Decimal("-15"), transaction_type="ADJUST", location="仓库A"
        )
    ...
    def test_issue_material_success(self, mock_update, mock_create, mock_select, mock_release):
        """测试领料出库成功"""
        mock_transaction = MaterialTransaction(id=1, total_amount=Decimal("315"))
        mock_create.return_value = mock_transaction
    ...
    @patch.object(InventoryManagementService, "create_transaction")
    @patch.object(InventoryManagementService, "update_stock")
    def test_issue_material_with_reservation(
        self, mock_update, mock_create, mock_select, mock_release
    ):
        """测试领料出库-带预留"""
        ...
        result = self.service.issue_material(
            material_id=100, quantity=Decimal("30"), location="仓库A", reservation_id=3001
        )
    ...
    def test_select_stock_for_issue_fifo(self):
        ...
        result = self.service._select_stock_for_issue(
            material_id=100, location="仓库A", quantity=Decimal("60"), cost_method="FIFO"
        )
    ...
    def test_select_stock_for_issue_lifo(self):
        ...
        result = self.service._select_stock_for_issue(
            material_id=100, location="仓库A", quantity=Decimal("60"), cost_method="LIFO"
        )
    ...
    def test_select_stock_for_issue_no_stock(self):
        ...
        with self.assertRaises(InsufficientStockError):
            self.service._select_stock_for_issue(
                material_id=100, location="仓库A", quantity=Decimal("50"), cost_method="FIFO"
            )

    def test_select_stock_for_issue_insufficient(self):
        """测试选择库存-库存不足"""
        stock = MaterialStock(
            id=1, material_id=100, location="仓库A", available_quantity=Decimal("20")
        )
    ...
    def test_return_material_auto_batch(self, mock_update, mock_create):
        ...
        result = self.service.return_material(
            material_id=100, quantity=Decimal("15"), location="仓库A"
        )
    ...
    def test_transfer_stock_success(self, mock_update, mock_create):
        ...
        from_stock = MaterialStock(
            id=1, material_id=100, location="仓库A", unit_price=Decimal("10.5")
        )
        to_stock = MaterialStock(
            id=2, material_id=100, location="仓库B", unit_price=Decimal("10.5")
        )
    ...
    def test_reserve_material_insufficient(self, mock_available):
        ...
        with self.assertRaises(InsufficientStockError):
            self.service.reserve_material(material_id=100, quantity=Decimal("50"))
    ...
    def test_reserve_material_multiple_stocks(self, mock_available):
        ...
        stock1 = MaterialStock(
            id=1, material_id=100, available_quantity=Decimal("30"), reserved_quantity=Decimal("0")
        )
        stock2 = MaterialStock(
            id=2, material_id=100, available_quantity=Decimal("50"), reserved_quantity=Decimal("0")
        )
        ...
        result = self.service.reserve_material(material_id=100, quantity=Decimal("60"))
    ...
    def test_cancel_reservation_success(self):
        ...
        stock = MaterialStock(
            id=1, material_id=100, reserved_quantity=Decimal("30"), available_quantity=Decimal("50")
        )
        ...
        result = self.service.cancel_reservation(
            reservation_id=3001, cancelled_by=5, cancel_reason="项目取消"
        )
    ...
    def test_cancel_reservation_invalid_status(self):
        """测试取消预留-状态不允许"""
        reservation = MaterialReservation(id=3001, tenant_id=self.tenant_id, status="USED")
    ...
    def test_release_reservation_full(self):
        """测试释放预留-完全使用"""
        reservation = MaterialReservation(
            id=3001, used_quantity=Decimal("0"), remaining_quantity=Decimal("30"), status="ACTIVE"
        )
    ...
    def test_calculate_turnover_rate_success(self):
        """测试计算周转率成功"""
        transactions = [
            MaterialTransaction(id=1, transaction_type="ISSUE", total_amount=Decimal("1000")),
            MaterialTransaction(id=2, transaction_type="ISSUE", total_amount=Decimal("1500")),
        ]

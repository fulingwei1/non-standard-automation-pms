...
class TestUpdateKpiValue:
    ...
    def test_update_value_basic(self):
        ...
        with (
            patch("app.services.strategy.kpi_service.value.get_kpi", return_value=kpi_mock),
            patch("app.services.strategy.kpi_service.value.create_kpi_snapshot"),
        ):
            result = update_kpi_value(db, kpi_id=1, value=Decimal("75"), recorded_by=5)
    ...
    def test_update_value_with_remark(self):
        ...
        with (
            ...
            update_kpi_value(
                db, kpi_id=1, value=Decimal("75"), recorded_by=2, remark="Manual update"
            )
    ...
    def test_update_value_with_special_characters_in_remark(self):
        ...
        with (
            ...
            update_kpi_value(
                db, kpi_id=1, value=Decimal("70"), recorded_by=1, remark=special_remark
            )
    ...
    def test_update_value_snapshot_creation_error(self):
        ...
        with (
            patch("app.services.strategy.kpi_service.value.get_kpi", return_value=kpi_mock),
            patch(
                "app.services.strategy.kpi_service.value.create_kpi_snapshot",

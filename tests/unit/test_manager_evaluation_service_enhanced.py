...
class TestAdjustPerformance(TestManagerEvaluationService):
    ...
    def setUp(self):
        ...
        self.patcher = patch.object(self.service, "check_manager_permission", return_value=True)
    ...
    def test_adjust_performance_result_not_found(self):
        ...
        with self.assertRaises(ValueError) as context:
            self.service.adjust_performance(999, 1, adjustment_reason="有效的调整理由大于十个字符")
    ...
    def test_adjust_performance_no_permission(self):
        ...
        with self.assertRaises(ValueError) as context:
            self.service.adjust_performance(1, 1, adjustment_reason="有效的调整理由大于十个字符")
    ...
    def test_adjust_performance_manager_not_found(self):
        ...
        with self.assertRaises(ValueError) as context:
            self.service.adjust_performance(1, 999, adjustment_reason="有效的调整理由大于十个字符")
    ...
    def test_adjust_performance_first_time_success(self, mock_save):
        ...
        self.db.query.return_value.filter.return_value.first.side_effect = [result, manager]
...
class TestGetEngineersForEvaluation(TestManagerEvaluationService):
    ...
    def test_get_engineers_success(self, mock_tasks):
        ...
        self.db.query.return_value.filter.return_value.first.side_effect = [user1, user2]
...
class TestSubmitEvaluation(TestManagerEvaluationService):
    ...
    def test_submit_evaluation_minimal_comments(self):
        ...
        self.db.query.return_value.filter.return_value.first.side_effect = [result, None, manager]

        response = self.service.submit_evaluation(result_id=1, manager_id=1)

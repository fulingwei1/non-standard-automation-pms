...
class TestPermissionManagementService(unittest.TestCase):
    ...
    def test_create_permission(self):
        ...
        # 模拟 ApiPermission 构造
        with patch(
            "app.services.permission_management.permission_management_service.ApiPermission"
        ) as MockPermission:
    ...
    def test_assign_role_permissions(self):
        ...
        with patch(
            "app.services.permission_management.permission_management_service.RoleApiPermission"
        ) as MockRolePermission:
            # 执行测试
    ...
    def test_invalidate_permission_cache(self):
        ...
        # 测试缓存失效（允许失败）
        with patch(
            "app.services.permission_management.permission_management_service.get_permission_cache_service"
        ) as mock_cache:
    ...
    def test_get_user_permissions(self):
        ...
        with patch(
            "app.services.permission_management.permission_management_service.PermissionService"

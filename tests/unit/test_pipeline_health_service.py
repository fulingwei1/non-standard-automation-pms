...
class TestPipelineHealthService:
    ...
    def test_calculate_lead_health_converted(self, pipeline_health_service, test_sales_user):
        lead = Lead(
            owner_id=test_sales_user.id,
            lead_code="LEAD004",
            customer_name="已转换客户",
    ...
    def test_calculate_quote_health_h1(
        self, pipeline_health_service, test_sales_user, test_customer
    ):
    ...
    def test_calculate_quote_health_h3(
        self, pipeline_health_service, test_sales_user, test_customer
    ):
        from app.models.sales import Opportunity
    ...
    def test_calculate_pipeline_health(
        ...
        result = pipeline_health_service.calculate_pipeline_health(lead_id=lead.id)
    ...
    def test_pipeline_health_overall_worst(self):
        ...
        with (
            patch.object(
                svc,
                "calculate_lead_health",
                return_value={"health_status": "H2", "health_score": 50},
            ),
            patch.object(
                svc,
                "calculate_opportunity_health",
                return_value={"health_status": "H3", "health_score": 20},
            ),
        ):

...
def mock_gen():
    ...
    with (
        patch("app.services.ppt_generator.generator.Presentation") as MockPrs,
...
def test_generate_calls_save(mock_gen, tmp_path):
    ...
    for method in [
        "create_cover_slide",
        "create_toc_slide",
        "create_part1_industry_insights",
        "create_part2_solution_overview",
        "create_part3_core_features",
        "create_part4_customer_portal",
        "create_part5_ai_capabilities",
        "create_part6_customer_value",

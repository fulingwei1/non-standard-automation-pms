...
更多文本"""
    ...
    def test_calculate_confidence_score_high(self):
        ...
        analyzer = AIRequirementAnalyzer()
        raw_requirement = (
            "需要一条全自动化的汽车零部件装配生产线，包括机器人焊接、视觉检测、自动搬运等功能。"
            + "详细需求" * 100
        )
        parsed_result = {
    ...
    def test_calculate_confidence_score_medium(self):
        ...
        parsed_result = {
            ...
            "equipment_list": [{"name": "焊接设备", "type": "焊机"}],
            "technical_parameters": [],
            "process_flow": [],
        }
        score = analyzer._calculate_confidence_score(raw_requirement, parsed_result)
...
class TestPresaleAIRequirementService:
    ...
    async def test_analyze_requirement_success(self):
        ...
        mock_questions = [
            ClarificationQuestion(
                question_id=1, category="技术参数", question="精度要求？", importance="high"
            )
        ]
    ...
    async def test_refine_requirement_success(self):
        ...
        request = RequirementRefinementRequest(
            analysis_id=100, additional_context="补充信息：需要防爆设计"
        )
        ...
        with (
            patch.object(service, "get_analysis", return_value=mock_analysis),
            patch.object(
                service.analyzer, "analyze_requirement", new_callable=AsyncMock
            ) as mock_analyze,
        ):
    ...
    async def test_refine_requirement_not_found(self):
        ...
        request = RequirementRefinementRequest(analysis_id=999, additional_context="补充信息")
    ...
    def test_get_clarification_questions_found(self):
        ...
        mock_analysis.clarification_questions = [
            {"question_id": 1, "category": "技术参数", "question": "精度？", "importance": "high"},
            {
                "question_id": 2,
                "category": "功能需求",
                "question": "速度？",
    ...
    def test_update_structured_requirement_full_update(self):
        ...
        request = RequirementUpdateRequest(
            ...
            equipment_list=[
                EquipmentItem(
                    name="机器人", type="焊接机器人", quantity=2, specifications={}, priority="high"
                )
            ],
            process_flow=[
                ProcessStep(
    ...
    def test_update_structured_requirement_partial_update(self):
        ...
        request = RequirementUpdateRequest(analysis_id=100, acceptance_criteria=["新的验收标准"])
    ...
    def test_update_structured_requirement_not_found(self):
        ...
        request = RequirementUpdateRequest(analysis_id=999, acceptance_criteria=["标准"])

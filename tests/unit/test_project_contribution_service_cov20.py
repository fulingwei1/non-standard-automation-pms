...
class TestCalculateMemberContribution:
    def test_creates_new_contribution_when_not_exists(self):
        ...
        with patch(
            "app.services.project_contribution_service.ProjectMemberContribution"
        ) as MockContrib:
            contrib = make_contribution()
            MockContrib.return_value = contrib
            result = svc.calculate_member_contribution(project_id=1, user_id=1, period="2025-01")
    ...
    def test_calculates_task_count(self):
        ...
        result = svc.calculate_member_contribution(project_id=1, user_id=1, period="2025-06")
    ...
    def test_period_december_wraps_to_jan(self):
        ...
        db.query.return_value = q
        # Should not raise
        result = svc.calculate_member_contribution(project_id=1, user_id=1, period="2025-12")

...
class TestProjectRiskService(unittest.TestCase):
    ...
    def test_create_risk_success(self):
        ...
        with (
            patch("app.services.project_risk.project_risk_service.get_or_404") as mock_get,
            patch("app.services.project_risk.project_risk_service.save_obj") as mock_save,
            patch(
                "app.services.project_risk.project_risk_service.ProjectRisk", return_value=mock_risk
            ),
        ):
    ...
    def test_get_risk_list_with_filters(self):
        ...
        mock_filter_chain.order_by.return_value.offset.return_value.limit.return_value.all.return_value = (
            mock_risks
        )
    ...
    def test_update_risk_with_status_closure(self):
        ...
        update_data = {"status": "CLOSED", "description": "Updated description"}

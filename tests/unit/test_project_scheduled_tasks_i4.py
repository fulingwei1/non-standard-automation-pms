    ...
    def test_project_near_deadline_creates_alert(self):
        ...
        def query_side(model_cls):
            ...
            if call_count[0] == 1:
                ...
                # 查询已有预警 -> None
                q.filter.return_value.filter.return_value.filter.return_value.filter.return_value.first.return_value = (
                    None
                )
            return q
        ...
        with (
            ...
            patch(
                "app.utils.scheduled_tasks.project_scheduled_tasks.AlertRecord",
...
class TestDailySpecMatchCheck:
    ...
    def test_no_active_projects_returns_zero(self):
        ...
        with (
            ...
            patch(
                "app.utils.scheduled_tasks.project_scheduled_tasks.SpecMatchService",

...
class TestBuildTeamInfo:
    ...
    def test_returns_multiple_members(self):
        ...
        members = [
            create_mock_member(
                user_id=1, role_code="PM", user=create_mock_user(id=1, real_name="张三")
            ),
            create_mock_member(
                user_id=2, role_code="DEV", user=create_mock_user(id=2, real_name="李四")
            ),
            create_mock_member(
                user_id=3, role_code="QA", user=create_mock_user(id=3, real_name="王五")
            ),
        ]

...
class TestGetEntityData:
    ...
    def test_get_entity_data_minimal(self):
        """测试获取最小数据的采购订单"""
        db = make_db()
        order = make_purchase_order(id=1, project_id=None, vendor_id=None, order_title=None)
...
class TestValidateSubmit:
    ...
    def test_validate_submit_no_items(self):
        ...
        db = make_db()
        order = make_purchase_order(
            id=1, status="DRAFT", supplier_id=100, order_date=datetime.now()
        )
    ...
    def test_validate_submit_zero_amount(self):
        ...
        db = make_db()
        order = make_purchase_order(
            id=1, status="DRAFT", supplier_id=100, order_date=datetime.now(), amount_with_tax="0"
        )
...
class TestEdgeCases:
    ...
    def test_date_isoformat_conversion(self):
        ...
        order = make_purchase_order(id=1, order_date=test_date, vendor_id=None, project_id=None)

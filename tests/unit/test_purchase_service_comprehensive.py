...
from app.models.purchase import GoodsReceipt, PurchaseOrder, PurchaseRequest
...
class TestPurchaseServiceComprehensive:
    ...
    def test_get_purchase_orders_success(self, service, db_mock):
        ...
        mock_order.id = 1
        db_mock.query.return_value.options.return_value.order_by.return_value.offset.return_value.limit.return_value.all.return_value = [
            mock_order
        ]
    ...
    def test_get_purchase_order_by_id_found(self, service, db_mock):
        ...
        mock_order = MagicMock()
        mock_order.id = 1
        db_mock.query.return_value.options.return_value.filter.return_value.first.return_value = (
            mock_order
        )
    ...
    def test_create_purchase_order_success(self, service, db_mock):
        ...
        order_data = {
            ...
            "project_id": 1,
            "total_amount": 10000,
            "items": [{"material_id": 1, "quantity": 10, "unit_price": 100, "total_amount": 1000}],
        }

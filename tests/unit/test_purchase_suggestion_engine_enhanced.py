...
class TestGenerateFromShortages(TestPurchaseSuggestionEngine):
    ...
    def test_generate_from_shortages_with_project_filter(self):
        ...
        mock_shortage_query.filter.return_value.filter.return_value.all.return_value = [
            mock_shortage
        ]
        ...
        self.db.query.side_effect = [mock_shortage_query, mock_existing_query, mock_material_query]

        # Mock 推荐供应商方法
        self.engine._recommend_supplier = MagicMock(
            return_value=(1, Decimal("85.5"), {"total_score": 85.5}, [])
        )
...
class TestGenerateFromSafetyStock(TestPurchaseSuggestionEngine):
    ...
    def test_generate_from_safety_stock_success(self):
        ...
        # Mock 推荐供应商
        self.engine._recommend_supplier = MagicMock(
            return_value=(2, Decimal("90.0"), {"total_score": 90.0}, [])
        )
    ...
    def test_generate_from_safety_stock_respect_min_order_qty(self):
        ...
        self.engine._recommend_supplier = MagicMock(return_value=(2, Decimal("90.0"), {}, []))
...
class TestGenerateFromForecast(TestPurchaseSuggestionEngine):
    ...
    def test_generate_from_forecast_success(self):
        ...
        self.engine._recommend_supplier = MagicMock(return_value=(3, Decimal("88.0"), {}, []))
...
class TestRecommendSupplier(TestPurchaseSuggestionEngine):
    ...
    def test_recommend_supplier_single_supplier(self):
        ...
        # Mock 评分计算
        self.engine._calculate_supplier_score = MagicMock(
            return_value={
...
class TestCalculateSupplierScore(TestPurchaseSuggestionEngine):
    ...
    def test_calculate_supplier_score_with_performance(self):
        ...
        mock_perf_query.filter.return_value.order_by.return_value.first.return_value = (
            mock_performance
        )

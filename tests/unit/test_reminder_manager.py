...
class TestTimesheetReminderManager(unittest.TestCase):
    ...
    def test_update_reminder_config_success(self):
        ...
        result = self.manager.update_reminder_config(
            config_id=1, rule_name="更新后的规则", is_active=False, priority="LOW"
        )
    ...
    def test_update_reminder_config_not_found(self):
        ...
        result = self.manager.update_reminder_config(config_id=999, rule_name="不存在的规则")
    ...
    def test_check_user_applicable_no_restrictions(self):
        ...
        result = self.manager.check_user_applicable(config=config, user_id=100)
    ...
    def test_check_user_applicable_user_match(self):
        ...
        result = self.manager.check_user_applicable(config=config, user_id=200)
    ...
    def test_check_user_applicable_department_match(self):
        ...
        result = self.manager.check_user_applicable(config=config, user_id=100, department_id=2)
    ...
    def test_check_user_applicable_role_match(self):
        ...
        result = self.manager.check_user_applicable(
            config=config, user_id=100, role_ids=[5, 20, 25]
        )
    ...
    def test_check_user_applicable_no_match(self):
        ...
        result = self.manager.check_user_applicable(
            config=config, user_id=999, department_id=99, role_ids=[99]
        )
    ...
    def test_create_reminder_record_minimal(self):
        ...
        with patch("app.services.timesheet_reminder.reminder_manager.save_obj") as mock_save:
            ...
            with patch.object(
                self.manager, "_generate_reminder_no", return_value="RM20260221140001"
            ):
    ...
    def test_create_reminder_record_full_parameters(self):
        ...
        with patch("app.services.timesheet_reminder.reminder_manager.save_obj") as mock_save:
            with patch.object(
                self.manager, "_generate_reminder_no", return_value="RA20260221140002"
            ):
                result = self.manager.create_reminder_record(
                    reminder_type=ReminderTypeEnum.APPROVAL_TIMEOUT,
                    user_id=200,
    ...
    def test_mark_reminder_sent_success(self):
        ...
        result = self.manager.mark_reminder_sent(reminder_id=1, channels=["EMAIL", "WECHAT"])
    ...
    def test_dismiss_reminder_success(self):
        ...
        result = self.manager.dismiss_reminder(reminder_id=1, dismissed_by=100, reason="误报")
    ...
    def test_dismiss_reminder_without_reason(self):
        ...
        result = self.manager.dismiss_reminder(reminder_id=1, dismissed_by=100)
    ...
    def test_get_pending_reminders_with_filters(self):
        ...
        result = self.manager.get_pending_reminders(
            user_id=100, reminder_type=ReminderTypeEnum.MISSING_TIMESHEET, limit=50
        )
    ...
    def test_check_reminder_limit_under_limit(self):
        ...
        result = self.manager.check_reminder_limit(
            user_id=100, reminder_type=ReminderTypeEnum.MISSING_TIMESHEET, max_per_day=5
        )
    ...
    def test_resolve_anomaly_success(self):
        ...
        result = self.manager.resolve_anomaly(
            anomaly_id=1, resolved_by=100, resolution_note="已补填工时说明"
        )
    ...
    def test_resolve_anomaly_not_found(self):
        ...
        result = self.manager.resolve_anomaly(anomaly_id=999, resolved_by=100)
    ...
    def test_resolve_anomaly_without_note(self):
        ...
        result = self.manager.resolve_anomaly(anomaly_id=1, resolved_by=100)
    ...
    def test_get_unresolved_anomalies_with_filters(self):
        ...
        result = self.manager.get_unresolved_anomalies(
            user_id=100, anomaly_type=AnomalyTypeEnum.DAILY_OVER_12, limit=50
        )
    ...
    def test_check_user_applicable_department_none(self):
        ...
        result = self.manager.check_user_applicable(config=config, user_id=100, department_id=None)
    ...
    def test_check_user_applicable_roles_none(self):
        ...
        result = self.manager.check_user_applicable(config=config, user_id=100, role_ids=None)
    ...
    def test_check_user_applicable_empty_role_list(self):
        ...
        result = self.manager.check_user_applicable(config=config, user_id=100, role_ids=[])
    ...
    def test_update_reminder_config_ignore_none_values(self):
        ...
        result = self.manager.update_reminder_config(config_id=1, rule_name="新名称", priority=None)

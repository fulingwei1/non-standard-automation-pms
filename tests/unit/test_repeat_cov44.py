...
class TestRepeatTemplate:
    ...
    def test_template_is_dict(self):
        assert isinstance(REPEAT_TEMPLATE, dict)
    ...
    def test_first_stage_is_order_confirmation(self):
        assert REPEAT_TEMPLATE["stages"][0]["stage_name"] == "订单确认"
    ...
    def test_sequence_is_ordered(self):

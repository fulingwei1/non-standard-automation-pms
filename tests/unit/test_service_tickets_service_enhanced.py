...
class TestServiceTicketsService(unittest.TestCase):
    ...
    def test_get_dashboard_statistics_basic(self):
        ...
        # Mock 私有方法
        with (
            patch.object(self.service, "_calculate_avg_response_time", return_value=120.5),
    ...
    def test_get_dashboard_statistics_zero_values(self):
        ...
        with (
            patch.object(self.service, "_calculate_avg_response_time", return_value=0.0),
    ...
    def test_get_service_tickets_basic(self):
        ...
        with (
            patch(
                "app.services.service.service_tickets_service.apply_keyword_filter",
                return_value=mock_query,
            ),
            patch(
                "app.services.service.service_tickets_service.apply_pagination",
                return_value=mock_query,
            ),
            patch(
                "app.services.service.service_tickets_service.get_pagination_params"
            ) as mock_pagination,
        ):

            mock_pagination.return_value = MagicMock(
                page=1, page_size=20, offset=0, limit=20, pages_for_total=lambda x: 1
            )
    ...
    def test_get_service_tickets_with_filters(self):
        ...
        with (
            ...
            mock_pagination.return_value = MagicMock(
                page=1, page_size=20, offset=0, limit=20, pages_for_total=lambda x: 0
            )
    ...
    def test_get_service_tickets_pagination(self):
        ...
        with (
            ...
            mock_pagination.return_value = MagicMock(
                page=2, page_size=10, offset=10, limit=10, pages_for_total=lambda x: 5
            )
    ...
    def test_create_service_ticket_basic(self):
        ...
        with (
            patch.object(self.service, "_generate_ticket_number", return_value="REPAIR20240101001"),
    ...
    def test_create_service_ticket_with_description_fallback(self):
        ...
        with (
            patch.object(self.service, "_generate_ticket_number", return_value="MAINT20240101001"),
            patch.object(self.service, "_auto_assign_ticket"),
            patch.object(self.service, "_send_ticket_notification"),
    ...
    def test_assign_ticket_success(self):
        ...
        with (
            patch.object(self.service, "get_service_ticket", return_value=mock_ticket),
            patch.object(self.service, "_send_ticket_notification"),
        ):

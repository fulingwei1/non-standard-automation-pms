...
class TestShortageManagementService:
    ...
    def test_get_shortage_list(self):
        ...
        with (
            ...
            patch(
                "app.services.shortage.shortage_management_service.apply_pagination",
                return_value=chain,
            ),
            patch(
...
class TestAIClientService:
    ...
    def test_generate_solution_routes_to_kimi(self):
        ...
        with patch.object(
            svc, "_call_kimi", return_value={"content": "kimi", "success": True}
        ) as mock_kimi:
    ...
    def test_generate_solution_routes_to_gpt4(self):
        ...
        with patch.object(
            svc, "_call_openai", return_value={"content": "gpt4", "success": True}
        ) as mock_openai:
...
class TestBusinessCacheService:
    ...
    def test_get_project_list_miss(self):
        ...
        with (
            patch("app.services.cache.business_cache.get_cache") as mock_gc,
...
class TestCustomRuleService:
    ...
    def test_get_custom_rule_no_roles(self):
        ...
        with patch(
            "app.services.permission_service.PermissionService.get_user_effective_roles",
            return_value=[],
        ):
...
class TestProjectResourceService:
    ...
    def test_init(self):
        ...
        db = MagicMock()
        with (
            patch("app.services.project.resource_service.ProjectCoreService"),

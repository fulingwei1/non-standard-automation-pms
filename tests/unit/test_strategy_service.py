...
class TestCreateStrategy(unittest.TestCase):
    ...
    def test_create_strategy_minimal_fields(self):
        ...
        data = StrategyCreate(code="STR-2027", name="2027战略", year=2027)
...
class TestListStrategies(unittest.TestCase):
    ...
    def test_list_strategies_no_filter(self):
        ...
        strategies = [MockStrategy(id=1, year=2026), MockStrategy(id=2, year=2025)]
...
class TestGetStrategyMapData(unittest.TestCase):
    ...
    def test_get_strategy_map_data_success(self, mock_csf_health, mock_strategy_health, mock_get):
        ...
        mock_db.query.side_effect = [
            ...
            kpi_query,
            kpi_query,  # KPI counts for 2 CSFs
            # CUSTOMER dimension
            mock_csf_query,
            # INTERNAL dimension
            mock_csf_query,
        ...
        # Mock CSF health
        mock_csf_health.return_value = {"score": 80, "level": "GOOD", "kpi_completion_rate": 0.75}
    ...
    @patch("app.services.strategy.health_calculator.calculate_strategy_health")
    @patch("app.services.strategy.health_calculator.calculate_csf_health")
    def test_get_strategy_map_data_empty_csfs(
        self, mock_csf_health, mock_strategy_health, mock_get
    ):
        """测试无CSF的情况"""
        mock_db = MagicMock()
...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_create_strategy_with_none_dates(self):
        ...
        data = StrategyCreate(
            code="STR-2026", name="测试", year=2026, start_date=None, end_date=None
        )

...
class TestSupplierPerformanceEvaluatorCore(unittest.TestCase):
    ...
    def test_delivery_metrics_all_on_time(self):
        ...
        result = self.evaluator._calculate_delivery_metrics(
            [mock_order], date(2024, 1, 1), date(2024, 1, 31)
        )
    ...
    def test_quality_metrics_no_items(self):
        ...
        result = self.evaluator._calculate_quality_metrics(
            [mock_order], date(2024, 1, 1), date(2024, 1, 31)
        )
    ...
    def test_price_competitiveness_no_data(self):
        ...
        result = self.evaluator._calculate_price_competitiveness(

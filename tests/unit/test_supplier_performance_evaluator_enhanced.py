...
class TestCalculateDeliveryMetrics:
    ...
    def test_all_on_time_deliveries(self, evaluator, mock_db):
        ...
        result = evaluator._calculate_delivery_metrics(orders, date(2025, 1, 1), date(2025, 1, 31))
...
class TestCalculateQualityMetrics:
    ...
    def test_perfect_quality(self, evaluator, mock_db):
        ...
        items = [
            ...
            MagicMock(
                received_qty=Decimal("50"), qualified_qty=Decimal("50"), rejected_qty=Decimal("0")
            ),
        ]
        ...
        result = evaluator._calculate_quality_metrics(orders, date(2025, 1, 1), date(2025, 1, 31))
    ...
    def test_partial_quality(self, evaluator, mock_db):
        ...
        items = [
            MagicMock(
                received_qty=Decimal("100"), qualified_qty=Decimal("90"), rejected_qty=Decimal("10")
            ),
        ]
    ...
    def test_zero_total_qty(self, evaluator, mock_db):
        ...
        items = [
            MagicMock(
                received_qty=Decimal("0"), qualified_qty=Decimal("0"), rejected_qty=Decimal("0")
            ),
        ]

...
class TestScoreDimension:
    ...
    def test_score_dimension_no_criteria(self):
        ...
        result = service._score_dimension(requirement_data, evaluation_criteria, criteria_keys)
        assert result == 0
...
class TestMatchValue:
    ...
    def test_match_value_exact_match(self):
        ...
        result = service._match_value("high", {"value": "high"}, {"match_mode": "exact"})
    ...
    def test_match_value_exact_no_match(self):
        ...
        result = service._match_value("high", {"value": "low"}, {"match_mode": "exact"})

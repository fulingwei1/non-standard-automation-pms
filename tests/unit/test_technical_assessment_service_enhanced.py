...
class TestTechnicalAssessmentService(unittest.TestCase):
        ...
        self.rules_config = {
            "evaluation_criteria": {
                ...
                "has_similar_case": {
                    ...
                    "max_points": 10,
                    "options": [{"value": True, "points": 10}, {"value": False, "points": 0}],
                },
            ...
            "scales": {
                ...
                "score_levels": {"HIGH": ">=80", "MEDIUM": "60-79", "LOW": "<60"},
            },
        }
    ...
    def test_calculate_scores_all_dimensions(self):
        ...
        dimension_scores, total_score = self.service._calculate_scores(
            self.requirement_data, self.rules_config
        )
    ...
    def test_calculate_scores_partial_data(self):
        """测试部分需求数据的分数计算"""
        partial_data = {"tech_maturity": "成熟", "budget_status": "已批准"}

        dimension_scores, total_score = self.service._calculate_scores(
            partial_data, self.rules_config
        )
    ...
    def test_score_dimension_full_score(self):
        ...
        score = self.service._score_dimension(
            self.requirement_data, self.rules_config["evaluation_criteria"], tech_criteria
        )
    ...
    def test_score_dimension_missing_criteria(self):
        """测试缺少评分标准的维度"""
        score = self.service._score_dimension(
            self.requirement_data, self.rules_config["evaluation_criteria"], ["non_existent_key"]
        )
    ...
    def test_score_dimension_no_matching_options(self):
        ...
        score = self.service._score_dimension(
            data, self.rules_config["evaluation_criteria"], ["tech_maturity"]
        )
    ...
    def test_check_veto_rules_triggered(self):
        ...
        veto_triggered, veto_rules = self.service._check_veto_rules(data, self.rules_config)
    ...
    def test_check_veto_rules_multiple_triggers(self):
        """测试多个一票否决同时触发"""
        data = {"budget_status": "无预算", "tech_feasibility": "不可行"}
    ...
    def test_check_veto_rules_operator_not_equal(self):
        ...
        veto_triggered, veto_rules = self.service._check_veto_rules({"status": "异常"}, rules)
    ...
    def test_check_veto_rules_missing_field(self):
        """测试一票否决规则字段缺失"""
        veto_triggered, veto_rules = self.service._check_veto_rules(
            {"other_field": "value"}, self.rules_config
        )
    ...
    def test_generate_risks_low_dimension_scores(self):
        ...
        risks = self.service._generate_risks(
            self.requirement_data, dimension_scores, self.rules_config
        )
    ...
    def test_generate_risks_low_requirement_maturity(self):
        ...
        dimension_scores = {
            k: 20 for k in ["technology", "business", "resource", "delivery", "customer"]
        }
    ...
    def test_generate_risks_all_high_scores(self):
        """测试所有维度高分无风险"""
        dimension_scores = {
            k: 18 for k in ["technology", "business", "resource", "delivery", "customer"]
        }
    ...
    def test_generate_conditions_conditional_decision(self):
        ...
        conditions = self.service._generate_conditions(
            AssessmentDecisionEnum.CONDITIONAL.value, risks, {}
        )
    ...
    def test_generate_conditions_with_open_items(self):
        ...
        conditions = self.service._generate_conditions(
            AssessmentDecisionEnum.CONDITIONAL.value, risks, data
        )
    ...
    def test_update_source_assessment_lead(self):
        ...
        self.service._update_source_assessment(AssessmentSourceTypeEnum.LEAD.value, 1, 100)
    ...
    def test_update_source_assessment_opportunity(self):
        ...
        self.service._update_source_assessment(AssessmentSourceTypeEnum.OPPORTUNITY.value, 1, 100)
    ...
    def test_update_source_assessment_not_found(self):
        ...
        # 不应该抛出异常
        self.service._update_source_assessment(AssessmentSourceTypeEnum.LEAD.value, 999, 100)

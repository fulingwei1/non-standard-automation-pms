...
class TestTemplateRecommendationService:
    ...
    def test_recommend_templates_by_project_type(self, db_session, test_template1, test_template2):
        ...
        result = service.recommend_templates(project_type="AUTOMATION", limit=5)
    ...
    def test_recommend_templates_by_product_category(self, db_session, test_template1):
        ...
        result = service.recommend_templates(product_category="ICT", limit=5)
    ...
    def test_recommend_templates_by_industry(self, db_session, test_template1):
        ...
        result = service.recommend_templates(industry="ELECTRONICS", limit=5)
    ...
    def test_recommend_templates_multiple_criteria(self, db_session, test_template1):
        ...
        result = service.recommend_templates(
            project_type="AUTOMATION", product_category="ICT", industry="ELECTRONICS", limit=5
        )
    ...
    def test_recommend_templates_limit(
        self, db_session, test_template1, test_template2, test_template3
    ):
        """测试限制返回数量"""
        service = TemplateRecommendationService(db_session)

        result = service.recommend_templates(project_type="AUTOMATION", limit=2)

        assert isinstance(result, list)
        assert len(result) <= 2

    def test_recommend_templates_sorted_by_score(
        self, db_session, test_template1, test_template2, test_template3
    ):
        """测试按评分排序"""
        service = TemplateRecommendationService(db_session)
    ...
    def test_recommend_templates_excludes_inactive(
        self, db_session, test_template1, test_template_inactive
    ):
        """测试排除非活跃模板"""
        service = TemplateRecommendationService(db_session)
    ...
    def test_calculate_score_project_type_match(self, db_session, test_template1):
        ...
        score = service._calculate_score(
            template=test_template1, project_type="AUTOMATION", product_category=None, industry=None
        )
    ...
    def test_calculate_score_product_category_match(self, db_session, test_template1):
        ...
        score = service._calculate_score(
            template=test_template1, project_type=None, product_category="ICT", industry=None
        )
    ...
    def test_calculate_score_usage_count(self, db_session, test_template3):
        ...
        score = service._calculate_score(
            template=test_template3, project_type=None, product_category=None, industry=None
        )
    ...
    def test_get_recommendation_reasons_usage_count(self, db_session, test_template1):
        ...
        reasons = service._get_recommendation_reasons(
            template=test_template1, project_type=None, product_category=None, industry=None
        )
    ...
    def test_get_recommendation_reasons_no_matches(self, db_session):
        ...
        reasons = service._get_recommendation_reasons(
            template=template, project_type=None, product_category=None, industry=None
        )
    ...
    def test_recommend_templates_no_criteria(
        self, db_session, test_template1, test_template2, test_template3
    ):
        """测试无筛选条件"""
        service = TemplateRecommendationService(db_session)

        result = service.recommend_templates(limit=5)

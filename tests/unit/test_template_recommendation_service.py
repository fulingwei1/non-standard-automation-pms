...
@pytest.fixture
def template_recommendation_service(db_session: Session):
    """创建 TemplateRecommendationService 实例"""
    return TemplateRecommendationService(db_session)
...
class TestTemplateRecommendationService:
    ...
    def test_recommend_templates(self, template_recommendation_service):
        """测试 recommend_templates 方法"""
        # TODO: 实现测试逻辑
        # 1. 准备测试数据
        # 2. 调用方法
        # 3. 验证结果

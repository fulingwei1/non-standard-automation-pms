...
class TestTimesheetAggregationService:
    ...
    def test_aggregate_monthly_calls_helpers(self, service, db):
        ...
        with patch(
            "app.services.timesheet_aggregation_service.TimesheetAggregationService.aggregate_monthly_timesheet"
        ) as mock_method:
    ...
    def test_aggregate_with_user_filter(self, service):
        ...
        with patch(
            f"{helper_base}.TimesheetAggregationService.aggregate_monthly_timesheet"
        ) as mock_agg:

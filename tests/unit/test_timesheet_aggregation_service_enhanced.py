...
class TestAggregateMonthlyTimesheet(unittest.TestCase):
    ...
    def test_aggregate_monthly_timesheet_user_month(
        ...
        mock_get_summary,
        mock_task_breakdown,
        mock_daily_breakdown,
        mock_project_breakdown,
        mock_hours_summary,
        mock_query_timesheets,
...
class TestGenerateFinanceReport(unittest.TestCase):
    ...
    def test_generate_finance_report_with_project_filter(
        self, mock_get_hourly_rate, mock_get_month_range
    ):
        """测试按项目筛选的财务报表"""
        mock_get_month_range.return_value = (date(2024, 1, 1), date(2024, 1, 31))
    ...
    @patch("app.services.timesheet_aggregation_service.get_month_range_by_ym")
    @patch("app.services.timesheet_aggregation_service.HourlyRateService.get_user_hourly_rate")
    def test_generate_finance_report_multiple_projects(
        self, mock_get_hourly_rate, mock_get_month_range
    ):
        """测试多项目财务报表"""
        mock_get_month_range.return_value = (date(2024, 1, 1), date(2024, 1, 31))
    ...
    @patch("app.services.timesheet_aggregation_service.get_month_range_by_ym")
    @patch("app.services.timesheet_aggregation_service.HourlyRateService.get_user_hourly_rate")
    def test_generate_finance_report_same_project_multiple_users(
        self, mock_get_hourly_rate, mock_get_month_range
    ):
        """测试同一项目多人的财务报表"""
        mock_get_month_range.return_value = (date(2024, 1, 1), date(2024, 1, 31))
...
class TestGenerateRDReport(unittest.TestCase):
    ...
    @patch("app.services.timesheet_aggregation_service.get_month_range_by_ym")
    @patch("app.services.timesheet_aggregation_service.HourlyRateService.get_user_hourly_rate")
    def test_generate_rd_report_no_rd_project_found(
        self, mock_get_hourly_rate, mock_get_month_range
    ):
        """测试研发项目不存在的情况"""
        mock_get_month_range.return_value = (date(2024, 1, 1), date(2024, 1, 31))
...
class TestEdgeCases(unittest.TestCase):
    ...
    @patch("app.services.timesheet_aggregation_service.get_month_range_by_ym")
    @patch("app.services.timesheet_aggregation_service.HourlyRateService.get_user_hourly_rate")
    def test_generate_finance_report_with_zero_hourly_rate(
        self, mock_get_hourly_rate, mock_get_month_range
    ):
        """测试时薪为0的情况"""
        mock_get_month_range.return_value = (date(2024, 1, 1), date(2024, 1, 31))

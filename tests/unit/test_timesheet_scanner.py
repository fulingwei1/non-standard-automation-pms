...
class TestScanAndNotifyAll:
    ...
    @patch(
        "app.services.timesheet_reminder.scanner.notify_weekly_timesheet_missing", return_value=3
    )
    ...
    @patch(
        "app.services.timesheet_reminder.scanner.notify_timesheet_missing",

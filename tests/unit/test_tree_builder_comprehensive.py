...
from app.common.tree_builder import _default_to_dict, build_tree
...
class TestBuildTree:
    ...
    def test_custom_id_key(self):
        ...
        tree = build_tree(items, id_key="dept_id", parent_key="parent_dept_id")
    ...
    def test_custom_to_dict(self):
        ...
        def to_dict(dept):
            return {"id": dept.dept_id, "name": dept.dept_name, "parent_id": dept.parent_id}
...
class TestIntegrationScenarios:
    ...
    def test_department_tree(self):
        ...
        tree = build_tree(departments, sort_key=lambda n: n.get("sort", 0))
    ...
    def test_menu_tree(self):
        ...
        tree = build_tree(menus, sort_key=lambda n: n.get("order", 0))

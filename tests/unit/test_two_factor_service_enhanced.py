...
class TestEncryptionDecryption(unittest.TestCase):
    ...
    def test_encrypt_decrypt_roundtrip(self):
        """测试加密解密往返"""
        original_secrets = ["JBSWY3DPEHPK3PXP", "ABCDEFGHIJKLMNOP", "1234567890ABCDEF", ""]
...
class TestDisable2FA(unittest.TestCase):
    ...
    def test_disable_2fa_wrong_password(self, mock_verify_pwd):
        ...
        success, message = self.service.disable_2fa_for_user(self.db, self.user, "wrong_password")
    ...
    def test_disable_2fa_success(self, mock_verify_pwd):
        ...
        success, message = self.service.disable_2fa_for_user(self.db, self.user, "correct_password")
...
class TestVerifyBackupCode(unittest.TestCase):
    ...
    def test_verify_backup_code_no_codes(self, mock_verify_pwd):
        ...
        success, message = self.service._verify_backup_code(self.db, self.user, "12345678")
    ...
    def test_verify_backup_code_invalid(self, mock_verify_pwd):
        ...
        success, message = self.service._verify_backup_code(self.db, self.user, "00000000")

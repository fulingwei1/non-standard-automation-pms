...
import app.services.urgent_purchase_from_shortage_service
...
class TestUrgentPurchaseFromShortageService:
    ...
    def test_create_urgent_purchase_request_from_alert(self):
        ...
        # TODO: 实现测试逻辑
        from app.services.urgent_purchase_from_shortage_service import create_urgent_purchase_request_from_alert
        pass
    ...
    def test_auto_trigger_urgent_purchase_for_alerts(self):
        ...
        # TODO: 实现测试逻辑
        from app.services.urgent_purchase_from_shortage_service import auto_trigger_urgent_purchase_for_alerts
        pass

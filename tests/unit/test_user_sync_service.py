...
class TestCreateUserFromEmployee:
    ...
    def test_existing_user_returns_none(self, db_session):
        ...
        employee = Employee(id=1, employee_code="EMP001", name="测试员工")

        db_session.add(employee)

        db_session.flush()

        user = User(employee_id=employee.id, username="test_user", password_hash="hash")
...
class TestSyncAllEmployees:
    ...
    def test_sync_with_department_filter(self, db_session):
        ...
        result = UserSyncService.sync_all_employees(db_session, department_filter="研发部")
...
class TestResetUserPassword:
    ...
    def test_no_employee_linked(self, db_session):
        ...
        user = User(id=1, employee_id=99999, username="test_user", password_hash="hash")
...
class TestToggleUserActive:
    ...
    def test_cannot_toggle_superuser(self, db_session):
        ...
        user = User(id=1, employee_id=1, username="admin", password_hash="hash", is_superuser=True)

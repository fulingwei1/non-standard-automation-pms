...
from app.utils.holiday_utils import get_working_days, is_holiday
from app.utils.number_generator import NumberGenerator
from app.utils.pagination import paginate
from app.utils.pinyin_utils import get_initials, to_pinyin
...
class TestRiskCalculator:
    ...
    def test_assess_schedule_risk(self):
        ...
        project_data = {"delay_days": 10, "progress_deviation": -15, "remaining_days": 30}
...
class TestProjectUtils:
    ...
    def test_calculate_earned_value(self):
        ...
        data = {"total_budget": 1000000, "completion_percentage": 60}
...
class TestNumberGenerator:
    ...
    def test_generate_project_number(self):
        ...
        project_number = generator.generate_project_number(
            prefix="PRJ", date_str="20260216", sequence=1
        )
...
class TestHolidayUtils:
    ...
    def test_get_working_days_with_holidays(self):
        ...
        working_days = get_working_days(start_date, end_date, exclude_holidays=holidays)
...
class TestBatchOperations:
    ...
    def test_batch_update(self):
        ...
        updates = [{"id": i, "status": "completed"} for i in range(50)]

...
class TestLogger:
    ...
    def test_log_error_with_context(self):
        ...
        with patch.object(logger, "error") as mock_error:
            log_error_with_context(
                logger, "Test error message", error, context={"user_id": 123, "project_id": 456}
            )
    ...
    def test_log_warning_with_context(self):
        ...
        with patch.object(logger, "warning") as mock_warning:
            log_warning_with_context(logger, "Test warning", context={"item_id": 789})
    ...
    def test_log_info_with_context(self):
        ...
        with patch.object(logger, "info") as mock_info:
            log_info_with_context(logger, "Test info", context={"action": "create"})
...
class TestProjectUtils:
    ...
    def test_init_project_stages(self, db_session: Session):
        ...
        s1_statuses = (
            ...
            .filter(ProjectStatus.stage_id == stages[0].id)
            .order_by(ProjectStatus.status_order)
            .all()
        )
...
class TestCacheDecorator:
    ...
    def test_track_query_decorator(self):
        ...
        from app.utils.cache_decorator import query_stats, track_query
...
class TestWeChatClient:
    ...
    def test_init_with_params(self):
        ...
        client = WeChatClient(corp_id="test_corp", agent_id="test_agent", secret="test_secret")
    ...
    def test_send_message_success(self, mock_get_token, mock_post):
        ...
        result = client.send_message(
            user_ids=["user1", "user2"], message={"msgtype": "text", "text": {"content": "test"}}
        )

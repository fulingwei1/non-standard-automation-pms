# -*- coding: utf-8 -*-
"""
Tests for win_rate_prediction_service service
Covers: app/services/win_rate_prediction_service.py
...
@pytest.fixture
def win_rate_prediction_service(db_session: Session):
    """Create win_rate_prediction_service instance."""
...
class TestWinRatePredictionService:
    ...
    def test_init(self, db_session: Session):
        ...
        service = WinRatePredictionService(db_session)

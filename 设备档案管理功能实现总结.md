...
**文件**: `app/api/v1/endpoints/machines.py`

#### 2.1.1 上传设备文档

**端点**: `POST /api/v1/machines/{machine_id}/documents/upload`
...
**端点**: `GET /api/v1/machines/{machine_id}/documents`
...
**端点**: `GET /api/v1/machines/{machine_id}/documents/{doc_id}/download`
...
**端点**: `GET /api/v1/machines/{machine_id}/documents/{doc_id}/versions`
